// BFDataImpl header file for DataSet DSTC0126.VWRepeat_Record
...
class dsi_DSTC0126_VWRepeat_Record : public BFDataImpl 
{
public:
   // Constructors
   dsi_DSTC0126_VWRepeat_Record();
   virtual ~dsi_DSTC0126_VWRepeat_Record();
...
private:
   ...
   BFTextField_1 ClassReq_;
   BFTextField<1000> FundList_;
   BFTextField_1 BankAcctExist_;
