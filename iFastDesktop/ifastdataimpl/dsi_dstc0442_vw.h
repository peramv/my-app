// BFDataImpl header file for DataSet DSTC0442.VW
...
class dsi_DSTC0442_VW : public BFDataImpl 
{
public:
   // Constructors
   dsi_DSTC0442_VW();
   virtual ~dsi_DSTC0442_VW();
...
private:
   ...
   // Field Declarations
   BFTextField_60 RDRApplic_;
   BFTextField_60 RDRDefault_;
