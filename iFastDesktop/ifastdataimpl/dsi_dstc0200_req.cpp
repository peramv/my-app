// BFDataImpl implementation file for DataSet DSTC0200.REQ
...
// This function creates an instance of dsi_DSTC0200_REQ
// The function is required by the factory class as that class may choke the compiler
// with excessive symbols if all of the required header files needed to be #include'd
BFDataImpl* create_dsi_DSTC0200_REQ() { return new dsi_DSTC0200_REQ; }

dsi_DSTC0200_REQ::dsi_DSTC0200_REQ()
: BFDataImpl( 40003087 )
...
BFDataImpl* dsi_DSTC0200_REQ::clone()
{
   dsi_DSTC0200_REQ* p = new dsi_DSTC0200_REQ;
   p->NextKey_ = NextKey_;
...
BFDataField* dsi_DSTC0200_REQ::getElement( const BFFieldId& id )
{
   switch( id.getId() ) {
...
const BFDataField* dsi_DSTC0200_REQ::getElement( const BFFieldId& id ) const
{
   return( ( const_cast< dsi_DSTC0200_REQ* >(this) )->getElement( id ) );
}

BFDataField* dsi_DSTC0200_REQ::getElementByIndex( unsigned int iField )
{
   if ( iField >=0 && iField < 28 )
   {
      ...
      if( NULL == pField )
      {
         switch(iField)
         {
            ...
            case 12: aFlds_[12] = &CompanyCode_; break;
            case 13: aFlds_[13] = &BrokerCode_; break;
            case 14: aFlds_[14] = &InterCode_; break;
            ...
            case 23: aFlds_[23] = &ClassCode_; break;
            case 24: aFlds_[24] = &ExternalIdType_; break;
            case 25: aFlds_[25] = &ExternalId_; break;
            case 26: aFlds_[26] = &RegAgentCode_; break;
            case 27: aFlds_[27] = &ExcludeStopSettle_; break;
         }
...
const BFDataField* dsi_DSTC0200_REQ::getElementByIndex( unsigned int iField ) const
{
   return( ( const_cast< dsi_DSTC0200_REQ* >(this) )->getElementByIndex( iField ) );
}

unsigned long dsi_DSTC0200_REQ::getLargestDefinedField( void ) const
{
   return( 200 );
}

unsigned long dsi_DSTC0200_REQ::getDefinedByteLength( void ) const
{
   return( 1435 * sizeof( I_CHAR ) );
}

bool dsi_DSTC0200_REQ::exists( const BFFieldId& id ) const
{
   return dsi_DSTC0200_REQ::fieldExists( id );
}

bool dsi_DSTC0200_REQ::fieldExists( const BFFieldId& id )
{
   switch( id.getId() )
   {
