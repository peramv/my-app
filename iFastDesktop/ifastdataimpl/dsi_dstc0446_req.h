// BFDataImpl header file for DataSet DSTC0446.REQ
...
class dsi_DSTC0446_REQ : public BFDataImpl 
{
public:
   // Constructors
   dsi_DSTC0446_REQ();
   virtual ~dsi_DSTC0446_REQ();
...
private:
   ...
   BFTextField_60 NationalID_;
   BFTextField_60 COINationalID_;
   BFTextField_60 Passport_;
   BFTextField_60 COIPassport_;
