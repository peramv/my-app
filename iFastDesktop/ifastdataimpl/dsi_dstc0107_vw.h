// BFDataImpl header file for DataSet DSTC0107.VW
...
class dsi_DSTC0107_VW : public BFDataImpl 
{
public:
   // Constructors
   dsi_DSTC0107_VW();
   virtual ~dsi_DSTC0107_VW();
...
private:
   ...
   BFDecimalField ClientLvlTfr_;
   BFDecimalField ClientLvlExch_;
