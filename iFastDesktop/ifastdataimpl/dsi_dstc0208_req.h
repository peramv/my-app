// BFDataImpl header file for DataSet DSTC0208.REQ
...
class dsi_DSTC0208_REQ : public BFDataImpl 
{
public:
   // Constructors
   dsi_DSTC0208_REQ();
   virtual ~dsi_DSTC0208_REQ();
...
private:
   ...
   BFIntegerField SettleMethod_;
   BFDecimalField NetSettlement_;
