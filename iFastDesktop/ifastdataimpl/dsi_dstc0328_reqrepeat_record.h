// BFDataImpl header file for DataSet DSTC0328.REQRepeat_Record
...
class dsi_DSTC0328_REQRepeat_Record : public BFDataImpl 
{
public:
   // Constructors
   dsi_DSTC0328_REQRepeat_Record();
   virtual ~dsi_DSTC0328_REQRepeat_Record();
...
private:
   ...
   BFIntegerField FundBrokerEligID_;
