// BFDataImpl header file for DataSet DSTC0090.REQ
...
class dsi_DSTC0090_REQ : public BFDataImpl 
{
public:
   // Constructors
   dsi_DSTC0090_REQ();
   virtual ~dsi_DSTC0090_REQ();
...
private:
   ...
   BFTextField_60 SrchBrokerName_;
   BFTextField_60 RequestType_;
   ...
   BFTextField_60 ClearingFirmBroker_;
   BFTextField_60 RelationType_;
