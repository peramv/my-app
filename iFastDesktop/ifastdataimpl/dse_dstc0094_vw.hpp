// Field IDs and DataIDs for DataSet DSTC0094.VW
...
namespace ifds
{
   extern __declspec(dllimport) const BFDataId DSTC0094_VW;
   extern __declspec(dllimport) const BFTextFieldId MoreAvailable;
   extern __declspec(dllimport) const BFTextFieldId NextKey;
   extern __declspec(dllimport) const BFNumericFieldId SlsRepTotal;
