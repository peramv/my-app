// BFDataImpl header file for DataSet DSTC0382.VWRepeat_Record
...
class dsi_DSTC0382_VWRepeat_Record : public BFDataImpl 
{
public:
   // Constructors
   dsi_DSTC0382_VWRepeat_Record();
   virtual ~dsi_DSTC0382_VWRepeat_Record();
...
private:
   ...
   BFTextField_60 SchedFreqDesc_;
   BFTextField_60 FrequencyType_;
