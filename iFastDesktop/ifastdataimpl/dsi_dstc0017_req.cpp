// BFDataImpl implementation file for DataSet DSTC0017.REQ
...
// This function creates an instance of dsi_DSTC0017_REQ
// The function is required by the factory class as that class may choke the compiler
// with excessive symbols if all of the required header files needed to be #include'd
BFDataImpl* create_dsi_DSTC0017_REQ() { return new dsi_DSTC0017_REQ; }

dsi_DSTC0017_REQ::dsi_DSTC0017_REQ()
: BFDataImpl( 40000053 )
...
, AllFundMode_( ifds::AllFundMode, &ifds::s_FldProp_AllFundMode )
...
, UseDateFlag_( ifds::UseDateFlag, &ifds::s_FldProp_UseDateFlag )
...
, TradeStatus_( ifds::TradeStatus, &ifds::s_FldProp_TradeStatus )
, EUSDScope_( ifds::EUSDScope, &ifds::s_FldProp_EUSDScope )
...
BFDataImpl* dsi_DSTC0017_REQ::clone()
{
   dsi_DSTC0017_REQ* p = new dsi_DSTC0017_REQ;
   p->AccountNum_ = AccountNum_;
   p->FundCode_ = FundCode_;
   p->ClassCode_ = ClassCode_;
   p->AllFundMode_ = AllFundMode_;
   p->NextKey_ = NextKey_;
   ...
   p->TradeStatus_ = TradeStatus_;
   p->EUSDScope_ = EUSDScope_;
...
BFDataField* dsi_DSTC0017_REQ::getElement( const BFFieldId& id )
{
   switch( id.getId() ) {
      ...
      case 40000051: return ( &AllFundMode_ ); break; // AllFundMode
      ...
      case 40001772: return ( &UseDateFlag_ ); break; // UseDateFlag
      ...
      case 40005243: return ( &TradeStatus_ ); break; // TradeStatus
      case 40005244: return ( &EUSDScope_ ); break; // EUSDScope
...
const BFDataField* dsi_DSTC0017_REQ::getElement( const BFFieldId& id ) const
{
   return( ( const_cast< dsi_DSTC0017_REQ* >(this) )->getElement( id ) );
}

BFDataField* dsi_DSTC0017_REQ::getElementByIndex( unsigned int iField )
{
   if ( iField >=0 && iField < 39 )
   {
      ...
      if( NULL == pField )
      {
         switch(iField)
         {
            ...
            case 3: aFlds_[3] = &AllFundMode_; break;
            ...
            case 9: aFlds_[9] = &FromDate_; break;
            case 10: aFlds_[10] = &ToDate_; break;
            case 11: aFlds_[11] = &UseDateFlag_; break;
            case 12: aFlds_[12] = &Track_; break;
            case 13: aFlds_[13] = &Activity_; break;
            case 14: aFlds_[14] = &OverrideRepeats_; break;
            case 15: aFlds_[15] = &ReqTransid_; break;
            ...
            case 27: aFlds_[27] = &AltAccount_; break;
            case 28: aFlds_[28] = &TransType_; break;
            case 29: aFlds_[29] = &Units_; break;
            case 30: aFlds_[30] = &FundIDValue_; break;
            case 31: aFlds_[31] = &FundIDType_; break;
            case 32: aFlds_[32] = &TradeStatus_; break;
            case 33: aFlds_[33] = &EUSDScope_; break;
            case 34: aFlds_[34] = &ExcludeReversal_; break;
            case 35: aFlds_[35] = &TradeDate_; break;
            case 36: aFlds_[36] = &ExcludeCancelled_; break;
            case 37: aFlds_[37] = &ReportingCurrency_; break;
            case 38: aFlds_[38] = &NSCCControlNumber_; break;
         }
...
const BFDataField* dsi_DSTC0017_REQ::getElementByIndex( unsigned int iField ) const
{
   return( ( const_cast< dsi_DSTC0017_REQ* >(this) )->getElementByIndex( iField ) );
}

unsigned long dsi_DSTC0017_REQ::getLargestDefinedField( void ) const
{
   return( 200 );
}

unsigned long dsi_DSTC0017_REQ::getDefinedByteLength( void ) const
{
   return( 1693 * sizeof( I_CHAR ) );
}

bool dsi_DSTC0017_REQ::exists( const BFFieldId& id ) const
{
   return dsi_DSTC0017_REQ::fieldExists( id );
}

bool dsi_DSTC0017_REQ::fieldExists( const BFFieldId& id )
{
   switch( id.getId() )
   {
      ...
      case 40005243: return( true );
      case 40005244: return( true );
