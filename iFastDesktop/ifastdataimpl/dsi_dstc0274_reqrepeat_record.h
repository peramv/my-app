// BFDataImpl header file for DataSet DSTC0274.REQRepeat_Record
...
class dsi_DSTC0274_REQRepeat_Record : public BFDataImpl 
{
public:
   // Constructors
   dsi_DSTC0274_REQRepeat_Record();
   virtual ~dsi_DSTC0274_REQRepeat_Record();
