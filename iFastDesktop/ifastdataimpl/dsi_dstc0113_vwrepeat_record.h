// BFDataImpl header file for DataSet DSTC0113.VWRepeat_Record
...
class dsi_DSTC0113_VWRepeat_Record : public BFDataImpl 
{
public:
   // Constructors
   dsi_DSTC0113_VWRepeat_Record();
   virtual ~dsi_DSTC0113_VWRepeat_Record();
...
private:
   ...
   BFTextField_60 SATxnConfDesc_;
   BFTextField_60 SADivConfCode_;
   BFTextField_60 SADivConfDesc_;
   BFTextField_60 SALettersCode_;
   BFTextField_60 SALettersDesc_;
