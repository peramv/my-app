// Field IDs and DataIDs for DataSet DSTC0354.VW
...
namespace ifds
{
   extern __declspec(dllimport) const BFDataId DSTC0354_VW;
   extern __declspec(dllimport) const BFTextFieldId MoreAvailable;
   extern __declspec(dllimport) const BFTextFieldId NextKey;
   extern __declspec(dllimport) const BFTextFieldId AllowUDMUpdate;
