// BFDataImpl implementation file for DataSet DSTC0045.REQ
...
// This function creates an instance of dsi_DSTC0045_REQ
// The function is required by the factory class as that class may choke the compiler
// with excessive symbols if all of the required header files needed to be #include'd
BFDataImpl* create_dsi_DSTC0045_REQ() { return new dsi_DSTC0045_REQ; }

dsi_DSTC0045_REQ::dsi_DSTC0045_REQ()
: BFDataImpl( 40000077 )
...
BFDataImpl* dsi_DSTC0045_REQ::clone()
{
   dsi_DSTC0045_REQ* p = new dsi_DSTC0045_REQ;
   p->User_Id_ = User_Id_;
...
BFDataField* dsi_DSTC0045_REQ::getElement( const BFFieldId& id )
{
   switch( id.getId() ) {
...
const BFDataField* dsi_DSTC0045_REQ::getElement( const BFFieldId& id ) const
{
   return( ( const_cast< dsi_DSTC0045_REQ* >(this) )->getElement( id ) );
}

BFDataField* dsi_DSTC0045_REQ::getElementByIndex( unsigned int iField )
{
   if ( iField >=0 && iField < 17 )
   {
      ...
      if( NULL == pField )
      {
         switch(iField)
         {
            ...
            case 4: aFlds_[4] = &ShareholderNum_; break;
            case 5: aFlds_[5] = &Remark1_; break;
            case 6: aFlds_[6] = &Remark2_; break;
            case 7: aFlds_[7] = &Remark3_; break;
            case 8: aFlds_[8] = &Remark4_; break;
            case 9: aFlds_[9] = &Remark5_; break;
            case 10: aFlds_[10] = &Remark6_; break;
            case 11: aFlds_[11] = &Remark7_; break;
            case 12: aFlds_[12] = &Remark8_; break;
            case 13: aFlds_[13] = &Remark9_; break;
            case 14: aFlds_[14] = &Remark10_; break;
            case 15: aFlds_[15] = &Track_; break;
            case 16: aFlds_[16] = &Activity_; break;
         }
...
const BFDataField* dsi_DSTC0045_REQ::getElementByIndex( unsigned int iField ) const
{
   return( ( const_cast< dsi_DSTC0045_REQ* >(this) )->getElementByIndex( iField ) );
}

unsigned long dsi_DSTC0045_REQ::getLargestDefinedField( void ) const
{
   return( 100 );
}

unsigned long dsi_DSTC0045_REQ::getDefinedByteLength( void ) const
{
   return( 1311 * sizeof( I_CHAR ) );
}

bool dsi_DSTC0045_REQ::exists( const BFFieldId& id ) const
{
   return dsi_DSTC0045_REQ::fieldExists( id );
}

bool dsi_DSTC0045_REQ::fieldExists( const BFFieldId& id )
{
   switch( id.getId() )
   {
