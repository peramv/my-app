// Field IDs and DataIDs for DataSet DSTC0423.VW
...
namespace ifds
{
   extern __declspec(dllimport) const BFDataId DSTC0423_VW;
   extern __declspec(dllimport) const BFTextFieldId MoreAvailable;
   extern __declspec(dllimport) const BFTextFieldId NextKey;
   extern __declspec(dllimport) const BFDecimalFieldId InvHisEstimatedRate;
