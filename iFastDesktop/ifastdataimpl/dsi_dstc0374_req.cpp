// BFDataImpl implementation file for DataSet DSTC0374.REQ
...
// This function creates an instance of dsi_DSTC0374_REQ
// The function is required by the factory class as that class may choke the compiler
// with excessive symbols if all of the required header files needed to be #include'd
BFDataImpl* create_dsi_DSTC0374_REQ() { return new dsi_DSTC0374_REQ; }

dsi_DSTC0374_REQ::dsi_DSTC0374_REQ()
: BFDataImpl( 40005523 )
...
BFDataImpl* dsi_DSTC0374_REQ::clone()
{
   dsi_DSTC0374_REQ* p = new dsi_DSTC0374_REQ;
...
BFDataField* dsi_DSTC0374_REQ::getElement( const BFFieldId& id )
{
   switch( id.getId() ) {
...
const BFDataField* dsi_DSTC0374_REQ::getElement( const BFFieldId& id ) const
{
   return( ( const_cast< dsi_DSTC0374_REQ* >(this) )->getElement( id ) );
}

BFDataField* dsi_DSTC0374_REQ::getElementByIndex( unsigned int iField )
{
   if ( iField >=0 && iField < 14 )
   {
      ...
      if( NULL == pField )
      {
         switch(iField)
         {
            ...
            case 6: aFlds_[6] = &Broker_; break;
            case 7: aFlds_[7] = &Branch_; break;
            case 8: aFlds_[8] = &SalesRepCode_; break;
            case 9: aFlds_[9] = &EffectiveDate_; break;
            case 10: aFlds_[10] = &PaymentFor_; break;
...
const BFDataField* dsi_DSTC0374_REQ::getElementByIndex( unsigned int iField ) const
{
   return( ( const_cast< dsi_DSTC0374_REQ* >(this) )->getElementByIndex( iField ) );
}

unsigned long dsi_DSTC0374_REQ::getLargestDefinedField( void ) const
{
   return( 100 );
}

unsigned long dsi_DSTC0374_REQ::getDefinedByteLength( void ) const
{
   return( 678 * sizeof( I_CHAR ) );
}

bool dsi_DSTC0374_REQ::exists( const BFFieldId& id ) const
{
   return dsi_DSTC0374_REQ::fieldExists( id );
}

bool dsi_DSTC0374_REQ::fieldExists( const BFFieldId& id )
{
   switch( id.getId() )
   {
