// BFDataImpl header file for DataSet DSTC0468.VWRepeat_Record
...
class dsi_DSTC0468_VWRepeat_Record : public BFDataImpl 
{
public:
   // Constructors
   dsi_DSTC0468_VWRepeat_Record();
   virtual ~dsi_DSTC0468_VWRepeat_Record();
...
private:
   ...
   BFTextField_60 ConfigName_;
   BFTextField_60 ConfigValue_;
