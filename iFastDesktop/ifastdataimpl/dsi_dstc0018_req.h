// BFDataImpl header file for DataSet DSTC0018.REQ
...
class dsi_DSTC0018_REQ : public BFDataImpl 
{
public:
   // Constructors
   dsi_DSTC0018_REQ();
   virtual ~dsi_DSTC0018_REQ();
...
private:
   ...
   // Field Declarations
   BFNumericField InAcctNum_;
   BFTextField_60 InFund_;
   BFTextField_60 InCertNum_;
   BFTextField_60 InXrefNum_;
