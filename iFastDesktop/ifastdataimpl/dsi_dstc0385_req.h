// BFDataImpl header file for DataSet DSTC0385.REQ
...
class dsi_DSTC0385_REQ : public BFDataImpl 
{
public:
   // Constructors
   dsi_DSTC0385_REQ();
   virtual ~dsi_DSTC0385_REQ();
...
private:
   ...
   BFTextField_1 AffluentFrom_;
   BFTextField_1 AffluentTo_;
