// BFDataImpl implementation file for DataSet DSTC0317.REQ
...
// This function creates an instance of dsi_DSTC0317_REQ
// The function is required by the factory class as that class may choke the compiler
// with excessive symbols if all of the required header files needed to be #include'd
BFDataImpl* create_dsi_DSTC0317_REQ() { return new dsi_DSTC0317_REQ; }

dsi_DSTC0317_REQ::dsi_DSTC0317_REQ()
: BFDataImpl( 40004878 )
...
BFDataImpl* dsi_DSTC0317_REQ::clone()
{
   dsi_DSTC0317_REQ* p = new dsi_DSTC0317_REQ;
...
BFDataField* dsi_DSTC0317_REQ::getElement( const BFFieldId& id )
{
   switch( id.getId() ) {
...
const BFDataField* dsi_DSTC0317_REQ::getElement( const BFFieldId& id ) const
{
   return( ( const_cast< dsi_DSTC0317_REQ* >(this) )->getElement( id ) );
}

BFDataField* dsi_DSTC0317_REQ::getElementByIndex( unsigned int iField )
{
   if ( iField >=0 && iField < 11 )
   {
      ...
      if( NULL == pField )
      {
         switch(iField)
         {
            ...
            case 9: aFlds_[9] = &SettlementInstrCode_; break;
...
const BFDataField* dsi_DSTC0317_REQ::getElementByIndex( unsigned int iField ) const
{
   return( ( const_cast< dsi_DSTC0317_REQ* >(this) )->getElementByIndex( iField ) );
}

unsigned long dsi_DSTC0317_REQ::getLargestDefinedField( void ) const
{
   return( 100 );
}

unsigned long dsi_DSTC0317_REQ::getDefinedByteLength( void ) const
{
   return( 491 * sizeof( I_CHAR ) );
}

bool dsi_DSTC0317_REQ::exists( const BFFieldId& id ) const
{
   return dsi_DSTC0317_REQ::fieldExists( id );
}

bool dsi_DSTC0317_REQ::fieldExists( const BFFieldId& id )
{
   switch( id.getId() )
   {
