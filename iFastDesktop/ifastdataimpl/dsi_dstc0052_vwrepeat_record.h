// BFDataImpl header file for DataSet DSTC0052.VWRepeat_Record
...
class dsi_DSTC0052_VWRepeat_Record : public BFDataImpl 
{
public:
   // Constructors
   dsi_DSTC0052_VWRepeat_Record();
   virtual ~dsi_DSTC0052_VWRepeat_Record();
...
private:
   ...
   BFTextField_10 rxBankingEntity_;
