// BFDataImpl implementation file for DataSet DSTC0072.REQRepeat_Record
...
// This function creates an instance of dsi_DSTC0072_REQRepeat_Record
// The function is required by the factory class as that class may choke the compiler
// with excessive symbols if all of the required header files needed to be #include'd
BFDataImpl* create_dsi_DSTC0072_REQRepeat_Record() { return new dsi_DSTC0072_REQRepeat_Record; }

dsi_DSTC0072_REQRepeat_Record::dsi_DSTC0072_REQRepeat_Record()
: BFDataImpl( 40000987 )
...
, UpdShrProvRes_( ifds::UpdShrProvRes, &ifds::s_FldProp_UpdShrProvRes )
...
BFDataImpl* dsi_DSTC0072_REQRepeat_Record::clone()
{
   dsi_DSTC0072_REQRepeat_Record* p = new dsi_DSTC0072_REQRepeat_Record;
   p->RunMode_ = RunMode_;
   ...
   p->UpdShrProvRes_ = UpdShrProvRes_;
...
BFDataField* dsi_DSTC0072_REQRepeat_Record::getElement( const BFFieldId& id )
{
   switch( id.getId() ) {
      ...
      case 40005923: return ( &UpdShrProvRes_ ); break; // UpdShrProvRes
...
const BFDataField* dsi_DSTC0072_REQRepeat_Record::getElement( const BFFieldId& id ) const
{
   return( ( const_cast< dsi_DSTC0072_REQRepeat_Record* >(this) )->getElement( id ) );
}

BFDataField* dsi_DSTC0072_REQRepeat_Record::getElementByIndex( unsigned int iField )
{
   if ( iField >=0 && iField < 33 )
   {
      ...
      if( NULL == pField )
      {
         switch(iField)
         {
            ...
            case 1: aFlds_[1] = &AddrCode_; break;
            ...
            case 11: aFlds_[11] = &Confirm_; break;
            case 12: aFlds_[12] = &EffectiveDate_; break;
            case 13: aFlds_[13] = &StopDate_; break;
            case 14: aFlds_[14] = &City_; break;
            case 15: aFlds_[15] = &AddressFileVer_; break;
            case 16: aFlds_[16] = &AddressFileRid_; break;
            case 17: aFlds_[17] = &Salutation_; break;
            case 18: aFlds_[18] = &RegAddrCode_; break;
            case 19: aFlds_[19] = &ProvinceCanadaUS_; break;
            case 20: aFlds_[20] = &RetMailDate_; break;
            case 21: aFlds_[21] = &RetMailFlag_; break;
            case 22: aFlds_[22] = &RetMailReasonCode_; break;
            case 23: aFlds_[23] = &UnclmRetMailStage_; break;
            case 24: aFlds_[24] = &UnclmStmtDate_; break;
            case 25: aFlds_[25] = &UnclmRemitDate_; break;
            case 26: aFlds_[26] = &StageStampDate_; break;
            case 27: aFlds_[27] = &UnclmComment_; break;
            case 28: aFlds_[28] = &UpdShrTaxJuris_; break;
            case 29: aFlds_[29] = &UpdShrProvRes_; break;
            case 30: aFlds_[30] = &StageAssignBy_; break;
            case 31: aFlds_[31] = &SkipValidate_; break;
            case 32: aFlds_[32] = &VerifyStat_; break;
         }
...
const BFDataField* dsi_DSTC0072_REQRepeat_Record::getElementByIndex( unsigned int iField ) const
{
   return( ( const_cast< dsi_DSTC0072_REQRepeat_Record* >(this) )->getElementByIndex( iField ) );
}

unsigned long dsi_DSTC0072_REQRepeat_Record::getLargestDefinedField( void ) const
{
   return( 200 );
}

unsigned long dsi_DSTC0072_REQRepeat_Record::getDefinedByteLength( void ) const
{
   return( 1298 * sizeof( I_CHAR ) );
}

bool dsi_DSTC0072_REQRepeat_Record::exists( const BFFieldId& id ) const
{
   return dsi_DSTC0072_REQRepeat_Record::fieldExists( id );
}

bool dsi_DSTC0072_REQRepeat_Record::fieldExists( const BFFieldId& id )
{
   switch( id.getId() )
   {
