// BFDataImpl implementation file for DataSet DSTC0161.VW
...
// This function creates an instance of dsi_DSTC0161_VW
// The function is required by the factory class as that class may choke the compiler
// with excessive symbols if all of the required header files needed to be #include'd
BFDataImpl* create_dsi_DSTC0161_VW() { return new dsi_DSTC0161_VW; }

dsi_DSTC0161_VW::dsi_DSTC0161_VW()
: BFDataImpl( 40002608 )
...
BFDataImpl* dsi_DSTC0161_VW::clone()
{
   dsi_DSTC0161_VW* p = new dsi_DSTC0161_VW;
...
BFDataField* dsi_DSTC0161_VW::getElement( const BFFieldId& id )
{
   switch( id.getId() ) {
...
const BFDataField* dsi_DSTC0161_VW::getElement( const BFFieldId& id ) const
{
   return( ( const_cast< dsi_DSTC0161_VW* >(this) )->getElement( id ) );
}

BFDataField* dsi_DSTC0161_VW::getElementByIndex( unsigned int iField )
{
   if ( iField >=0 && iField < 16 )
   {
      ...
      if( NULL == pField )
      {
         switch(iField)
         {
            ...
            case 3: aFlds_[3] = &WarnParam1_; break;
            case 4: aFlds_[4] = &WarnCode2_; break;
            case 5: aFlds_[5] = &WarnDesc2_; break;
            case 6: aFlds_[6] = &WarnParam2_; break;
            case 7: aFlds_[7] = &WarnCode3_; break;
            case 8: aFlds_[8] = &WarnDesc3_; break;
            case 9: aFlds_[9] = &WarnParam3_; break;
            case 10: aFlds_[10] = &WarnCode4_; break;
            case 11: aFlds_[11] = &WarnDesc4_; break;
            case 12: aFlds_[12] = &WarnParam4_; break;
            case 13: aFlds_[13] = &WarnCode5_; break;
            case 14: aFlds_[14] = &WarnDesc5_; break;
...
const BFDataField* dsi_DSTC0161_VW::getElementByIndex( unsigned int iField ) const
{
   return( ( const_cast< dsi_DSTC0161_VW* >(this) )->getElementByIndex( iField ) );
}

unsigned long dsi_DSTC0161_VW::getLargestDefinedField( void ) const
{
   return( 60 );
}

unsigned long dsi_DSTC0161_VW::getDefinedByteLength( void ) const
{
   return( 636 * sizeof( I_CHAR ) );
}

bool dsi_DSTC0161_VW::exists( const BFFieldId& id ) const
{
   return dsi_DSTC0161_VW::fieldExists( id );
}

bool dsi_DSTC0161_VW::fieldExists( const BFFieldId& id )
{
   switch( id.getId() )
   {
