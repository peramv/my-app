// BFDataImpl header file for DataSet DSTC0326.VWRepeat_Record
...
class dsi_DSTC0326_VWRepeat_Record : public BFDataImpl 
{
public:
    // Constructors
    dsi_DSTC0326_VWRepeat_Record();
    virtual ~dsi_DSTC0326_VWRepeat_Record();
...
private:
    ...
    BFTextField_1 HasPendingTrades_;
    BFDateField LatestPendingTradeDeff_;
