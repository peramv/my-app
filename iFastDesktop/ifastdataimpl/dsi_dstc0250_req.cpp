// BFDataImpl implementation file for DataSet DSTC0250.REQ
...
// This function creates an instance of dsi_DSTC0250_REQ
// The function is required by the factory class as that class may choke the compiler
// with excessive symbols if all of the required header files needed to be #include'd
BFDataImpl* create_dsi_DSTC0250_REQ() { return new dsi_DSTC0250_REQ; }

dsi_DSTC0250_REQ::dsi_DSTC0250_REQ()
: BFDataImpl( 40003807 )
...
BFDataImpl* dsi_DSTC0250_REQ::clone()
{
   dsi_DSTC0250_REQ* p = new dsi_DSTC0250_REQ;
...
BFDataField* dsi_DSTC0250_REQ::getElement( const BFFieldId& id )
{
   switch( id.getId() ) {
...
const BFDataField* dsi_DSTC0250_REQ::getElement( const BFFieldId& id ) const
{
   return( ( const_cast< dsi_DSTC0250_REQ* >(this) )->getElement( id ) );
}

BFDataField* dsi_DSTC0250_REQ::getElementByIndex( unsigned int iField )
{
...
const BFDataField* dsi_DSTC0250_REQ::getElementByIndex( unsigned int iField ) const
{
   return( ( const_cast< dsi_DSTC0250_REQ* >(this) )->getElementByIndex( iField ) );
}

unsigned long dsi_DSTC0250_REQ::getLargestDefinedField( void ) const
{
   return( 100 );
}

unsigned long dsi_DSTC0250_REQ::getDefinedByteLength( void ) const
{
   return( 533 * sizeof( I_CHAR ) );
}

bool dsi_DSTC0250_REQ::exists( const BFFieldId& id ) const
{
   return dsi_DSTC0250_REQ::fieldExists( id );
}

bool dsi_DSTC0250_REQ::fieldExists( const BFFieldId& id )
{
   switch( id.getId() )
   {
