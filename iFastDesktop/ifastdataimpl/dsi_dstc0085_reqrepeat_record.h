// BFDataImpl header file for DataSet DSTC0085.REQRepeat_Record
...
class dsi_DSTC0085_REQRepeat_Record : public BFDataImpl 
{
public:
    // Constructors
    dsi_DSTC0085_REQRepeat_Record();
    virtual ~dsi_DSTC0085_REQRepeat_Record();
