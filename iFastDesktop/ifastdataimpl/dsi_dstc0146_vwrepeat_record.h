// BFDataImpl header file for DataSet DSTC0146.VWRepeat_Record
...
class dsi_DSTC0146_VWRepeat_Record : public BFDataImpl 
{
public:
   // Constructors
   dsi_DSTC0146_VWRepeat_Record();
   virtual ~dsi_DSTC0146_VWRepeat_Record();
