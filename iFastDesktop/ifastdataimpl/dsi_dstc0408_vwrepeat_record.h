// BFDataImpl header file for DataSet DSTC0408.VWRepeat_Record
...
class dsi_DSTC0408_VWRepeat_Record : public BFDataImpl 
{
public:
   // Constructors
   dsi_DSTC0408_VWRepeat_Record();
   virtual ~dsi_DSTC0408_VWRepeat_Record();
