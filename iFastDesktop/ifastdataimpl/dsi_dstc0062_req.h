// BFDataImpl header file for DataSet DSTC0062.REQ
...
class dsi_DSTC0062_REQ : public BFDataImpl 
{
public:
   // Constructors
   dsi_DSTC0062_REQ();
   virtual ~dsi_DSTC0062_REQ();
...
private:
   ...
   BFTextField_1 InclUnsettled_;
   BFTextField_1 Summary_;
   ...
   BFTextField_1 DescendingOrder_;
   BFTextField_1 CalculateMktValue_;
