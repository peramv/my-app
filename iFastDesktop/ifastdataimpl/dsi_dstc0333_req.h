// BFDataImpl header file for DataSet DSTC0333.REQ
...
class dsi_DSTC0333_REQ : public BFDataImpl 
{
public:
   // Constructors
   dsi_DSTC0333_REQ();
   virtual ~dsi_DSTC0333_REQ();
...
private:
   ...
   BFTextField_60 MsgSearchType_;
   BFTextField_60 CompanyCode_;
   BFNumericField EnvelopeID_;
