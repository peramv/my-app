// BFDataImpl implementation file for DataSet DSTC0332.REQ
...
// This function creates an instance of dsi_DSTC0332_REQ
// The function is required by the factory class as that class may choke the compiler
// with excessive symbols if all of the required header files needed to be #include'd
BFDataImpl* create_dsi_DSTC0332_REQ() { return new dsi_DSTC0332_REQ; }

dsi_DSTC0332_REQ::dsi_DSTC0332_REQ()
: BFDataImpl( 40005041 )
...
BFDataImpl* dsi_DSTC0332_REQ::clone()
{
   dsi_DSTC0332_REQ* p = new dsi_DSTC0332_REQ;
...
BFDataField* dsi_DSTC0332_REQ::getElement( const BFFieldId& id )
{
   switch( id.getId() ) {
...
const BFDataField* dsi_DSTC0332_REQ::getElement( const BFFieldId& id ) const
{
   return( ( const_cast< dsi_DSTC0332_REQ* >(this) )->getElement( id ) );
}

BFDataField* dsi_DSTC0332_REQ::getElementByIndex( unsigned int iField )
{
   if ( iField >=0 && iField < 13 )
   {
      ...
      if( NULL == pField )
      {
         switch(iField)
         {
            ...
            case 8: aFlds_[8] = &CompanyCode_; break;
            case 9: aFlds_[9] = &NetworkID_; break;
            case 10: aFlds_[10] = &StartDate_; break;
            case 11: aFlds_[11] = &EndDate_; break;
            case 12: aFlds_[12] = &FileName_; break;
         }
...
const BFDataField* dsi_DSTC0332_REQ::getElementByIndex( unsigned int iField ) const
{
   return( ( const_cast< dsi_DSTC0332_REQ* >(this) )->getElementByIndex( iField ) );
}

unsigned long dsi_DSTC0332_REQ::getLargestDefinedField( void ) const
{
   return( 100 );
}

unsigned long dsi_DSTC0332_REQ::getDefinedByteLength( void ) const
{
   return( 611 * sizeof( I_CHAR ) );
}

bool dsi_DSTC0332_REQ::exists( const BFFieldId& id ) const
{
   return dsi_DSTC0332_REQ::fieldExists( id );
}

bool dsi_DSTC0332_REQ::fieldExists( const BFFieldId& id )
{
   switch( id.getId() )
   {
