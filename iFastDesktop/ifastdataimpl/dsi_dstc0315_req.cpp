// BFDataImpl implementation file for DataSet DSTC0315.REQ
...
// This function creates an instance of dsi_DSTC0315_REQ
// The function is required by the factory class as that class may choke the compiler
// with excessive symbols if all of the required header files needed to be #include'd
BFDataImpl* create_dsi_DSTC0315_REQ() { return new dsi_DSTC0315_REQ; }

dsi_DSTC0315_REQ::dsi_DSTC0315_REQ()
: BFDataImpl( 40004730 )
...
BFDataImpl* dsi_DSTC0315_REQ::clone()
{
   dsi_DSTC0315_REQ* p = new dsi_DSTC0315_REQ;
...
BFDataField* dsi_DSTC0315_REQ::getElement( const BFFieldId& id )
{
   switch( id.getId() ) {
...
const BFDataField* dsi_DSTC0315_REQ::getElement( const BFFieldId& id ) const
{
   return( ( const_cast< dsi_DSTC0315_REQ* >(this) )->getElement( id ) );
}

BFDataField* dsi_DSTC0315_REQ::getElementByIndex( unsigned int iField )
{
   if ( iField >=0 && iField < 12 )
   {
      ...
      if( NULL == pField )
      {
         switch(iField)
         {
            ...
            case 10: aFlds_[10] = &AgentCode_; break;
            case 11: aFlds_[11] = &AsofDate_; break;
         }
...
const BFDataField* dsi_DSTC0315_REQ::getElementByIndex( unsigned int iField ) const
{
   return( ( const_cast< dsi_DSTC0315_REQ* >(this) )->getElementByIndex( iField ) );
}

unsigned long dsi_DSTC0315_REQ::getLargestDefinedField( void ) const
{
   return( 100 );
}

unsigned long dsi_DSTC0315_REQ::getDefinedByteLength( void ) const
{
   return( 601 * sizeof( I_CHAR ) );
}

bool dsi_DSTC0315_REQ::exists( const BFFieldId& id ) const
{
   return dsi_DSTC0315_REQ::fieldExists( id );
}

bool dsi_DSTC0315_REQ::fieldExists( const BFFieldId& id )
{
   switch( id.getId() )
   {
