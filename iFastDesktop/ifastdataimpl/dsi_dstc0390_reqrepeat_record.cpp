// BFDataImpl implementation file for DataSet DSTC0390.REQRepeat_Record
...
// This function creates an instance of dsi_DSTC0390_REQRepeat_Record
// The function is required by the factory class as that class may choke the compiler
// with excessive symbols if all of the required header files needed to be #include'd
BFDataImpl* create_dsi_DSTC0390_REQRepeat_Record() { return new dsi_DSTC0390_REQRepeat_Record; }

dsi_DSTC0390_REQRepeat_Record::dsi_DSTC0390_REQRepeat_Record()
: BFDataImpl( 40005821 )
...
BFDataImpl* dsi_DSTC0390_REQRepeat_Record::clone()
{
    dsi_DSTC0390_REQRepeat_Record* p = new dsi_DSTC0390_REQRepeat_Record;
...
BFDataField* dsi_DSTC0390_REQRepeat_Record::getElement( const BFFieldId& id )
{
    switch( id.getId() ) {
...
const BFDataField* dsi_DSTC0390_REQRepeat_Record::getElement( const BFFieldId& id ) const
{
   return( ( const_cast< dsi_DSTC0390_REQRepeat_Record* >(this) )->getElement( id ) );
}

BFDataField* dsi_DSTC0390_REQRepeat_Record::getElementByIndex( unsigned int iField )
{
    if ( iField >=0 && iField < 18 )
    {
        ...
        if( NULL == pField )
        {
            switch(iField)
            {
                ...
                case 1: aFlds_[1] = &RegDocStatus_; break;
                case 2: aFlds_[2] = &DocReceivedDate_; break;
                case 3: aFlds_[3] = &RegDocRemarks_; break;
...
const BFDataField* dsi_DSTC0390_REQRepeat_Record::getElementByIndex( unsigned int iField ) const
{
    return( ( const_cast< dsi_DSTC0390_REQRepeat_Record* >(this) )->getElementByIndex( iField ) );
}

unsigned long dsi_DSTC0390_REQRepeat_Record::getLargestDefinedField( void ) const
{
    return( 256 );
}

unsigned long dsi_DSTC0390_REQRepeat_Record::getDefinedByteLength( void ) const
{
    return( 981 * sizeof( I_CHAR ) );
}

bool dsi_DSTC0390_REQRepeat_Record::exists( const BFFieldId& id ) const
{
    return dsi_DSTC0390_REQRepeat_Record::fieldExists( id );
}

bool dsi_DSTC0390_REQRepeat_Record::fieldExists( const BFFieldId& id )
{
    switch( id.getId() )
    {
