// BFDataImpl header file for DataSet DSTC0127.REQ
...
class dsi_DSTC0127_REQ : public BFDataImpl 
{
public:
   // Constructors
   dsi_DSTC0127_REQ();
   virtual ~dsi_DSTC0127_REQ();
...
private:
   ...
   BFTextField_60 BatchSrchType_;
   BFTextField_60 PayType_;
   BFTextField_60 TransType_;
   BFTextField_1 SupTransNo_;
