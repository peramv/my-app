// BFDataImpl header file for DataSet DSTC0263.VW
...
class dsi_DSTC0263_VW : public BFDataImpl 
{
public:
   // Constructors
   dsi_DSTC0263_VW();
   virtual ~dsi_DSTC0263_VW();
...
private:
   ...
   // Field Declarations
   BFTextField_60 DefaultRebFreq_;
   BFTextField_60 DefaultRoundFund_;
   BFTextField_60 DefaultRoundClass_;
   BFTextField_1 UpdAMSOnNewAcct_;
   BFTextField_1 DefaultAllocOverride_;
   BFTextField_1 PACSWPOverride_;
   BFTextField_1 NextRebDateApplicable_;
