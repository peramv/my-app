// Field IDs and DataIDs for DataSet DSTC0024.VW
...
#include <ifastdataimpl/dse_dstc0024_vwrepeat_record.hpp>
namespace ifds
{
   extern __declspec(dllimport) const BFDataId DSTC0024_VW;
