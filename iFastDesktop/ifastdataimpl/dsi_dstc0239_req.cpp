// BFDataImpl implementation file for DataSet DSTC0239.REQ
...
// This function creates an instance of dsi_DSTC0239_REQ
// The function is required by the factory class as that class may choke the compiler
// with excessive symbols if all of the required header files needed to be #include'd
BFDataImpl* create_dsi_DSTC0239_REQ() { return new dsi_DSTC0239_REQ; }

dsi_DSTC0239_REQ::dsi_DSTC0239_REQ()
: BFDataImpl( 40003666 )
...
BFDataImpl* dsi_DSTC0239_REQ::clone()
{
   dsi_DSTC0239_REQ* p = new dsi_DSTC0239_REQ;
...
BFDataField* dsi_DSTC0239_REQ::getElement( const BFFieldId& id )
{
   switch( id.getId() ) {
...
const BFDataField* dsi_DSTC0239_REQ::getElement( const BFFieldId& id ) const
{
   return( ( const_cast< dsi_DSTC0239_REQ* >(this) )->getElement( id ) );
}

BFDataField* dsi_DSTC0239_REQ::getElementByIndex( unsigned int iField )
{
...
const BFDataField* dsi_DSTC0239_REQ::getElementByIndex( unsigned int iField ) const
{
   return( ( const_cast< dsi_DSTC0239_REQ* >(this) )->getElementByIndex( iField ) );
}

unsigned long dsi_DSTC0239_REQ::getLargestDefinedField( void ) const
{
   return( 200 );
}

unsigned long dsi_DSTC0239_REQ::getDefinedByteLength( void ) const
{
   return( 748 * sizeof( I_CHAR ) );
}

bool dsi_DSTC0239_REQ::exists( const BFFieldId& id ) const
{
   return dsi_DSTC0239_REQ::fieldExists( id );
}

bool dsi_DSTC0239_REQ::fieldExists( const BFFieldId& id )
{
   switch( id.getId() )
   {
