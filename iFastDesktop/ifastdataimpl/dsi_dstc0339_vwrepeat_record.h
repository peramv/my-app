// BFDataImpl header file for DataSet DSTC0339.VWRepeat_Record
...
class dsi_DSTC0339_VWRepeat_Record : public BFDataImpl 
{
public:
   // Constructors
   dsi_DSTC0339_VWRepeat_Record();
   virtual ~dsi_DSTC0339_VWRepeat_Record();
