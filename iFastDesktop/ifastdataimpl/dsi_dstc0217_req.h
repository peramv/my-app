// BFDataImpl header file for DataSet DSTC0217.REQ
...
class dsi_DSTC0217_REQ : public BFDataImpl 
{
public:
   // Constructors
   dsi_DSTC0217_REQ();
   virtual ~dsi_DSTC0217_REQ();
...
private:
   ...
   BFTextField_10 FullRed_;
   BFTextField_60 RedCode_;
   BFTextField_10 AcctLvlDSC_;
