// BFDataImpl header file for DataSet DSTC0019.REQ
...
class dsi_DSTC0019_REQ : public BFDataImpl 
{
public:
    // Constructors
    dsi_DSTC0019_REQ();
    virtual ~dsi_DSTC0019_REQ();
...
private:
    ...
    BFTextField<3> AcctLvlDSCFund_;
    BFTextField_10 AllFundGroupMode_;
