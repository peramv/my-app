// BFDataImpl implementation file for DataSet DSTC0004.VW
...
// This function creates an instance of dsi_DSTC0004_VW
// The function is required by the factory class as that class may choke the compiler
// with excessive symbols if all of the required header files needed to be #include'd
BFDataImpl* create_dsi_DSTC0004_VW() { return new dsi_DSTC0004_VW; }

dsi_DSTC0004_VW::dsi_DSTC0004_VW()
...
BFDataImpl* dsi_DSTC0004_VW::clone()
{
...
BFDataField* dsi_DSTC0004_VW::getElement( const BFFieldId& id )
{
   switch( id.getId() ) {
...
const BFDataField* dsi_DSTC0004_VW::getElement( const BFFieldId& id ) const
{
   return( ( const_cast< dsi_DSTC0004_VW* >(this) )->getElement( id ) );
}
...
const BFDataField* dsi_DSTC0004_VW::getElementByIndex( unsigned int iField ) const
{
   return( ( const_cast< dsi_DSTC0004_VW* >(this) )->getElementByIndex( iField ) );
}

unsigned long dsi_DSTC0004_VW::getLargestDefinedField( void ) const
{
   return( 100 );
}
...
{
   return dsi_DSTC0004_VW::fieldExists( id );
}

bool dsi_DSTC0004_VW::fieldExists( const BFFieldId& id )
{
   switch( id.getId() )
   {
