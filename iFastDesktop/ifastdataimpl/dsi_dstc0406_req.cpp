// BFDataImpl implementation file for DataSet DSTC0406.REQ
...
// This function creates an instance of dsi_DSTC0406_REQ
// The function is required by the factory class as that class may choke the compiler
// with excessive symbols if all of the required header files needed to be #include'd
BFDataImpl* create_dsi_DSTC0406_REQ() { return new dsi_DSTC0406_REQ; }

dsi_DSTC0406_REQ::dsi_DSTC0406_REQ()
: BFDataImpl( 40006230 )
...
BFDataImpl* dsi_DSTC0406_REQ::clone()
{
   dsi_DSTC0406_REQ* p = new dsi_DSTC0406_REQ;
...
BFDataField* dsi_DSTC0406_REQ::getElement( const BFFieldId& id )
{
   switch( id.getId() ) {
...
const BFDataField* dsi_DSTC0406_REQ::getElement( const BFFieldId& id ) const
{
   return( ( const_cast< dsi_DSTC0406_REQ* >(this) )->getElement( id ) );
}

BFDataField* dsi_DSTC0406_REQ::getElementByIndex( unsigned int iField )
{
   if ( iField >=0 && iField < 16 )
   {
      ...
      if( NULL == pField )
      {
         switch(iField)
         {
            ...
            case 15: aFlds_[15] = &OverrideRepeats_; break;
         }
...
const BFDataField* dsi_DSTC0406_REQ::getElementByIndex( unsigned int iField ) const
{
   return( ( const_cast< dsi_DSTC0406_REQ* >(this) )->getElementByIndex( iField ) );
}

unsigned long dsi_DSTC0406_REQ::getLargestDefinedField( void ) const
{
   return( 100 );
}

unsigned long dsi_DSTC0406_REQ::getDefinedByteLength( void ) const
{
   return( 718 * sizeof( I_CHAR ) );
}

bool dsi_DSTC0406_REQ::exists( const BFFieldId& id ) const
{
   return dsi_DSTC0406_REQ::fieldExists( id );
}

bool dsi_DSTC0406_REQ::fieldExists( const BFFieldId& id )
{
   switch( id.getId() )
   {
