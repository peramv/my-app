// Field IDs and DataIDs for DataSet DSTC0018.VW
...
#include <ifastdataimpl/dse_dstc0018_vwrepeat_record.hpp>
namespace ifds
{
   extern __declspec(dllimport) const BFDataId DSTC0018_VW;
