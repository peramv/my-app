// BFDataImpl implementation file for DataSet DSTC0287.REQ
...
// This function creates an instance of dsi_DSTC0287_REQ
// The function is required by the factory class as that class may choke the compiler
// with excessive symbols if all of the required header files needed to be #include'd
BFDataImpl* create_dsi_DSTC0287_REQ() { return new dsi_DSTC0287_REQ; }

dsi_DSTC0287_REQ::dsi_DSTC0287_REQ()
: BFDataImpl( 40004392 )
...
BFDataImpl* dsi_DSTC0287_REQ::clone()
{
   dsi_DSTC0287_REQ* p = new dsi_DSTC0287_REQ;
...
BFDataField* dsi_DSTC0287_REQ::getElement( const BFFieldId& id )
{
   switch( id.getId() ) {
...
const BFDataField* dsi_DSTC0287_REQ::getElement( const BFFieldId& id ) const
{
   return( ( const_cast< dsi_DSTC0287_REQ* >(this) )->getElement( id ) );
}

BFDataField* dsi_DSTC0287_REQ::getElementByIndex( unsigned int iField )
{
   if ( iField >=0 && iField < 14 )
   {
      ...
      if( NULL == pField )
      {
         switch(iField)
         {
            ...
            case 12: aFlds_[12] = &SortBy_; break;
            case 13: aFlds_[13] = &SortOrder_; break;
         }
...
const BFDataField* dsi_DSTC0287_REQ::getElementByIndex( unsigned int iField ) const
{
   return( ( const_cast< dsi_DSTC0287_REQ* >(this) )->getElementByIndex( iField ) );
}

unsigned long dsi_DSTC0287_REQ::getLargestDefinedField( void ) const
{
   return( 200 );
}

unsigned long dsi_DSTC0287_REQ::getDefinedByteLength( void ) const
{
   return( 812 * sizeof( I_CHAR ) );
}

bool dsi_DSTC0287_REQ::exists( const BFFieldId& id ) const
{
   return dsi_DSTC0287_REQ::fieldExists( id );
}

bool dsi_DSTC0287_REQ::fieldExists( const BFFieldId& id )
{
   switch( id.getId() )
   {
