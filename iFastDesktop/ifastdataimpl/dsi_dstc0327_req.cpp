// BFDataImpl implementation file for DataSet DSTC0327.REQ
...
// This function creates an instance of dsi_DSTC0327_REQ
// The function is required by the factory class as that class may choke the compiler
// with excessive symbols if all of the required header files needed to be #include'd
BFDataImpl* create_dsi_DSTC0327_REQ() { return new dsi_DSTC0327_REQ; }

dsi_DSTC0327_REQ::dsi_DSTC0327_REQ()
: BFDataImpl( 40004896 )
...
BFDataImpl* dsi_DSTC0327_REQ::clone()
{
   dsi_DSTC0327_REQ* p = new dsi_DSTC0327_REQ;
...
BFDataField* dsi_DSTC0327_REQ::getElement( const BFFieldId& id )
{
   switch( id.getId() ) {
...
const BFDataField* dsi_DSTC0327_REQ::getElement( const BFFieldId& id ) const
{
   return( ( const_cast< dsi_DSTC0327_REQ* >(this) )->getElement( id ) );
}

BFDataField* dsi_DSTC0327_REQ::getElementByIndex( unsigned int iField )
{
...
const BFDataField* dsi_DSTC0327_REQ::getElementByIndex( unsigned int iField ) const
{
   return( ( const_cast< dsi_DSTC0327_REQ* >(this) )->getElementByIndex( iField ) );
}

unsigned long dsi_DSTC0327_REQ::getLargestDefinedField( void ) const
{
   return( 200 );
}

unsigned long dsi_DSTC0327_REQ::getDefinedByteLength( void ) const
{
   return( 689 * sizeof( I_CHAR ) );
}

bool dsi_DSTC0327_REQ::exists( const BFFieldId& id ) const
{
   return dsi_DSTC0327_REQ::fieldExists( id );
}

bool dsi_DSTC0327_REQ::fieldExists( const BFFieldId& id )
{
   switch( id.getId() )
   {
