// BFDataImpl implementation file for DataSet DSTC0357.REQRepeat_Record
...
// This function creates an instance of dsi_DSTC0357_REQRepeat_Record
// The function is required by the factory class as that class may choke the compiler
// with excessive symbols if all of the required header files needed to be #include'd
BFDataImpl* create_dsi_DSTC0357_REQRepeat_Record() { return new dsi_DSTC0357_REQRepeat_Record; }

dsi_DSTC0357_REQRepeat_Record::dsi_DSTC0357_REQRepeat_Record()
: BFDataImpl( 40005357 )
...
BFDataImpl* dsi_DSTC0357_REQRepeat_Record::clone()
{
   dsi_DSTC0357_REQRepeat_Record* p = new dsi_DSTC0357_REQRepeat_Record;
   p->RunMode_ = RunMode_;
...
BFDataField* dsi_DSTC0357_REQRepeat_Record::getElement( const BFFieldId& id )
{
   switch( id.getId() ) {
...
const BFDataField* dsi_DSTC0357_REQRepeat_Record::getElement( const BFFieldId& id ) const
{
   return( ( const_cast< dsi_DSTC0357_REQRepeat_Record* >(this) )->getElement( id ) );
}

BFDataField* dsi_DSTC0357_REQRepeat_Record::getElementByIndex( unsigned int iField )
{
...
const BFDataField* dsi_DSTC0357_REQRepeat_Record::getElementByIndex( unsigned int iField ) const
{
   return( ( const_cast< dsi_DSTC0357_REQRepeat_Record* >(this) )->getElementByIndex( iField ) );
}

unsigned long dsi_DSTC0357_REQRepeat_Record::getLargestDefinedField( void ) const
{
   return( 60 );
}

unsigned long dsi_DSTC0357_REQRepeat_Record::getDefinedByteLength( void ) const
{
   return( 422 * sizeof( I_CHAR ) );
}

bool dsi_DSTC0357_REQRepeat_Record::exists( const BFFieldId& id ) const
{
   return dsi_DSTC0357_REQRepeat_Record::fieldExists( id );
}

bool dsi_DSTC0357_REQRepeat_Record::fieldExists( const BFFieldId& id )
{
   switch( id.getId() )
   {
