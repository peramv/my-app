// BFDataImpl header file for DataSet DSTC0039.REQ
...
class dsi_DSTC0039_REQ : public BFDataImpl 
{
public:
   // Constructors
   dsi_DSTC0039_REQ();
   virtual ~dsi_DSTC0039_REQ();
...
private:
   ...
   BFTextField_60 NewPasswd_;
   BFTextField_60 OldPassword_;
