// BFDataImpl header file for DataSet DSTC0439.REQ
...
class dsi_DSTC0439_REQ : public BFDataImpl 
{
public:
   // Constructors
   dsi_DSTC0439_REQ();
   virtual ~dsi_DSTC0439_REQ();
...
private:
   ...
   BFTextField_60 BrokerCodeNew_;
   BFTextField_60 BranchCodeNew_;
   BFTextField_60 SlsRepCodeNew_;
