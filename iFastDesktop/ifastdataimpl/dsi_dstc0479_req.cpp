// BFDataImpl implementation file for DataSet DSTC0479.REQ
...
// This function creates an instance of dsi_DSTC0479_REQ
// The function is required by the factory class as that class may choke the compiler
// with excessive symbols if all of the required header files needed to be #include'd
BFDataImpl* create_dsi_DSTC0479_REQ() { return new dsi_DSTC0479_REQ; }

dsi_DSTC0479_REQ::dsi_DSTC0479_REQ()
: BFDataImpl( 40007730 )
...
, ToAccount_( ifds::ToAccount, &ifds::s_FldProp_ToAccount )
...
BFDataImpl* dsi_DSTC0479_REQ::clone()
{
    dsi_DSTC0479_REQ* p = new dsi_DSTC0479_REQ;
    ...
    p->ToFund_ = ToFund_;
    p->ToClass_ = ToClass_;
    p->ToAccount_ = ToAccount_;
	p->TradeInDate_ = TradeInDate_;
    return(p);
}

BFDataField* dsi_DSTC0479_REQ::getElement( const BFFieldId& id )
{
    switch( id.getId() ) {
        ...
        case 40000723: return ( &ToAccount_ ); break; // ToAccount
		case 40007782: return ( &TradeInDate_ ); break; // TradeInDate
    }
    return( NULL );
}

const BFDataField* dsi_DSTC0479_REQ::getElement( const BFFieldId& id ) const
{
   return( ( const_cast< dsi_DSTC0479_REQ* >(this) )->getElement( id ) );
}

BFDataField* dsi_DSTC0479_REQ::getElementByIndex( unsigned int iField )
{
    if ( iField >=0 && iField < 29 )
    {
        ...
        if( NULL == pField )
        {
            switch(iField)
            {
                ...
                case 27: aFlds_[27] = &ToAccount_; break;
				case 28: aFlds_[28] = &TradeInDate_; break;
            }
...
const BFDataField* dsi_DSTC0479_REQ::getElementByIndex( unsigned int iField ) const
{
    return( ( const_cast< dsi_DSTC0479_REQ* >(this) )->getElementByIndex( iField ) );
}

unsigned long dsi_DSTC0479_REQ::getLargestDefinedField( void ) const
{
    return( 200 );
}

unsigned long dsi_DSTC0479_REQ::getDefinedByteLength( void ) const
{
    return( 1476 * sizeof( I_CHAR ) );
}

bool dsi_DSTC0479_REQ::exists( const BFFieldId& id ) const
{
    return dsi_DSTC0479_REQ::fieldExists( id );
}

bool dsi_DSTC0479_REQ::fieldExists( const BFFieldId& id )
{
    switch( id.getId() )
    {
