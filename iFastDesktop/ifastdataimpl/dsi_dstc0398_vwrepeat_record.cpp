// BFDataImpl implementation file for DataSet DSTC0398.VWRepeat_Record
...
// This function creates an instance of dsi_DSTC0398_VWRepeat_Record
// The function is required by the factory class as that class may choke the compiler
// with excessive symbols if all of the required header files needed to be #include'd
BFDataImpl* create_dsi_DSTC0398_VWRepeat_Record() { return new dsi_DSTC0398_VWRepeat_Record; }

dsi_DSTC0398_VWRepeat_Record::dsi_DSTC0398_VWRepeat_Record()
: BFDataImpl( 40006033 )
...
, TotCBAmount_( ifds::TotCBAmount, &ifds::s_FldProp_TotCBAmount )
{
   cFields_ = 23;
...
BFDataImpl* dsi_DSTC0398_VWRepeat_Record::clone()
{
   dsi_DSTC0398_VWRepeat_Record* p = new dsi_DSTC0398_VWRepeat_Record;
   ...
   p->RecType_ = RecType_;
   p->TotCBAmount_ = TotCBAmount_;
   return(p);
}

BFDataField* dsi_DSTC0398_VWRepeat_Record::getElement( const BFFieldId& id )
{
   switch( id.getId() ) {
      ...
      case 40007503: return ( &TotCBAmount_ ); break; // TotCBAmount
   }
   return( NULL );
}

const BFDataField* dsi_DSTC0398_VWRepeat_Record::getElement( const BFFieldId& id ) const
{
   return( ( const_cast< dsi_DSTC0398_VWRepeat_Record* >(this) )->getElement( id ) );
}

BFDataField* dsi_DSTC0398_VWRepeat_Record::getElementByIndex( unsigned int iField )
{
   if ( iField >=0 && iField < 23 )
   {
      ...
      if( NULL == pField )
      {
         switch(iField)
         {
            ...
            case 20: aFlds_[20] = &FeePercent_; break;
            case 21: aFlds_[21] = &RecType_; break;
            case 22: aFlds_[22] = &TotCBAmount_; break;
         }
...
const BFDataField* dsi_DSTC0398_VWRepeat_Record::getElementByIndex( unsigned int iField ) const
{
   return( ( const_cast< dsi_DSTC0398_VWRepeat_Record* >(this) )->getElementByIndex( iField ) );
}

unsigned long dsi_DSTC0398_VWRepeat_Record::getLargestDefinedField( void ) const
{
   return( 200 );
}

unsigned long dsi_DSTC0398_VWRepeat_Record::getDefinedByteLength( void ) const
{
   return( 1027 * sizeof( I_CHAR ) );
}

bool dsi_DSTC0398_VWRepeat_Record::exists( const BFFieldId& id ) const
{
   return dsi_DSTC0398_VWRepeat_Record::fieldExists( id );
}

bool dsi_DSTC0398_VWRepeat_Record::fieldExists( const BFFieldId& id )
{
   switch( id.getId() )
   {
