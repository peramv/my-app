// BFDataImpl implementation file for DataSet DSTC0462.REQ
...
// This function creates an instance of dsi_DSTC0462_REQ
// The function is required by the factory class as that class may choke the compiler
// with excessive symbols if all of the required header files needed to be #include'd
BFDataImpl* create_dsi_DSTC0462_REQ() { return new dsi_DSTC0462_REQ; }

dsi_DSTC0462_REQ::dsi_DSTC0462_REQ()
: BFDataImpl( 40007375 )
...
BFDataImpl* dsi_DSTC0462_REQ::clone()
{
   dsi_DSTC0462_REQ* p = new dsi_DSTC0462_REQ;
...
BFDataField* dsi_DSTC0462_REQ::getElement( const BFFieldId& id )
{
   switch( id.getId() ) {
...
const BFDataField* dsi_DSTC0462_REQ::getElement( const BFFieldId& id ) const
{
   return( ( const_cast< dsi_DSTC0462_REQ* >(this) )->getElement( id ) );
}

BFDataField* dsi_DSTC0462_REQ::getElementByIndex( unsigned int iField )
{
...
const BFDataField* dsi_DSTC0462_REQ::getElementByIndex( unsigned int iField ) const
{
   return( ( const_cast< dsi_DSTC0462_REQ* >(this) )->getElementByIndex( iField ) );
}

unsigned long dsi_DSTC0462_REQ::getLargestDefinedField( void ) const
{
   return( 200 );
}

unsigned long dsi_DSTC0462_REQ::getDefinedByteLength( void ) const
{
   return( 888 * sizeof( I_CHAR ) );
}

bool dsi_DSTC0462_REQ::exists( const BFFieldId& id ) const
{
   return dsi_DSTC0462_REQ::fieldExists( id );
}

bool dsi_DSTC0462_REQ::fieldExists( const BFFieldId& id )
{
   switch( id.getId() )
   {
