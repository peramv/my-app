// BFDataImpl implementation file for DataSet DSTC0249.VWRepeat_Record
...
// This function creates an instance of dsi_DSTC0249_VWRepeat_Record
// The function is required by the factory class as that class may choke the compiler
// with excessive symbols if all of the required header files needed to be #include'd
BFDataImpl* create_dsi_DSTC0249_VWRepeat_Record() { return new dsi_DSTC0249_VWRepeat_Record; }

dsi_DSTC0249_VWRepeat_Record::dsi_DSTC0249_VWRepeat_Record()
: BFDataImpl( 40003750 )
...
BFDataImpl* dsi_DSTC0249_VWRepeat_Record::clone()
{
   dsi_DSTC0249_VWRepeat_Record* p = new dsi_DSTC0249_VWRepeat_Record;
...
BFDataField* dsi_DSTC0249_VWRepeat_Record::getElement( const BFFieldId& id )
{
   switch( id.getId() ) {
...
const BFDataField* dsi_DSTC0249_VWRepeat_Record::getElement( const BFFieldId& id ) const
{
   return( ( const_cast< dsi_DSTC0249_VWRepeat_Record* >(this) )->getElement( id ) );
}

BFDataField* dsi_DSTC0249_VWRepeat_Record::getElementByIndex( unsigned int iField )
{
...
const BFDataField* dsi_DSTC0249_VWRepeat_Record::getElementByIndex( unsigned int iField ) const
{
   return( ( const_cast< dsi_DSTC0249_VWRepeat_Record* >(this) )->getElementByIndex( iField ) );
}

unsigned long dsi_DSTC0249_VWRepeat_Record::getLargestDefinedField( void ) const
{
   return( 60 );
}

unsigned long dsi_DSTC0249_VWRepeat_Record::getDefinedByteLength( void ) const
{
   return( 385 * sizeof( I_CHAR ) );
}

bool dsi_DSTC0249_VWRepeat_Record::exists( const BFFieldId& id ) const
{
   return dsi_DSTC0249_VWRepeat_Record::fieldExists( id );
}

bool dsi_DSTC0249_VWRepeat_Record::fieldExists( const BFFieldId& id )
{
   switch( id.getId() )
   {
