// BFDataImpl header file for DataSet DSTC0199.REQ
...
class dsi_DSTC0199_REQ : public BFDataImpl 
{
public:
   // Constructors
   dsi_DSTC0199_REQ();
   virtual ~dsi_DSTC0199_REQ();
...
private:
   ...
   BFTextField<20> AccrualType_;
   BFDecimalField RunTotal_;
