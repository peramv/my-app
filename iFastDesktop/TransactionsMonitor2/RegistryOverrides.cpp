   ...
   *pdwcValueType = *pdwcValueData = *pdwcValueName = 0;
   ...
   if( !stricmp( path, fake::MFDSTC_ADMIN ) ) {
      ...
      switch(i) {
         ...
         case 2: SET_OVERRIDE_STR( "transactionsmonitor", "MFDSTC" ); break;
         case 3: SET_OVERRIDE_STR( "transactionsmonitor_d", "MFDSTC" ); break;
		 case 4: SET_OVERRIDE_STR( "transactionsmonitor2", "MFDSTC" ); break;
         case 5: SET_OVERRIDE_STR( "transactionsmonitor2_d", "MFDSTC" ); break;
      }
   }
   else if ( !stricmp( path, fake::TESESSION_EXTRAEAL ) ) {
      switch(i) {
