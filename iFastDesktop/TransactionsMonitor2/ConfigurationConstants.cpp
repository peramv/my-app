...
namespace CONFIGURATION_CONSTANTS
{
   ...
   CONFIGURATION_CONSTANTS_TAG( SMQMaxConnections );

   CONFIGURATION_CONSTANTS_TAG( AMQBrokerURLs );
   CONFIGURATION_CONSTANTS_TAG( AMQSingleQueue );
   CONFIGURATION_CONSTANTS_TAG( AMQMultiQueue );
   CONFIGURATION_CONSTANTS_TAG( AMQUser );
   CONFIGURATION_CONSTANTS_TAG( AMQPassword );
   CONFIGURATION_CONSTANTS_TAG( AMQWaitTimeout );
   CONFIGURATION_CONSTANTS_TAG( AMQWorkEventTopicPrefix );
   CONFIGURATION_CONSTANTS_TAG( AMQWorkEventReplyTopic );
   CONFIGURATION_CONSTANTS_TAG( AMQWorkAgentKeepAliveTopic );
   CONFIGURATION_CONSTANTS_TAG( AMQTimeToLive );
   CONFIGURATION_CONSTANTS_TAG( AMQMaxConnections );
