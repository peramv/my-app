...
private:
   SMQTest& smqTest_;
public:
	CSonicConnectionTest(SMQTest& smqTest, CWnd* pParent = NULL);   // standard constructor
	virtual ~CSonicConnectionTest();

   SMQTest& getSMQTest() { return smqTest_; }

// Dialog Data
	enum { IDD = IDD_CONNECTION_TEST };
