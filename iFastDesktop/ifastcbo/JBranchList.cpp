...
namespace
{
   const I_CHAR * const CLASSNAME = I_( "JBranchList" );
}

JBranchList::JBranchList( BFAbstractCBO &parent )
: MFCanBFCbo( parent ),
_requestData(ifds::DSTC0091_REQ)
{
   TRACE_CONSTRUCTOR( CLASSNAME, NULL_STRING );
}

//*****************************************************************************
JBranchList::~JBranchList()
{
   TRACE_DESTRUCTOR( CLASSNAME );
}

//*****************************************************************************
SEVERITY JBranchList::init( const DString&  dstrBrokerCode, 
...

{
   ...
   ReceiveData(DSTC_REQUEST::BRANCH, _requestData, ifds::DSTC0091_VW, DSTCRequestor( getSecurity() ,false) );

   return(GETCURRENTHIGHESTSEVERITY());
}

SEVERITY JBranchList::getMore()
{
...
//******************************************************************************
/* $Log:   Y:/VCS/BF iFAST/ifastcbo/JBranchList.cpp-arc  $
 * 
 *    Rev 1.11   Nov 14 2004 14:48:52   purdyech
 * PET910 - .NET Conversion
 * 
 *    Rev 1.10   Mar 21 2003 18:17:18   PURDYECH
 ...
 * 
 *    Rev 1.6   03 May 2001 14:06:42   SMITHDAV
 ...
 * 
 *    Rev 1.3   Dec 06 2000 13:45:20   OLTEANCR
 * modif. ReceiveData
 * 
...
// 
//    Rev 1.0   Feb 25 2000 16:12:28   FENGYONG
// Initial revision.
// 
