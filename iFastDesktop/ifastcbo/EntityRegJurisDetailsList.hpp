...
//******************************************************************************
//
// ^FILE   : EntityRegJurisDetailsList.hpp
// ^AUTHOR : 
...
class IFASTCBO_LINKAGE EntityRegJurisDetailsList : public MFCanBFCbo, private boost::noncopyable
{
public:
	EntityRegJurisDetailsList( BFAbstractCBO &parent );
	virtual ~EntityRegJurisDetailsList( void );
