...
class IFASTCBO_LINKAGE CrossSysTransferOut : virtual public Redemption
{
public:
   CrossSysTransferOut (BFAbstractCBO &parent);
   virtual ~CrossSysTransferOut ();
...
private:
   ...
   bool _blTaxable;
   DString _dstrEAPEarningCodes;
};

//******************************************************************************
//              Revision Control Entries
//******************************************************************************
/* $Log:   Y:/VCS/BF iFAST/ifastcbo/CrossSysTransferOut.hpp-arc  $
