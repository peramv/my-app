...
//******************************************************************************
//
// ^FILE      : DistributorBankInstructions.hpp
...
class IFASTCBO_LINKAGE DistributorBankInstructions : public BankInstructionsEx
{
public:
   DistributorBankInstructions ( BFAbstractCBO &parent, 
                                 const DString &bankType);
   virtual ~DistributorBankInstructions();
...
//******************************************************************************
//
/* $Log:   Y:/VCS/BF iFAST/ifastcbo/DistributorBankInstructions.hpp-arc  $
//
