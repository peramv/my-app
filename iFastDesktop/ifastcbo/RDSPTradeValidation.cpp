...
namespace CND
{
	...
	extern const long ERR_RDSP_INSUFFICIENT_GRANT_BOND_BALANCE;
	extern const long WARN_RDSP_INSUFFICIENT_GRANT_BOND_BALANCE;
	extern const long ERR_RDSP_GRANT_RETURN_CANNOT_BE_GREATER_THAN_GRANT_PURCHASE;
	extern const long WARN_RDSP_GRANT_RETURN_CANNOT_BE_GREATER_THAN_GRANT_PURCHASE;
	extern const long ERR_RDSP_BOND_RETURN_CANNOT_BE_GREATER_THAN_BOND_PURCHASE;
	extern const long WARN_RDSP_BOND_RETURN_CANNOT_BE_GREATER_THAN_BOND_PURCHASE;
}
...
namespace
{
	...
	const long RDSP_INSUFFICIENT_GRANT_BOND_BALANCE						= 2243;
	const long RDSP_GRANT_RETURN_CANNOT_BE_GREATER_THAN_GRANT_PURCHASE	= 2254;
	const long RDSP_BOND_RETURN_CANNOT_BE_GREATER_THAN_BOND_PURCHASE	= 2255; 
}
	...
	while(!iter.end())
	{
		...
		switch (nErrNum)
		{
			...
			case RDSP_MONEY_OUT_TRANS_EXISTS_AFTER_DATE_OF_PAYMENT:
				...
				break;
			case RDSP_INSUFFICIENT_GRANT_BOND_BALANCE:
				{
					// 2243 - Insufficient grant/bond balance, repayment may reject.
					if (severityCode == EWI_ERROR)
						ADDCONDITIONFROMFILE (CND::ERR_RDSP_INSUFFICIENT_GRANT_BOND_BALANCE);
					if (severityCode == EWI_WARNING)
						ADDCONDITIONFROMFILE (CND::WARN_RDSP_INSUFFICIENT_GRANT_BOND_BALANCE);
				}
				break;
			case RDSP_GRANT_RETURN_CANNOT_BE_GREATER_THAN_GRANT_PURCHASE:
				{
					// 2254 - Grant Return amount cannot be greater than the grant purchase amount.
					if (severityCode == EWI_ERROR)
						ADDCONDITIONFROMFILE (CND::ERR_RDSP_GRANT_RETURN_CANNOT_BE_GREATER_THAN_GRANT_PURCHASE);
					if (severityCode == EWI_WARNING)
						ADDCONDITIONFROMFILE (CND::WARN_RDSP_GRANT_RETURN_CANNOT_BE_GREATER_THAN_GRANT_PURCHASE);
				}
				break;
			case RDSP_BOND_RETURN_CANNOT_BE_GREATER_THAN_BOND_PURCHASE:
				{
					// 2255 - Bond Return amount cannot be greater than the bond purchase amount.
					if (severityCode == EWI_ERROR)
						ADDCONDITIONFROMFILE (CND::ERR_RDSP_BOND_RETURN_CANNOT_BE_GREATER_THAN_BOND_PURCHASE);
					if (severityCode == EWI_WARNING)
						ADDCONDITIONFROMFILE (CND::WARN_RDSP_BOND_RETURN_CANNOT_BE_GREATER_THAN_BOND_PURCHASE);
				}
				break;
			default:				
				break;
