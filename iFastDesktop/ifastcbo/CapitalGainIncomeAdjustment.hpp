...
//******************************************************************************
//
// ^FILE   : CapitalGainIncomeAdjustment.hpp
// ^AUTHOR :
// ^DATE   : 
//
...
class IFASTCBO_LINKAGE CapitalGainIncomeAdjustment : public ManualDividendAdjustment
{
public:
    CapitalGainIncomeAdjustment (BFAbstractCBO &parent);
    virtual ~CapitalGainIncomeAdjustment();
