...
//******************************************************************************
//
// ^FILE   : DSTCMktIndexMasterTrxnBuilder.hpp
// ^AUTHOR : 
// ^DATE   : 
//
// ^CLASS    : 
...
class DSTCMktIndexMasterTrxnBuilder : private boost::noncopyable
{
public:
   ...
   static void buildTrxnKey( DString& strKey, MktIndexMaster* MktIndexMaster );
