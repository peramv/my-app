...
//******************************************************************************
//
// ^FILE   : DemographicsChildList.hpp
// ^AUTHOR : 
// ^DATE   : Oct, 2014
//
...
class IFASTCBO_LINKAGE DemographicsChildList : public MFCanBFCbo, private boost::noncopyable
{
public:

   DemographicsChildList( BFAbstractCBO &parent );
   virtual ~DemographicsChildList();
   ...
   SEVERITY addNewKYCAttribRecord( const DString& code,
...
//******************************************************************************
// 
// $Log:   Y:/VCS/BF iFAST/ifastcbo/DemographicsChildList.hpp-arc  $
//
