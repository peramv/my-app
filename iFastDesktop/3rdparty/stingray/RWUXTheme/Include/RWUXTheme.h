...
#undef _RWUXTHEMEAUTOLIBNAME
	...
	#if	_MSC_VER > 1600 // VC11 and higher
		#ifndef _UNICODE
			#if   !defined(_RWOSDLL) && !defined(_AFXDLL) &&  defined(_DEBUG)
				#define _RWUXTHEMEAUTOLIBNAME "RWUXThemeD11.lib"
			#elif !defined(_RWOSDLL) && !defined(_AFXDLL) && !defined(_DEBUG)
				#define _RWUXTHEMEAUTOLIBNAME "RWUXTheme11.lib"
			#elif !defined(_RWOSDLL) &&  defined(_AFXDLL) &&  defined(_DEBUG)
				#define _RWUXTHEMEAUTOLIBNAME "RWUXThemeAD11.lib"
			#elif !defined(_RWOSDLL) &&  defined(_AFXDLL) && !defined(_DEBUG)
				#define _RWUXTHEMEAUTOLIBNAME "RWUXThemeA11.lib"
			#elif  defined(_RWOSDLL) &&  defined(_AFXDLL) &&  defined(_DEBUG)
				#define _RWUXTHEMEDLL
				#define _RWUXTHEMEAUTOLIBNAME "RWUXThemeSD11.lib"
			#elif  defined(_RWOSDLL) &&  defined(_AFXDLL) && !defined(_DEBUG)
				#define _RWUXTHEMEDLL
				#define _RWUXTHEMEAUTOLIBNAME "RWUXThemeS11.lib"
		...
		#else
			#if   !defined(_RWOSDLL) && !defined(_AFXDLL) &&  defined(_DEBUG)
				#define _RWUXTHEMEAUTOLIBNAME "RWUXThemeUD11.lib"
			#elif !defined(_RWOSDLL) && !defined(_AFXDLL) && !defined(_DEBUG)
				#define _RWUXTHEMEAUTOLIBNAME "RWUXThemeU11.lib"
			#elif !defined(_RWOSDLL) &&  defined(_AFXDLL) &&  defined(_DEBUG)
				#define _RWUXTHEMEAUTOLIBNAME "RWUXThemeAUD11.lib"
			#elif !defined(_RWOSDLL) &&  defined(_AFXDLL) && !defined(_DEBUG)
				#define _RWUXTHEMEAUTOLIBNAME "RWUXThemeAU11.lib"
			#elif  defined(_RWOSDLL) &&  defined(_AFXDLL) &&  defined(_DEBUG)
				#define _RWUXTHEMEDLL
				#define _RWUXTHEMEAUTOLIBNAME "RWUXThemeSUD11.lib"
			#elif  defined(_RWOSDLL) &&  defined(_AFXDLL) && !defined(_DEBUG)
				#define _RWUXTHEMEDLL
				#define _RWUXTHEMEAUTOLIBNAME "RWUXThemeSU11.lib"
			#elif  defined(_RWOSDLL) && !defined(_AFXDLL)
				#error One of Stingray Studio DLL defines is specified but _AFXDLL is not. Stingray Studio DLLs cannot be used with static MFC libraries.
			#endif
		#endif
	#elif	_MSC_VER > 1500 // VC10 and higher
		#ifndef _UNICODE
			#if   !defined(_RWOSDLL) && !defined(_AFXDLL) &&  defined(_DEBUG)
				#define _RWUXTHEMEAUTOLIBNAME "RWUXThemeD10.lib"
			#elif !defined(_RWOSDLL) && !defined(_AFXDLL) && !defined(_DEBUG)
				#define _RWUXTHEMEAUTOLIBNAME "RWUXTheme10.lib"
			#elif !defined(_RWOSDLL) &&  defined(_AFXDLL) &&  defined(_DEBUG)
				#define _RWUXTHEMEAUTOLIBNAME "RWUXThemeAD10.lib"
			#elif !defined(_RWOSDLL) &&  defined(_AFXDLL) && !defined(_DEBUG)
				#define _RWUXTHEMEAUTOLIBNAME "RWUXThemeA10.lib"
			#elif  defined(_RWOSDLL) &&  defined(_AFXDLL) &&  defined(_DEBUG)
				#define _RWUXTHEMEDLL
				#define _RWUXTHEMEAUTOLIBNAME "RWUXThemeSD10.lib"
			#elif  defined(_RWOSDLL) &&  defined(_AFXDLL) && !defined(_DEBUG)
				#define _RWUXTHEMEDLL
				#define _RWUXTHEMEAUTOLIBNAME "RWUXThemeS10.lib"
			#elif  defined(_RWOSDLL) && !defined(_AFXDLL)
				#error One of Stingray Studio DLL defines is specified but _AFXDLL is not. Stingray Studio DLLs cannot be used with static MFC libraries.
			#endif
		#else
			#if   !defined(_RWOSDLL) && !defined(_AFXDLL) &&  defined(_DEBUG)
				#define _RWUXTHEMEAUTOLIBNAME "RWUXThemeUD10.lib"
			#elif !defined(_RWOSDLL) && !defined(_AFXDLL) && !defined(_DEBUG)
				#define _RWUXTHEMEAUTOLIBNAME "RWUXThemeU10.lib"
			#elif !defined(_RWOSDLL) &&  defined(_AFXDLL) &&  defined(_DEBUG)
				#define _RWUXTHEMEAUTOLIBNAME "RWUXThemeAUD10.lib"
			#elif !defined(_RWOSDLL) &&  defined(_AFXDLL) && !defined(_DEBUG)
				#define _RWUXTHEMEAUTOLIBNAME "RWUXThemeAU10.lib"
			#elif  defined(_RWOSDLL) &&  defined(_AFXDLL) &&  defined(_DEBUG)
				#define _RWUXTHEMEDLL
				#define _RWUXTHEMEAUTOLIBNAME "RWUXThemeSUD10.lib"
			#elif  defined(_RWOSDLL) &&  defined(_AFXDLL) && !defined(_DEBUG)
				#define _RWUXTHEMEDLL
				#define _RWUXTHEMEAUTOLIBNAME "RWUXThemeSU10.lib"
			#elif  defined(_RWOSDLL) && !defined(_AFXDLL)
				#error One of Stingray Studio DLL defines is specified but _AFXDLL is not. Stingray Studio DLLs cannot be used with static MFC libraries.
			#endif
		#endif
	#elif _MSC_VER > 1400 //VC9 and higher
		#ifndef _UNICODE
			#if   !defined(_RWOSDLL) && !defined(_AFXDLL) &&  defined(_DEBUG)
...
// SRSTUDIO-800
RWTHEMEAPI(BOOL) RWIsWindowsClassicStyleEnabled();
RWTHEMEAPI(BOOL) RWSetWindowsClassicStyle(BOOL bEnable = TRUE);
