...
{
	DECLARE_DYNCREATE(CGXWChildFrame)
public:
	CGXWChildFrame();
...
protected:
	...
	afx_msg void InsertWorkSheet();
	afx_msg void DeleteWorkSheet();
	afx_msg void CanInsertWorkSheet(CCmdUI* pUI);
	afx_msg void CanDeleteWorkSheet(CCmdUI* pUI);
