...
// gxsexpr.h: Expression routines and untilities 
...
extern void __cdecl _gx_expr_print(int, gxFormula *, LPTSTR);

extern gxOperand __cdecl _gx_expr_eval(int, int, int, gxExprNode *, gxExprPointer);
extern gxOperand __cdecl _gx_do_eval(gxExprNode *, gxExprPointer, int bAddMemObj = 0);
extern gxOperand __cdecl _gx_do_eval_et(gxExprNode *, gxExprPointer);
extern int __cdecl _gx_evaluate_cexpr(int, int, int, gxExprNode *, gxExprPointer);
extern int __cdecl _gx_evaluate_cell(int, gxCell *);

extern void __cdecl _gx_set_error_reason(int reason);
extern int __cdecl _gx_get_error_reason(void);
extern void __cdecl _gx_set_error_position(int pos);
extern int __cdecl _gx_get_error_position(void);
extern void __cdecl _gx_set_expr_err_flag(int flag);
extern int __cdecl _gx_get_expr_err_flag(void);
extern int __cdecl _gx_get_expr_si(void);
extern LPTSTR __cdecl _gx_get_xs_fn_name(void);
extern LPTSTR __cdecl _gx_get_expr_sbuf(void);
extern void __cdecl _gx_get_expr_rc(unsigned *, unsigned *);
extern int __cdecl _gx_get_expr_err_code(void);
extern gxOperand * __cdecl _gx_get_fn_arg_ptr(void);
extern void __cdecl _gx_set_fn_arg_ptr(gxOperand * p);

extern int __cdecl _gx_references_cells(gxExprNode * nbuf, int size);
extern int __cdecl _gx_calls_functions(gxExprNode * nbuf, int size);

extern void __cdecl _gx_free_formula(gxFormula *);
extern void __cdecl _gx_free_formula_strings(gxFormula *);
extern gxFormula * __cdecl _gx_formula_dup(gxFormula *);

extern void __cdecl _gx_reset_first_error(int);
extern void __cdecl _gx_convert_upper(LPTSTR);
extern void __cdecl _gx_convert_lower(LPTSTR);
extern int __cdecl _gx_xs_int_check(double);
extern void __cdecl _gx_str_trim(LPTSTR);
extern int __cdecl _gx_ieee_infnan(gxNumber *);
extern void __cdecl _gx_fp_error_init(void);
extern LPTSTR __cdecl _gx_format_function_name(LPTSTR, LPCTSTR, int);

extern void __cdecl _gx_mkwm(gxMatrix * m);
extern int __cdecl _gx_freewm(gxMatrix * m);
extern void __cdecl _gx_cleanwm(void);
extern gxNumber * __cdecl _gx_mknumarray(int n);
...
// exprpars.cpp
extern int __cdecl _gx_parse_formula(int si, LPCTSTR text, gxFormula * fm);
...
extern void __cdecl _gx_fn_table_init(void);

extern gxKeyword * __cdecl _gx_fn_lookup(LPCTSTR text);

extern gxNumber __cdecl _gx_get_one_number(gxOperand argv[]);

extern int __cdecl _gx_cvt2constant(gxOperand * opp);

extern int __cdecl _gx_cvt2int(gxNumber x);

extern int __cdecl _gx_fn_get_value(int r, int c, gxNumber * vp);

extern void __cdecl _gx_fn_xsstrcpy(LPTSTR dst, LPCTSTR src, int n);

extern void __cdecl _gx_fn_xsstrcat(LPTSTR dst, LPCTSTR src, int n);

extern void __cdecl _gx_function_error(int code);

extern void __cdecl _gx_propagate_error(gxOperand * argv);

extern void __cdecl _gx_clean_fn_args(void);

// stat.cpp

extern double __cdecl _gx_gammalog(double x);

extern double __cdecl _gx_betacf(double a, double b, double x);

extern double __cdecl _gx_betai(double a, double b, double x);

extern double __cdecl _gx_alphaT(double nu, double t);

extern double __cdecl _gx_alphaF(double nu1, double nu2, double F);

extern double __cdecl _gx_phi(double x);

extern double __cdecl _gx_phi_inverse(double x);
...
extern int __cdecl _gx_end_of_month(int m, int y);
extern long __cdecl _gx_edate(int si, long start_date, int mos);
extern void __cdecl _gx_find_yearfrac1(int si, long start_date, long end_date, int basis, gxNumber * year_frac);
extern void __cdecl _gx_find_yearfrac(int si, long start_date, long end_date, int basis, gxNumber * year_frac);
extern long __cdecl _gx_days360(int si, long date1, long date2);

extern long __cdecl _gx_encode_date(int si, int year, int month, int day);
extern int __cdecl _gx_decode_date(int si, long gdate, int *year, int *month, int *day);
extern int __cdecl _gx_encode_time(double *timeval, int hr, int min, int sec);
extern int __cdecl _gx_decode_time(double timeval, int *hr, int *min, int *sec);
extern void __cdecl _gx_current_time(int *yr, int *mo, int *da, int *hr, int *min, int *sec);
extern int __cdecl _gx_get_date(int si, LPCTSTR date_str, int *mp, int *dp, int *yp, int *fmtp);
extern int __cdecl _gx_get_time(LPCTSTR time_str, int *hp, int *mp, int *sp);

// matrix.cpp

extern int __cdecl _gx_asymmetric(gxMatrix a);

extern gxMatrix __cdecl _gx_mtranspose(gxMatrix a);

extern gxMatrix __cdecl _gx_mmul(gxMatrix a, gxMatrix b);

extern gxMatrix __cdecl _gx_mTmul(gxMatrix a, gxMatrix b);

extern gxMatrix __cdecl _gx_mLUdecomp(gxMatrix a, int *indx, double *d);

extern gxMatrix __cdecl _gx_mLUbksub(gxMatrix a, int *indx, gxMatrix b);

extern gxMatrix __cdecl _gx_minvert(gxMatrix a);

extern gxMatrix __cdecl _gx_mlinsolv(gxMatrix a, gxMatrix b);

extern int __cdecl _gx_mlls_short(gxMatrix a, gxMatrix b, gxMatrix * result);

extern int __cdecl _gx_mlls(gxMatrix a, gxMatrix b, gxMatrix * result);

extern double __cdecl _gx_mdet(gxMatrix a);

extern void __cdecl _gx_fft(gxMatrix a, int sign);

extern gxMatrix __cdecl _gx_dft(gxMatrix a, int sign);

extern gxMatrix __cdecl _gx_meigen(gxMatrix a);

extern void __cdecl _gx_hh_tridiag(gxMatrix a, gxMatrix d, gxMatrix e);

extern void __cdecl _gx_tridiag_eigen(gxMatrix d, gxMatrix e);
