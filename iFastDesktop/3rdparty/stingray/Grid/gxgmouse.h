...
// Construction
public:
	CGXGridMouseWheelPlugin(CGXGridCore* pGrid);
...
// Implementation
public:
	virtual ~CGXGridMouseWheelPlugin();
...
// Construction
public:
	CGXGridIntelliMousePlugin(CGXGridCore* pGrid);
...
// Implementation
public:
	virtual ~CGXGridIntelliMousePlugin();
