...
\
bool class_name::OnGetValue(const XML_ENTRY_MAP* pEntry, MSXML::IXMLDOMNode* pParentNode, XMLVALUE& value)\
{\
	bool bRetval(true);\
\
...
\
\
bool class_name::OnCanContinueWriteLoop(const XML_ENTRY_MAP* pEntry, MSXML::IXMLDOMNode* pNodeAdded)\
{\
	bool bRetval(false);\
\
	__eType id = (__eType) pEntry->dwID;\
...
\
bool class_name::OnSetValue(const XML_ENTRY_MAP* pEntry, MSXML::IXMLDOMNode* pThisNode, XMLVALUE& xmlValue)\
{\
...
virtual bool OnCanContinueWriteLoop(const XML_ENTRY_MAP* pEntry, MSXML::IXMLDOMNode* pNodeAdded);\
virtual bool OnGetValue(const XML_ENTRY_MAP* pEntry, MSXML::IXMLDOMNode* pParentNode, XMLVALUE& xmlValue);\
\
virtual void OnStartRead();\
virtual void OnCompleteRead();\
virtual bool OnStartReadLoop(const XML_ENTRY_MAP* pEntry);\
virtual bool OnSetValue(const XML_ENTRY_MAP* pEntry, MSXML::IXMLDOMNode* pThisNode, XMLVALUE& xmlValue);\
\
protected:\
