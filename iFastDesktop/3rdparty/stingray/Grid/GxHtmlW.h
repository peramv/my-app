...
//
//
// HtmlRW.h: interface for the CGXHtmlW class.
//
//////////////////////////////////////////////////////////////////////
...
struct CGXTagInfo
{
	...
	CGXTagInfo(LPCTSTR lpszAttrib, LPCTSTR lpszContent, BOOL _bWrapByNewline = TRUE, BOOL _bEndingNewline = TRUE)
...
public:
	CGXTagHandler(LPCTSTR lpszTag)
		: strTag(lpszTag)
	{
		strTag.TrimLeft();
		strTag.TrimRight();
	}
	virtual ~CGXTagHandler() {};
...
{
public:
	CGXTagDefaultHandler(LPCTSTR lpszTag)
		: CGXTagHandler(lpszTag)
	{}
	virtual ~CGXTagDefaultHandler() {}
	virtual CString ComposeOutput(const CGXTagInfo& tagInfo);
};
...
struct CGXTagHandlerEntry
{
	...
	CGXTagHandlerEntry(CGXTagHandler* _pHandler, LPCTSTR lpszTag)
		: pHandler(_pHandler), strTag(lpszTag)
	{
	}
	virtual ~CGXTagHandlerEntry()
	{
		if( pHandler != NULL )
			delete pHandler;
		pHandler = NULL;
...
protected:
	...
	static CGXTagHandlerEntry _gxTagHandlerEntries[];

public:
	//@cmember
	/* Get the pointer to the tag handler map */
	static CGXTagHandlerEntry* GetHandlerEntries() { return _gxTagHandlerEntries; }
	//@cmember
	...
	virtual CString GetTableCellString(int nRight, int nBottom, 
	...
	virtual CString GetTableAttrib();
	//@cmember
	...
	CGXGridCore* Grid() { return m_pGrid; }
};
