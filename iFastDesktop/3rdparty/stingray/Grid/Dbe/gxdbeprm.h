...
//
//
// Holds all CGXDBEGrid-specific data. 
// This data can be shared among several CGXDBEGrid-derived views
// so that the document/view architecture can be supported.
//
