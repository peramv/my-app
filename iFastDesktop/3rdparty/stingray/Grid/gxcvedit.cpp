...
GRID_IMPLEMENT_CONTROL(CGXVScrollEdit, CGXEditControl);
...
CRect CGXVScrollEdit::GetCellRect(ROWCOL nRow, ROWCOL nCol, LPRECT rectItem, const CGXStyle* pStyle)
{
 	CRect rect = CGXEditControl::GetCellRect(nRow, nCol, rectItem, pStyle);
	
	if(pStyle && m_bVertScrollBar)
 	{
