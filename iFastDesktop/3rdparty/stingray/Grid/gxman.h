...
public:
	...
	CMap<SEC_DWORD, SEC_DWORD&, T*, T*&>* GetMap()
	{return &m_pMpT;};
...
public:
	...
	const CMap<SEC_DWORD, SEC_DWORD&, T*, T*&>* GetMap() const
	{return &m_pMpT;};

	CMap<SEC_DWORD, SEC_DWORD&, T*, T*&>* AccessMap()
	{return &m_pMpT;};
...
public:
	...
	CMap<const IID*, const IID*&, T*, T*&>* GetMap()
	{return &m_pMpT;};
...
public:
	...
	CMap<const T*, const T*&, T, T&>* GetMap()
	{return &m_pMpT;};
