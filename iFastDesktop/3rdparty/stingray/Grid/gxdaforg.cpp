///////////////////////////////////////////////////////////////////////////////
// gxdaforg.cpp : AttachForeignTable with code reference to CGXTabbedComboBox
//
...
#pragma code_seg("GX_SEG_GXDAFORG")
#endif
...
void CGXDaoGrid::AttachForeignTable(ROWCOL nCol, CDaoRecordset* pSet, UINT nKeyCol, UINT nDispCol, BOOL bDispAllCols, BOOL bDisplayHeader)
{
	ASSERT(pSet != NULL);
