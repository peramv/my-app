...
// by Stingray Library and should not be used
// separetely.
// Portions of this header file declarations
// were taken from Microsoft Platform SDK 
// header files in order to provide compatibility
// with VC6 compiler
