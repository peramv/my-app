...
public:
	...
	/** Create a TopicSession
	  ...
	  */
      virtual TopicSessionRef createTopicSession(jboolean transacted,jint acknowledgeMode);
    ...
    /** Create a TopicSession
	  ...
	  *                         and acknowledgement mode.
	  */
      virtual TopicSessionRef createTopicSession(jboolean transacted, jint ackMode, StringRef sessionName);
