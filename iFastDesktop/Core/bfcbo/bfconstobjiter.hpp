 ...
 * @version 0.1
 */
class BFBASE_LINKAGE BFConstObjIter : public BFObserver
{
public:
   /**
    ...
    * @param dstFilter     - IDI string containins the criteria
    */
   bool getKeyFilter( DString & dstFilter ) const;
   /**
    ...
    * @param dstFilter     - IDI string containins the criteria
    */
   bool getDataFilter( DString & dstFilter ) const;
   /**
    ...
    */
   BFConstObjIter( const BFAbstractCBO &bfObj, 
...
private:
    ...
    */
   bool checkDataFilter() const;
   /**
    * returns true if the key filter criteria is met
    */
   bool checkKeyFilter() const;
   ...
   BFConstObjIter();
//DS  BFConstObjIter( const BFConstObjIter &copy );
//DS  BFConstObjIter& operator=( const BFConstObjIter &copy );
   ...
   typedef std::map< StrKeyEntry, BFAbstractCBO::OBJECT_MAP_CONST_ITER, less_StrKeyEntry > STR_KEY_MAP;

   BFDataFilter *  pDataFilter_;

   KEY_FILTER_VECTOR  vKeyFilter_;
   bool bKeyFiltered_;
   mutable bool bPrefixKeyFilter_;

   STR_KEY_MAP                _strKeyMap;
   STR_KEY_MAP::iterator      _strKeyMapIter;
   const BFAbstractCBO*       _pContainer; 
   const BFDataGroupId& idDataGroup_;
   ITERTYPE                   _iterType;
   CONTAINER                  _currContainer;
   BFAbstractCBO::OBJECT_MAP_CONST_ITER _currIter;
...
//******************************************************************************
//
/* $Log:   Y:/VCS/BF Core/bfcbo/bfconstobjiter.hpp-arc  $
//
//   Rev 1.6   Dec 09 2004 12:16:58   purdyech
//PET910 - Non-versionable CBO optimization fixes
//
//   Rev 1.5   Oct 22 2004 08:54:00   PURDYECH
//PET910 - .NET Conversion Fixes
//
//   Rev 1.4   Jan 06 2003 16:40:22   PURDYECH
//BFDataGroupId changeover
//
//   Rev 1.3   Nov 27 2002 15:01:54   PURDYECH
...
//New PVCS Database
//
//   Rev 1.0   Aug 29 2002 13:31:06   PURDYECH
//Initial revision.
 * 
