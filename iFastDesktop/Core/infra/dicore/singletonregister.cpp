...
static void __cdecl releaseSingletons( void );
...
SingletonRegister *SingletonRegister::getRegistrar()
{
   if ( NULL == s_pRegistrar )
   {
      ...
      // set up the automatic cleanup
      atexit( ::releaseSingletons );
   }
...
//
//
// $Log:   Y:/VCS/iFastAWD/dicore/singletonregister.cpp-arc  $
// 
