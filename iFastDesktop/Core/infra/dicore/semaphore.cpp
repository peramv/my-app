                           ...
                           DWORD dwResult)
{
   ...
   appendULong(strErr.getImp(), dwResult);
   strErr += I_( "on " );
...
//
//
// $Log:   Y:/VCS/iFastAWD/dicore/semaphore.cpp-arc  $
// 
//    Rev 1.0   28 Jan 2008 13:20:28   kovacsro
// Initial revision.
// 
