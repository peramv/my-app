...
bool RegistryObject::destroy()
{
   ...
   else
   {
      ...
      RegistryKey local( registryPath.asA(), RegistryKey::LOCAL_MACHINE );
...
//
//
// $Log:   Y:/VCS/iFastAWD/dicore/registryobject.cpp-arc  $
// 
