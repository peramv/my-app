...
DString makeDStringUsingGenericTags( const I_CHAR * strErr,
                                    ... )
{
   DString retVal;
   I_CHAR * errBuf = makeErrBufUsingGenericTagsBase( &strErr );
   retVal = errBuf;
   delete [] errBuf;
   return retVal;
}
...
//
//
// $Log:   Y:/VCS/iFastAWD/dicore/idistring.cpp-arc  $
// 
//    Rev 1.0   28 Jan 2008 13:19:50   kovacsro
// Initial revision.
// 
//    Rev 1.11   23 Aug 2001 17:40:28   dt14177
