...
DICORE_LINKAGE DString& upperCase( DString &aString );
...
DICORE_LINKAGE I_STRING & formatStringUsingMaskICU(
                                                 I_STRING &valueString,
                                                 const I_STRING &mask );

DICORE_LINKAGE I_STRING & removeMaskFromStringICU( I_STRING &maskedValue,
                                                const I_STRING &mask );
...
DICORE_LINKAGE DStringA & formatStringUsingMaskICU(
                                       DStringA &valueString,
                                       const DStringA &mask );

DICORE_LINKAGE DStringA & removeMaskFromStringICU(
                                              DStringA &maskedValue,
                                              const DStringA &mask );
...
//
//
// $Log:   Y:/VCS/iFastAWD/inc/stringfunctions.hpp-arc  $
//
//   Rev 1.0   28 Jan 2008 13:32:50   kovacsro
//Initial revision.
// 
//    Rev 1.10   Apr 03 2002 16:56:16   dt40784
// added functions removeMaskFromStringICU() and formatStringUsingMask()
// 
