 ...
 * DLL which is loaded the first time an AwdInterface object is instatiated or
 * when one of the static methods is first called.
 */
class DIAWDI_LINKAGE AwdInterface
{
   ...
   public:
       ...
       * Default constructor
       *
       * The first time an AwdInterface object is instantiated, an attempt
   ...
   public:
       ...
       *
       * @param busarea - The business area.
       *
       ...
       * @exception ConditionException
       */
      string_vector getStatusList( const AwdKey *pKey );

	   /**
       * Returns a list of status based on the current queue of a work object, bussArea and WorkType.
       * The status list is filtered on Queue, BussArea and WkType.
       *
       * @param pKey - The key to the work object.
       *
       ...
       * @exception ConditionException
       */
	  string_vector getStatusList( const AwdKey *pKey, const DString &strBussArea, const DString &strWkType );
       ...
       *
       * @return A reference to the data dictionary.
       *
       * @exception ConditionException
       */
      data_obj_map & getAwdFieldList();
       ...
       *
       * This will invoke a CSD for the awd object indicated by the AwdData.
       ...
       * @exception ConditionException
       */
      bool stopCSD( const AwdKey *pKey );
       ...
       */
      bool hasActiveService( const AwdKey *pKey,
       ...
       * @return True if successfull.
       */
      bool getAllChildren( const AwdKey* pKey,
       ...
       * @return True if successfull.
       */
      bool getImmediateChildren( const AwdKey* pKey,
                                 AwdKeyVector &awdKeyVector );
       ...
       * @return True if successful.
       */
      bool showAwdServiceWindow( const AwdKey *pKey,
                                 const DString &serviceName,
                                 bool bShow );
       ...
       */
      bool isLocked( const AwdKey *pKey );
       ...
       * @exception ConditionException
       */
      bool insertItemInContainer( const AwdKey *pKey, bool lock = false );
       ...
       * @exception ConditionException
       */
      bool insertItemInContainer( const AwdKey *pKey,
       ...
       * @exception ConditionException
       */
      bool isItemInContainer( const AwdKey *pKey );

      /**
       * Returns true if the AWD object represted by the key is in the container
       * and is succesfully selected.
       *
       * @param pKey - The key to the AWD object to select.
       *
       * @return True if successfull.
       *
       * @exception ConditionException
       */
      bool selectItemInContainer( const AwdKey *pKey );

      /**
       * Closes an AWD container.  If the container was <i>opened</i> with
       * the method locateAwdContainer, it will not be closed but will no
       * longer be used or considered to be the open container.
       *
       ...
       * @exception ConditionException
       */
      bool expandContainerItemDown( const AwdKey *pKey );

      /**
       * Creates an AWD Transaction (work) object on the AWD server based on
       * the AwdData object passed in.
       *
       ...
       * @exception ConditionException
       */
      bool createAwdTransaction( AwdData &awdData, bool lock );

      /**
       * Creates an AWD case object on the AWD server based on the AwdData
       * object passed in.
       *
       ...
       * @exception ConditionException
       */
      bool createAwdCase( AwdData &awdData, bool lock );

      /**
       * This method creates an AWD Source object.
       *
       * The AWD Source object is created using the values passed in with the
       * AwdData object and the file passed in as the image.  If ppSource is
       * not NULL, it will point to an AwdSource object if the AWD Source was
       * successfully created.  The caller of this method will then be
       * responsible for deleting the AwdSource object.
       *
       * @param awdData -  Values to pass to AWD.
       * @param format - Object (image) format.
       * @param strFile - Image to be used for the source.
       * @param ppSource - Pointer to and AwdSource pointer.
       * @param lock - Whether or not to create with lock.
       *
       * @return True if successful.
       *
       * @exception ConditionException
       */
      bool createAwdSource( const AwdData &awdData,
       ...
       * @exception ConditionException
       */
      bool createRelationship( const AwdKey *pParent,
                               const AwdKey *pChild );
       ...
       * @exception ConditionException
       */
      bool lockAwdObject( const AwdKey *pKey, bool lock );
       ...
       *
       * @return True if parent is a case.
       *
       * @exception ConditionException
       */
      bool hasCaseForParent( const AwdKey *pKey, AwdKey **ppParent );
       ...
       *
       * @return True if a child is a source.
       *
       * @exception ConditionException
       */
      bool hasSourceForChild( const AwdKey *pKey, AwdKey **ppChild );

      bool hasChildren( const AwdKey *pKey );
       ...
       * @exception ConditionException
       */
      bool addComment( const AwdKey *pKey, const DString &comment );
       ...
       *
       * @return True of the listener was started.
       *
       * @exception ConditionException
       */
       ...
       *
       * <b>Note:</b> This method can only be called on the AwdInterface
       ...
       * @exception ConditionException
       */
      AwdKeyVector endListenCreateObjects();

      /**
       * Used to create an AwdKey object.
       *
       * Creates a new AwdKey object using the three elements that define
       * the primary index (key) for an AWD object on the AWD server.
       * Regardless if the AWD object exists, an AwdKey object will be "new"ed
       * up.  Call the method AwdKey::isKey() to determine whether this method
       * was successful.
       *
       * <b>Note:</b> The caller of this function is responsible for deleting the
       * AwdKey object returned.
       *
       ...
       *
       * @return A new AwdKey object.
       *
       * @exception ConditionException
       */
      AwdKey * newAwdKey( const DString &createDateTime,
       ...
       * @exception ConditionException
       */
      bool retrieveData( const AwdKey *pKey, AwdData &awdData );
       ...
       * @exception ConditionException
       */
      bool retrieveDataLite( const AwdKey *pKey, AwdData &awdData );
       ...
       * object represented by thekey passed in.  An AwdSource object will be
       * dynamically instantiated and returned in ppSource.  The caller of this
       * method is responsible for deleting the AwdSource object when it is no
       * longer needed.
       *
       * @param pKey - The key to the AWD source object to be retrieved.
       * @param ppSource - The AwdSource object that was retrieved.
       *
       * @return True if successful.
       *
       * @exception ConditionException
       */
      bool retrieveSource( const AwdKey *pKey, AwdSource **ppSource );
       ...
       * @exception ConditionException
       */
      bool startService( const AwdKey *pKey,
       ...
       * @exception ConditionException
       */
      bool stopService( const AwdKey *pKey,
                        const DString &strServiceName );
       ...
       * AwdData object.  The AwdKey member of the AwdData object must be valid.
       *
       ...
       * @exception ConditionException
       */
      bool updateAwdObject( AwdData &awdData );
       ...
       * @return True if successful.
       */
      bool getAwdWork( AwdData &awdData );

      /**
       * Makes a list of AWD work (case and transaction) objects currently in
       * the AWD container, dynamically allocates an AwdKey object for each
       ...
       * the vector and deleting each AwdKey object added by this method.</b>
       *
       * @param awdKeyVector - vector to hold the collection of AwdKey objects.
       *
       * @return True if successful.
       */
      bool getAwdWorkObjects( AwdKeyVector &awdKeyVector );
       ...
       */
      bool doubleClickContainerItem( const AwdKey *pKey );
       ...
       *         AWD container.
       */
      AwdKey * getCurrentContainerSelection();
       ...
       * @exception ConditionException
       */
      DString getQueue( const AwdKey *pKey );
       ...
       * @exception ConditionException
       */
      bool setQueue( const AwdKey *pKey, const DString &queue );
       ...
       * @exception ConditionException
       */
      bool suspendWorkObject( const AwdKey *pKey,
       ...
       * @return True if successful.
       */
      bool unSuspendWorkObject( const AwdKey *pKey );
...
//
//
// $Log:   Y:/VCS/iFastAWD/inc/awdinterface.hpp-arc  $
//
...
//Initial revision.
// 
//    Rev 1.20   Oct 16 2001 15:04:56   dt21858
// Added stopCSD()
// Added selectItemInContainer()
//
//    Rev 1.19   Aug 23 2001 16:54:04   DT21858
// - Added overloaded method for insertItemInContainer().
//
//    Rev 1.18   Aug 13 2001 13:59:22   DT21858
// Added getImmediateChildren()
//
//    Rev 1.17   Aug 06 2001 15:59:32   DT21858
// - Sync up eith 1.7.2.10 branch (comments included below)
// - Added getWorkstationID(), getCountry() and implemented getQueueList()
//
//
//    Rev 1.16   Jun 04 2001 15:10:16   DT21858
// Added comment
//
//    Rev 1.15   Jun 04 2001 15:01:08   DT21858
...
// removed awdType (it is now in InterfaceManager)
//
