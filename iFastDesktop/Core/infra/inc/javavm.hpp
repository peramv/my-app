...
#undef DIACCESSOR_LINKAGE
#ifdef DIACCESSOR_DLL
   #define DIACCESSOR_LINKAGE CLASS_EXPORT
#else
   #define DIACCESSOR_LINKAGE CLASS_IMPORT
#endif

class DIACCESSOR_LINKAGE DSTJavaVM
{
   public:
...
//******************************************************************************
//
// $Log:   Y:/VCS/iFastAWD/inc/javavm.hpp-arc  $
//
//   Rev 1.0   28 Jan 2008 13:32:08   kovacsro
//Initial revision.
// 
