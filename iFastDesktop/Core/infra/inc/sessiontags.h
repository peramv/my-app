...
namespace SessionTags
{
   ...
   extern DISESSN_LINKAGE const I_CHAR * EVENT_DURATION;
   ...
   extern DISESSN_LINKAGE const I_CHAR * MESSAGE_EVENT;
   extern DISESSN_LINKAGE const I_CHAR * MESSAGE_ITEM;
   extern DISESSN_LINKAGE const I_CHAR * MESSAGING_RECEIPANTS;
   ...
   extern DISESSN_LINKAGE const I_CHAR * PREVIOUS_EVENT_TIME;
   ...
   extern DISESSN_LINKAGE const I_CHAR * MESSAGE_TABLE;
   ...
   extern DISESSN_LINKAGE const I_CHAR * USE_MESSAGING;
