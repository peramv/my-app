#pragma message( "including "__FILE__ )
   ...
   #define CICSRESPONSEFORMATTER_HPP
 ...
 */
class DIVIEW_LINKAGE CICSResponseFormatter
{
public:
   /**
    * Constructor.
    ...
    */
   virtual ~CICSResponseFormatter();

   /**
    * Call this to parse the raw TA2000 host response.  This method should be
...
//
//
// $Log:   Y:/VCS/iFastAWD/inc/CICSResponseFormatter.hpp-arc  $
//
//   Rev 1.0   28 Jan 2008 13:30:22   kovacsro
//Initial revision.
//
//   Rev 1.2   Jun 26 2001 12:57:12   DT11159
//Deleted method getFormattedErrorMessage( ).
//
//   Rev 1.1   Jun 08 2001 19:12:50   DT11159
//Added View Manager error information in conditions.
//
//   Rev 1.0   May 18 2001 15:52:54   DT11159
//
//
//
