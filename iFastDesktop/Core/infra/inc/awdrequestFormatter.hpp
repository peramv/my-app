   ...
   #define AWDREQUESTFORMATTER_HPP
 ...
 */
class DIVIEW_LINKAGE AWDRequestFormatter
{
public:
   /**
    * Constructor.
    ...
    */
   AWDRequestFormatter( const DStringA & viewName,
    ...
    * Destory object.
    */
   virtual ~AWDRequestFormatter();

   /**
    * Call this to format a AWD host request.  This method should be
...
//
//
// $Log:   Y:/VCS/iFastAWD/inc/awdrequestFormatter.hpp-arc  $
//
//   Rev 1.0   28 Jan 2008 13:29:50   kovacsro
//Initial revision.
//
//   Rev 1.0   May 18 2001 15:53:28   DT11159
// 
//
//
