...
#define VMCLIENTPRIVATECONNECTION_HPP
...
/**
 * View Manager Private Connection class
 */
class DIVIEW_LINKAGE VmClientPrivateConnection : public VmClientConnection
{
public:
   /**
    * Constructor
    ...
    */
   VmClientPrivateConnection( const DString & hostId,
                              const DString & connectionName );

   virtual ~VmClientPrivateConnection();
    ...
    *                     be INFINITE.
    */
   virtual void send( const DString & requestName,
...
//
//
// $Log:   Y:/VCS/iFastAWD/diview/VmClientPrivateConnection.hpp-arc  $
//
//   Rev 1.0   28 Jan 2008 13:24:10   kovacsro
//Initial revision.
//
//   Rev 1.0   Jun 28 2001 16:27:38   DT11159
// 
//
//
