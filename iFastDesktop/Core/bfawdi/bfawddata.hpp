...
/**
 * An BFAwdData object represents the data for an AWD object.  In addition, an
 * BFAwdData object will hold a pointer to an BFAwdKey object when the AwdDat object
 ...
 */
class BFAWDI_LINKAGE BFAwdData
{
   // Public enums
public:
   enum
...
public:
    ...
    * within an BFAwdData object.
    */
   class BFAWDI_LINKAGE LobIterator
   {
...
public:
    ...
    * @param copy - copy
    */
   BFAwdData( const BFAwdData &copy );
...
public:
    ...
    *
    * @param objt - The source's object type
    */
    ...
    * Assignment operator
    *
    * @param copy   - BFAwdData object to copy.
    *
    * @return Reference to self.
    */
   BFAwdData & operator=( const BFAwdData &copy );

   /**
    * Sets the BFAwdKey associated with this object.
    *
    * <b>Note:</b> The instance receiving the key takes the responsibility
    * for deleting it.  The caller should <i>not</i> delete the BFAwdKey
    * object after calling this method.
    *
    * @param awdKey - Pointer to the key.
    */
   void setKey( BFAwdKey *awdKey );

   /**
    * Returns the pointer to the BFAwdKey object associated with this object.
...
//******************************************************************************
//
// $Log:   Y:/VCS/BF Core/bfawdi/bfawddata.hpp-arc  $
//
//   Rev 1.2   Nov 27 2002 14:51:58   PURDYECH
