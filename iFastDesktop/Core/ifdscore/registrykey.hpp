...
extern "C" {
	DICORE_LINKAGE void __cdecl GetOverrideFunctions( PFRCO *pfnCO, PFRGOC *pfnGOC, PFREOV *pfnEOV, PFREOK *pfnEOK );
}
...
//******************************************************************************
//
// $Log:   Y:/VCS/BF iFAST/core/ifdscore/registrykey.hpp-arc  $
//
//   Rev 1.3   May 16 2011 07:48:44   purdyech
//Added GetOverrideFunctions to support registry-less AWD support
//
