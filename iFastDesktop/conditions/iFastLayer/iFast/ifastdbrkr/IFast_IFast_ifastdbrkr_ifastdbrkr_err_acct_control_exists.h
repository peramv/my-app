...
namespace CND
{
	class CIFast_IFast_ifastdbrkr_ifastdbrkr_err_acct_control_exists : public CConditionObject
	{
	public:
		CIFast_IFast_ifastdbrkr_ifastdbrkr_err_acct_control_exists() { }
		~CIFast_IFast_ifastdbrkr_ifastdbrkr_err_acct_control_exists() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("IFASTDBRKR_ERR_ACCT_CONTROL_EXISTS")); }
