...
namespace CND
{
	class CIFast_IFast_ifastdbrkr_err_trade_unit_adj_req_for_account : public CConditionObject
	{
	public:
		CIFast_IFast_ifastdbrkr_err_trade_unit_adj_req_for_account() { }
		~CIFast_IFast_ifastdbrkr_err_trade_unit_adj_req_for_account() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_TRADE_UNIT_ADJ_REQ_FOR_ACCOUNT")); }
