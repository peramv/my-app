...
namespace CND
{
	class CIFast_IFast_ifastdbrkr_err_invalid_amount_type : public CConditionObject
	{
	public:
		CIFast_IFast_ifastdbrkr_err_invalid_amount_type() { }
		~CIFast_IFast_ifastdbrkr_err_invalid_amount_type() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_INVALID_AMOUNT_TYPE")); }
