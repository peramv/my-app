...
namespace CND
{
	class CIFast_IFast_ifastdbrkr_ifastdbrkr_unexpected_end_of_stream_file : public CConditionObject
	{
	public:
		CIFast_IFast_ifastdbrkr_ifastdbrkr_unexpected_end_of_stream_file() { }
		~CIFast_IFast_ifastdbrkr_ifastdbrkr_unexpected_end_of_stream_file() { }
