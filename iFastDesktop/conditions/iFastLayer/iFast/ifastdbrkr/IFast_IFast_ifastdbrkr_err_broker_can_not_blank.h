...
namespace CND
{
	class CIFast_IFast_ifastdbrkr_err_broker_can_not_blank : public CConditionObject
	{
	public:
		CIFast_IFast_ifastdbrkr_err_broker_can_not_blank() { }
		~CIFast_IFast_ifastdbrkr_err_broker_can_not_blank() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_BROKER_CAN_NOT_BLANK")); }
