...
namespace CND
{
	class CIFast_IFast_ifastdbrkr_err_socket_connect_failed : public CConditionObject
	{
	public:
		CIFast_IFast_ifastdbrkr_err_socket_connect_failed() { }
		~CIFast_IFast_ifastdbrkr_err_socket_connect_failed() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_SOCKET_CONNECT_FAILED")); }
