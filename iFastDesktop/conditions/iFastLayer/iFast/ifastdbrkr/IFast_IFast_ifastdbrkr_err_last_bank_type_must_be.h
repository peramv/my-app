...
namespace CND
{
	class CIFast_IFast_ifastdbrkr_err_last_bank_type_must_be : public CConditionObject
	{
	public:
		CIFast_IFast_ifastdbrkr_err_last_bank_type_must_be() { }
		~CIFast_IFast_ifastdbrkr_err_last_bank_type_must_be() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_LAST_BANK_TYPE_MUST_BE")); }
