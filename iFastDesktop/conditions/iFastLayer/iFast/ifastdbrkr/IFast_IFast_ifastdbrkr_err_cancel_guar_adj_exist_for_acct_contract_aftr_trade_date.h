...
namespace CND
{
	class CIFast_IFast_ifastdbrkr_err_cancel_guar_adj_exist_for_acct_contract_aftr_trade_date : public CConditionObject
	{
	public:
		CIFast_IFast_ifastdbrkr_err_cancel_guar_adj_exist_for_acct_contract_aftr_trade_date() { }
		~CIFast_IFast_ifastdbrkr_err_cancel_guar_adj_exist_for_acct_contract_aftr_trade_date() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_CANCEL_GUAR_ADJ_EXIST_FOR_ACCT_CONTRACT_AFTR_TRADE_DATE")); }
