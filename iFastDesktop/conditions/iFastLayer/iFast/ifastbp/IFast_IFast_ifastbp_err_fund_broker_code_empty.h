...
namespace CND
{
	class CIFast_IFast_ifastbp_err_fund_broker_code_empty : public CConditionObject
	{
	public:
		CIFast_IFast_ifastbp_err_fund_broker_code_empty() { }
		~CIFast_IFast_ifastbp_err_fund_broker_code_empty() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_FUND_BROKER_CODE_EMPTY")); }
