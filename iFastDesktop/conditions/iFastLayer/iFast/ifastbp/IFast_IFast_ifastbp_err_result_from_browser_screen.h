...
namespace CND
{
	class CIFast_IFast_ifastbp_err_result_from_browser_screen : public CConditionObject
	{
	public:
		CIFast_IFast_ifastbp_err_result_from_browser_screen() { }
		~CIFast_IFast_ifastbp_err_result_from_browser_screen() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_RESULT_FROM_BROWSER_SCREEN")); }
