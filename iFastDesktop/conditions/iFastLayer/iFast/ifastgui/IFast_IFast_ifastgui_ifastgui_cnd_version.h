...
namespace CND
{
	class CIFast_IFast_ifastgui_ifastgui_cnd_version : public CConditionObject
	{
	public:
		CIFast_IFast_ifastgui_ifastgui_cnd_version() { }
		~CIFast_IFast_ifastgui_ifastgui_cnd_version() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("IFASTGUI_CND_VERSION")); }
