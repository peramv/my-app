...
namespace CND
{
	class CIFast_IFast_ifastgui_gui_err_data_not_found : public CConditionObject
	{
	public:
		CIFast_IFast_ifastgui_gui_err_data_not_found() { }
		~CIFast_IFast_ifastgui_gui_err_data_not_found() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("GUI_ERR_DATA_NOT_FOUND")); }
		virtual DString GetGroupName() const { return DString(I_("iFast")); }
		virtual DString GetModuleName() const { return DString(I_("ifastgui")); }
		virtual int GetSeverity() const { return 4; }

		// Messages
		virtual DString GetMessage_EN_US() const { return DString(I_("Data is not found.")); }
