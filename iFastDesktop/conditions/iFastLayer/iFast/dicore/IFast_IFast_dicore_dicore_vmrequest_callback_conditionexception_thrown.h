...
namespace CND
{
	class CIFast_IFast_dicore_dicore_vmrequest_callback_conditionexception_thrown : public CConditionObject
	{
	public:
		CIFast_IFast_dicore_dicore_vmrequest_callback_conditionexception_thrown() { }
		~CIFast_IFast_dicore_dicore_vmrequest_callback_conditionexception_thrown() { }
