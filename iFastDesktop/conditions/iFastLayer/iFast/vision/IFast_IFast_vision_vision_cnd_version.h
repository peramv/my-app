...
namespace CND
{
	class CIFast_IFast_vision_vision_cnd_version : public CConditionObject
	{
	public:
		CIFast_IFast_vision_vision_cnd_version() { }
		~CIFast_IFast_vision_vision_cnd_version() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("VISION_CND_VERSION")); }
