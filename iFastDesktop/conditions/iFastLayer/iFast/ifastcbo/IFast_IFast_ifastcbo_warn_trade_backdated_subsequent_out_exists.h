...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_trade_backdated_subsequent_out_exists : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_trade_backdated_subsequent_out_exists() { }
		~CIFast_IFast_ifastcbo_warn_trade_backdated_subsequent_out_exists() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_TRADE_BACKDATED_SUBSEQUENT_OUT_EXISTS")); }
