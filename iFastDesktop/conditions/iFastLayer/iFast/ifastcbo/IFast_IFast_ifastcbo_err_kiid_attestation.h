...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_kiid_attestation : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_kiid_attestation() { }
		~CIFast_IFast_ifastcbo_err_kiid_attestation() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_KIID_ATTESTATION")); }
