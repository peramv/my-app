...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_direct_depst_bank_for_can_bank_only : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_direct_depst_bank_for_can_bank_only() { }
		~CIFast_IFast_ifastcbo_warn_direct_depst_bank_for_can_bank_only() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_DIRECT_DEPST_BANK_FOR_CAN_BANK_ONLY")); }
