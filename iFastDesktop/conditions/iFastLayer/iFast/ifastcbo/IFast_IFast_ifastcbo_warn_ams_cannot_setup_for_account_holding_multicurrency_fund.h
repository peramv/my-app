...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_ams_cannot_setup_for_account_holding_multicurrency_fund : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_ams_cannot_setup_for_account_holding_multicurrency_fund() { }
		~CIFast_IFast_ifastcbo_warn_ams_cannot_setup_for_account_holding_multicurrency_fund() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_AMS_CANNOT_SETUP_FOR_ACCOUNT_HOLDING_MULTICURRENCY_FUND")); }
