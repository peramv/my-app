...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_tup_estimated_units : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_tup_estimated_units() { }
		~CIFast_IFast_ifastcbo_warn_tup_estimated_units() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_TUP_ESTIMATED_UNITS")); }
