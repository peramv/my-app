...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_pim_inst_acct_must_be_added_to_custodian : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_pim_inst_acct_must_be_added_to_custodian() { }
		~CIFast_IFast_ifastcbo_err_pim_inst_acct_must_be_added_to_custodian() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_PIM_INST_ACCT_MUST_BE_ADDED_TO_CUSTODIAN")); }
