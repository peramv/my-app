...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_account_owner_age_over_69 : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_account_owner_age_over_69() { }
		~CIFast_IFast_ifastcbo_err_account_owner_age_over_69() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_ACCOUNT_OWNER_AGE_OVER_69")); }
