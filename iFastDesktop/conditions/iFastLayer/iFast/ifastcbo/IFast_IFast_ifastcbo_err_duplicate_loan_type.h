...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_duplicate_loan_type : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_duplicate_loan_type() { }
		~CIFast_IFast_ifastcbo_err_duplicate_loan_type() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_DUPLICATE_LOAN_TYPE")); }
