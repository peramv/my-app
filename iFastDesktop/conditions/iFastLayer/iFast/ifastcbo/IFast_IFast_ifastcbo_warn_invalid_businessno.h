...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_invalid_businessno : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_invalid_businessno() { }
		~CIFast_IFast_ifastcbo_warn_invalid_businessno() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_INVALID_BUSINESSNO")); }
