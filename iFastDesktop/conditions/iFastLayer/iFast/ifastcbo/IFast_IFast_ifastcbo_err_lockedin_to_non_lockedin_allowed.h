...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_lockedin_to_non_lockedin_allowed : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_lockedin_to_non_lockedin_allowed() { }
		~CIFast_IFast_ifastcbo_err_lockedin_to_non_lockedin_allowed() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_LOCKEDIN_TO_NON_LOCKEDIN_ALLOWED")); }
