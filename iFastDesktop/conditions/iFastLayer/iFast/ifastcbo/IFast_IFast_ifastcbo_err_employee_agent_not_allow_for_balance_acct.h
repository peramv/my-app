...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_employee_agent_not_allow_for_balance_acct : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_employee_agent_not_allow_for_balance_acct() { }
		~CIFast_IFast_ifastcbo_err_employee_agent_not_allow_for_balance_acct() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_EMPLOYEE_AGENT_NOT_ALLOW_FOR_BALANCE_ACCT")); }
