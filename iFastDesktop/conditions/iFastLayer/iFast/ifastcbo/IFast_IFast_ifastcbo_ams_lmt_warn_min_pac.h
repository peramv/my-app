...
namespace CND
{
	class CIFast_IFast_ifastcbo_ams_lmt_warn_min_pac : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_ams_lmt_warn_min_pac() { }
		~CIFast_IFast_ifastcbo_ams_lmt_warn_min_pac() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("AMS_LMT_WARN_MIN_PAC")); }
