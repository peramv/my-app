...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_acct_control_unable_to_modify : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_acct_control_unable_to_modify() { }
		~CIFast_IFast_ifastcbo_err_acct_control_unable_to_modify() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_ACCT_CONTROL_UNABLE_TO_MODIFY")); }
