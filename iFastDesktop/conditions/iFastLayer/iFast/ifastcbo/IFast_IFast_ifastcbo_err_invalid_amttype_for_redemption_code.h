...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_invalid_amttype_for_redemption_code : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_invalid_amttype_for_redemption_code() { }
		~CIFast_IFast_ifastcbo_err_invalid_amttype_for_redemption_code() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_INVALID_AMTTYPE_FOR_REDEMPTION_CODE")); }
