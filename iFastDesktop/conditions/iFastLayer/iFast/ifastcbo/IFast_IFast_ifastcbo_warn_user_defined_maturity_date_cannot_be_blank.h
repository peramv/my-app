...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_user_defined_maturity_date_cannot_be_blank : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_user_defined_maturity_date_cannot_be_blank() { }
		~CIFast_IFast_ifastcbo_warn_user_defined_maturity_date_cannot_be_blank() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_USER_DEFINED_MATURITY_DATE_CANNOT_BE_BLANK")); }
