...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_traded_unit_position : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_traded_unit_position() { }
		~CIFast_IFast_ifastcbo_warn_traded_unit_position() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_TRADED_UNIT_POSITION")); }
