...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_entity_nationality_blank : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_entity_nationality_blank() { }
		~CIFast_IFast_ifastcbo_warn_entity_nationality_blank() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_ENTITY_NATIONALITY_BLANK")); }
