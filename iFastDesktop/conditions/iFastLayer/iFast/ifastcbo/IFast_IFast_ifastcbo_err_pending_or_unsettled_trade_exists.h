...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_pending_or_unsettled_trade_exists : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_pending_or_unsettled_trade_exists() { }
		~CIFast_IFast_ifastcbo_err_pending_or_unsettled_trade_exists() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_PENDING_OR_UNSETTLED_TRADE_EXISTS")); }
