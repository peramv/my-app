...
namespace CND
{
	class IFast_IFast_ifastcbo_err_attention_biccode_linked_msg : public CConditionObject
		
	{
	public:
		IFast_IFast_ifastcbo_err_attention_biccode_linked_msg() { }
		~IFast_IFast_ifastcbo_err_attention_biccode_linked_msg() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_BIC_CODE_LINKED_MSG")); }
