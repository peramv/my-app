...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_resp_benef_over21 : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_resp_benef_over21() { }
		~CIFast_IFast_ifastcbo_warn_resp_benef_over21() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_RESP_BENEF_OVER21")); }
