...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_direct_deposit_bnk_info_missing : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_direct_deposit_bnk_info_missing() { }
		~CIFast_IFast_ifastcbo_warn_direct_deposit_bnk_info_missing() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_DIRECT_DEPOSIT_BNK_INFO_MISSING")); }
