...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_rdsp_api_timeout : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_rdsp_api_timeout() { }
		~CIFast_IFast_ifastcbo_err_rdsp_api_timeout() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_RDSP_API_TIMEOUT")); }
