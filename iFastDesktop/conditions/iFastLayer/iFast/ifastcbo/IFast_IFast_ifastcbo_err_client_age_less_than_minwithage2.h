...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_client_age_less_than_minwithage2 : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_client_age_less_than_minwithage2() { }
		~CIFast_IFast_ifastcbo_err_client_age_less_than_minwithage2() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_CLIENT_AGE_LESS_THAN_MINWITHAGE2")); }
