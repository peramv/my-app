...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_unsettled_trades_with_ams : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_unsettled_trades_with_ams() { }
		~CIFast_IFast_ifastcbo_warn_unsettled_trades_with_ams() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_UNSETTLED_TRADES_WITH_AMS")); }
