...
namespace CND
{
  class CIFast_IFast_ifastcbo_err_dilution_nsm_external_nsm_only_one_yes : public CConditionObject
  {
    public:
      CIFast_IFast_ifastcbo_err_dilution_nsm_external_nsm_only_one_yes() { }
      ~CIFast_IFast_ifastcbo_err_dilution_nsm_external_nsm_only_one_yes() { }

    public:
      // General
      virtual DString GetConditionName() const { return DString(I_("ERR_DILUTION_NSM_EXTERNAL_NSM_ONLY_ONE_YES")); }
