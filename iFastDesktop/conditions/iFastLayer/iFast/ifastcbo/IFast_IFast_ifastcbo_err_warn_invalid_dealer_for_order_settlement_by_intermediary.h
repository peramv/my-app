...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_warn_invalid_dealer_for_order_settlement_by_intermediary : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_warn_invalid_dealer_for_order_settlement_by_intermediary() { }
		~CIFast_IFast_ifastcbo_err_warn_invalid_dealer_for_order_settlement_by_intermediary() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_WARN_INVALID_DEALER_FOR_ORDER_SETTLEMENT_BY_INTERMEDIARY")); }
