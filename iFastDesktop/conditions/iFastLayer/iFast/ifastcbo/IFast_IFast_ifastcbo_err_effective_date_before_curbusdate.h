...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_effective_date_before_curbusdate : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_effective_date_before_curbusdate() { }
		~CIFast_IFast_ifastcbo_err_effective_date_before_curbusdate() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_EFFECTIVE_DATE_BEFORE_CURBUSDATE")); }
