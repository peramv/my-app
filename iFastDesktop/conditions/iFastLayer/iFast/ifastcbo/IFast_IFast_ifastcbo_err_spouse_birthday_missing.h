...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_spouse_birthday_missing : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_spouse_birthday_missing() { }
		~CIFast_IFast_ifastcbo_err_spouse_birthday_missing() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_SPOUSE_BIRTHDAY_MISSING")); }
