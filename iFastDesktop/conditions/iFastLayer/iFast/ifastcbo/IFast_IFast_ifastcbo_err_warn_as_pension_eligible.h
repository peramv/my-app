...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_warn_as_pension_eligible : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_warn_as_pension_eligible() { }
		~CIFast_IFast_ifastcbo_err_warn_as_pension_eligible() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_WARN_AS_PENSION_ELIGIBLE")); }
