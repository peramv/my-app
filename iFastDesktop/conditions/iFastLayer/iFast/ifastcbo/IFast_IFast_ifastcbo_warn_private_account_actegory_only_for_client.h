...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_private_account_actegory_only_for_client : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_private_account_actegory_only_for_client() { }
		~CIFast_IFast_ifastcbo_warn_private_account_actegory_only_for_client() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_PRIVATE_ACCOUNT_ACTEGORY_ONLY_FOR_CLIENT")); }
