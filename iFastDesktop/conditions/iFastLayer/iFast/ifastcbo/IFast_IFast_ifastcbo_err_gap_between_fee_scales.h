...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_gap_between_fee_scales : public CConditionObject
	{
	public:
	...
	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_GAP_BETWEEN_FEE_SCALES")); }
