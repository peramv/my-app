...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_bank_country_code_required : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_bank_country_code_required() { }
		~CIFast_IFast_ifastcbo_err_bank_country_code_required() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_BANK_COUNTRY_CODE_REQUIRED")); }
