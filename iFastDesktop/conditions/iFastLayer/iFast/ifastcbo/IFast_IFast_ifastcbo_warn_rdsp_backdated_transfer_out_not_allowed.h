...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_rdsp_backdated_transfer_out_not_allowed : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_rdsp_backdated_transfer_out_not_allowed() { }
		~CIFast_IFast_ifastcbo_warn_rdsp_backdated_transfer_out_not_allowed() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_RDSP_BACKDATED_TRANSFER_OUT_NOT_ALLOWED")); }
