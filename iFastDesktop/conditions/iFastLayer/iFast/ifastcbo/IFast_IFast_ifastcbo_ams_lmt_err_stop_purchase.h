...
namespace CND
{
	class CIFast_IFast_ifastcbo_ams_lmt_err_stop_purchase : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_ams_lmt_err_stop_purchase() { }
		~CIFast_IFast_ifastcbo_ams_lmt_err_stop_purchase() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("AMS_LMT_ERR_STOP_PURCHASE")); }
