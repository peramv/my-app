...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_qesi_total_transfer_filed_is_blank : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_qesi_total_transfer_filed_is_blank() { }
		~CIFast_IFast_ifastcbo_warn_qesi_total_transfer_filed_is_blank() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_QESI_TOTAL_TRANSFER_FILED_IS_BLANK")); }
