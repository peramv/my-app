...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_non_trustee_update_hist_info_req : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_non_trustee_update_hist_info_req() { }
		~CIFast_IFast_ifastcbo_warn_non_trustee_update_hist_info_req() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_NON_TRUSTEE_UPDATE_HIST_INFO_REQ")); }
