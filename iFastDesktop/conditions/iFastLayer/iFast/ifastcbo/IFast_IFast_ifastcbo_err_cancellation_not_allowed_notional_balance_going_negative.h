...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_cancellation_not_allowed_notional_balance_going_negative : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_cancellation_not_allowed_notional_balance_going_negative() { }
		~CIFast_IFast_ifastcbo_err_cancellation_not_allowed_notional_balance_going_negative() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_CANCELLATION_NOT_ALLOWED_NOTIONAL_BALANCE_GOING_NEGATIVE")); }
