...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_remain_amount_mustbe_paid : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_remain_amount_mustbe_paid() { }
		~CIFast_IFast_ifastcbo_warn_remain_amount_mustbe_paid() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_REMAIN_AMOUNT_MUSTBE_PAID")); }
