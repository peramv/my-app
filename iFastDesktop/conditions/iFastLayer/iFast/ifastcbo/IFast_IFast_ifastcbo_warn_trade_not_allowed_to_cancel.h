...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_trade_not_allowed_to_cancel : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_trade_not_allowed_to_cancel() { }
		~CIFast_IFast_ifastcbo_warn_trade_not_allowed_to_cancel() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_TRADE_NOT_ALLOWED_TO_CANCEL")); }
