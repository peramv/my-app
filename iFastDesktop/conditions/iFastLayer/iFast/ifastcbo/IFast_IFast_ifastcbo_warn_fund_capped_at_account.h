...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_fund_capped_at_account : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_fund_capped_at_account() { }
		~CIFast_IFast_ifastcbo_warn_fund_capped_at_account() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_FUND_CAPPED_AT_ACCOUNT")); }
