...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_guaguard_not_same_between_to_ti : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_guaguard_not_same_between_to_ti() { }
		~CIFast_IFast_ifastcbo_warn_guaguard_not_same_between_to_ti() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_GUAGUARD_NOT_SAME_BETWEEN_TO_TI")); }
