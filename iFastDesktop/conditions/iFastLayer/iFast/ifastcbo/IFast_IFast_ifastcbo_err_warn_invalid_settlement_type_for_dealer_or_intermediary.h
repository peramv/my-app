...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_warn_invalid_settlement_type_for_dealer_or_intermediary : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_warn_invalid_settlement_type_for_dealer_or_intermediary() { }
		~CIFast_IFast_ifastcbo_err_warn_invalid_settlement_type_for_dealer_or_intermediary() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_WARN_INVALID_SETTLEMENT_TYPE_FOR_DEALER_OR_INTERMEDIARY")); }
