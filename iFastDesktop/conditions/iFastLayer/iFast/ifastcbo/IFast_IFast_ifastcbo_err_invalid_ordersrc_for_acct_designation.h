...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_invalid_ordersrc_for_acct_designation : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_invalid_ordersrc_for_acct_designation() { }
		~CIFast_IFast_ifastcbo_err_invalid_ordersrc_for_acct_designation() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_INVALID_ORDERSRC_FOR_ACCT_DESIGNATION")); }
