...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_settle_type_block_not_allow_not_through_fundserv : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_settle_type_block_not_allow_not_through_fundserv() { }
		~CIFast_IFast_ifastcbo_err_settle_type_block_not_allow_not_through_fundserv() { }
