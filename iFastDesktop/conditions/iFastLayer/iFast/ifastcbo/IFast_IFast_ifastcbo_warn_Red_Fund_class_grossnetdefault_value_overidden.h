...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_Red_Fund_class_grossnetdefault_value_overidden : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_Red_Fund_class_grossnetdefault_value_overidden() { }
		~CIFast_IFast_ifastcbo_warn_Red_Fund_class_grossnetdefault_value_overidden() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_FUND_CLASS_GROSS_NET_FOR_REDEMPTION_OVERIDDEN")); }
