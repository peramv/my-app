...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_ams_account_hold_gic : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_ams_account_hold_gic() { }
		~CIFast_IFast_ifastcbo_err_ams_account_hold_gic() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_AMS_ACCOUNT_HOLD_GIC")); }
