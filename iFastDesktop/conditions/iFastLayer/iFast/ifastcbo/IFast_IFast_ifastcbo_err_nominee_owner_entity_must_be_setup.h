...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_nominee_owner_entity_must_be_setup : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_nominee_owner_entity_must_be_setup() { }
		~CIFast_IFast_ifastcbo_err_nominee_owner_entity_must_be_setup() { }
