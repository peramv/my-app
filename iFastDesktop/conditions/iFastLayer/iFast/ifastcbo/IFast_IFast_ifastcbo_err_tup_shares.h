...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_tup_shares : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_tup_shares() { }
		~CIFast_IFast_ifastcbo_err_tup_shares() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_TUP_SHARES")); }
