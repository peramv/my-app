...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_cesg_adcesg_amount_be_returned_because_redemption : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_cesg_adcesg_amount_be_returned_because_redemption() { }
		~CIFast_IFast_ifastcbo_warn_cesg_adcesg_amount_be_returned_because_redemption() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_CESG_ADCESG_AMOUNT_BE_RETURNED_BECAUSE_REDEMPTION")); }
