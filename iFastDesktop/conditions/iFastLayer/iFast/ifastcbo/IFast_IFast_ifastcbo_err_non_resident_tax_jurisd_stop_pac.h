...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_non_resident_tax_jurisd_stop_pac : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_non_resident_tax_jurisd_stop_pac() { }
		~CIFast_IFast_ifastcbo_err_non_resident_tax_jurisd_stop_pac() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_NON_RESIDENT_TAX_JURISD_STOP_PAC")); }
