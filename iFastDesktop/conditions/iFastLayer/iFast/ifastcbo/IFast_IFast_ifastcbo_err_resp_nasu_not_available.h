...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_resp_nasu_not_available : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_resp_nasu_not_available() { }
		~CIFast_IFast_ifastcbo_err_resp_nasu_not_available() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_RESP_NASU_NOT_AVAILABLE")); }
