...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_group_number_is_required : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_group_number_is_required() { }
		~CIFast_IFast_ifastcbo_err_group_number_is_required() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_GROUP_NUMBER_IS_REQUIRED")); }
		virtual DString GetGroupName() const { return DString(I_("iFast")); }
		virtual DString GetModuleName() const { return DString(I_("ifastcbo")); }
		virtual int GetSeverity() const { return 6; }

		// Messages
		virtual DString GetMessage_EN_US() const { return DString(I_("Group number is a required field for record update.")); }
		virtual DString GetMessage_FR_FR() const { return DString(I_("Group number is a required field for record update.")); }
		virtual DString GetMessage_DE_DE() const { return DString(I_("Das Feld \"Gruppennummer\" ist für die Aktualisierung des Eintrags erforderlich. Bitte geben Sie einen Wert ein.")); }
