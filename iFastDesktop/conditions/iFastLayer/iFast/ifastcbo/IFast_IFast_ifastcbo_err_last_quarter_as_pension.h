...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_last_quarter_as_pension : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_last_quarter_as_pension() { }
		~CIFast_IFast_ifastcbo_err_last_quarter_as_pension() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_LAST_QUARTER_AS_PENSION")); }
