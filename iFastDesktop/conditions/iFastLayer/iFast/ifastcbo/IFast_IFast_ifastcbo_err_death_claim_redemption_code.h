...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_death_claim_redemption_code : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_death_claim_redemption_code() { }
		~CIFast_IFast_ifastcbo_err_death_claim_redemption_code() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_DEATH_CLAIM_REDEMPTION_CODE")); }
