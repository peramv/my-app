...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_acct_no_holdings : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_acct_no_holdings() { }
		~CIFast_IFast_ifastcbo_err_acct_no_holdings() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_ACCT_NO_HOLDINGS")); }
