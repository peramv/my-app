...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_qesi_amount_greater_than_10_prcnt_of_existing_qesi_unassisted_amount : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_qesi_amount_greater_than_10_prcnt_of_existing_qesi_unassisted_amount() { }
		~CIFast_IFast_ifastcbo_warn_qesi_amount_greater_than_10_prcnt_of_existing_qesi_unassisted_amount() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_QESI_AMOUNT_GREATER_THAN_10_PRCNT_OF_EXISTING_QESI_UNASSISTED_AMOUNT")); }
