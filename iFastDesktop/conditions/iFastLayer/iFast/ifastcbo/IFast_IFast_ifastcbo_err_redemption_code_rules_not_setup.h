...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_redemption_code_rules_not_setup : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_redemption_code_rules_not_setup() { }
		~CIFast_IFast_ifastcbo_err_redemption_code_rules_not_setup() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_REDEMPTION_CODE_RULES_NOT_SETUP")); }
