...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_transfer_contrary_client_guaguard_protection : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_transfer_contrary_client_guaguard_protection() { }
		~CIFast_IFast_ifastcbo_warn_transfer_contrary_client_guaguard_protection() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_TRANSFER_CONTRARY_CLIENT_GUAGUARD_PROTECTION")); }
