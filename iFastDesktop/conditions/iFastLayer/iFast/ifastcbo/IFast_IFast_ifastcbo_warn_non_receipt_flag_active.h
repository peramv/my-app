...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_non_receipt_flag_active : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_non_receipt_flag_active() { }
		~CIFast_IFast_ifastcbo_warn_non_receipt_flag_active() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_NON_RECEIPT_FLAG_ACTIVE")); }
