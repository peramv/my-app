...
namespace CND
{
    class CIFast_IFast_ifastcbo_warn_tr_out_must_be_cancelled : public CConditionObject
    {
    public:
        CIFast_IFast_ifastcbo_warn_tr_out_must_be_cancelled() { }
        ~CIFast_IFast_ifastcbo_warn_tr_out_must_be_cancelled() { }

    public:
        // General
        virtual DString GetConditionName() const { return DString(I_("WARN_TR_OUT_MUSTBE_CANCELLED_PRIOR_TO_THIS_OPERATION")); }
