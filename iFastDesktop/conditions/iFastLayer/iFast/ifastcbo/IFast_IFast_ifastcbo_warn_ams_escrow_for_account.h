...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_ams_escrow_for_account : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_ams_escrow_for_account() { }
		~CIFast_IFast_ifastcbo_warn_ams_escrow_for_account() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_AMS_ESCROW_FOR_ACCOUNT")); }
