...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_non_associated_benef_is_not_allowed : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_non_associated_benef_is_not_allowed() { }
		~CIFast_IFast_ifastcbo_warn_non_associated_benef_is_not_allowed() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_NON_ASSOCIATED_BENEF_IS_NOT_ALLOWED")); }
