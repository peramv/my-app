...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_different_siblingonly_status : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_different_siblingonly_status() { }
		~CIFast_IFast_ifastcbo_warn_different_siblingonly_status() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_DIFFERENT_SIBLINGONLY_STATUS")); }
