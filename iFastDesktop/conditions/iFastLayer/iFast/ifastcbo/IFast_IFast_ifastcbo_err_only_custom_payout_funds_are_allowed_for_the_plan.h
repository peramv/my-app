...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_only_custom_payout_funds_are_allowed_for_the_plan : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_only_custom_payout_funds_are_allowed_for_the_plan() { }
		~CIFast_IFast_ifastcbo_err_only_custom_payout_funds_are_allowed_for_the_plan() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_ONLY_CUSTOM_PAYOUT_FUNDS_ARE_ALLOWED_FOR_THE_PLAN")); }
