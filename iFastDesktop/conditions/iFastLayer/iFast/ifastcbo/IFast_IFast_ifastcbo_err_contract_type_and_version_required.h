...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_contract_type_and_version_required : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_contract_type_and_version_required() { }
		~CIFast_IFast_ifastcbo_err_contract_type_and_version_required() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_CONTRACT_TYPE_AND_VERSION_REQUIRED")); }
