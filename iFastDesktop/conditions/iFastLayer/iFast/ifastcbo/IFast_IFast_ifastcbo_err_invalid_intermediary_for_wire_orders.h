...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_invalid_intermediary_for_wire_orders : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_invalid_intermediary_for_wire_orders() { }
		~CIFast_IFast_ifastcbo_err_invalid_intermediary_for_wire_orders() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_INVALID_INTERMEDIARY_FOR_WIRE_ORDERS")); }
