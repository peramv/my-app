...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_direct_depst_bank_for_can_cur_bank_acct_only : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_direct_depst_bank_for_can_cur_bank_acct_only() { }
		~CIFast_IFast_ifastcbo_err_direct_depst_bank_for_can_cur_bank_acct_only() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_DIRECT_DEPST_BANK_FOR_CAN_CUR_BANK_ACCT_ONLY")); }
