...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_payins_should_be_eft : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_payins_should_be_eft() { }
		~CIFast_IFast_ifastcbo_err_payins_should_be_eft() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_PAYINS_SHOULD_BE_EFT")); }
