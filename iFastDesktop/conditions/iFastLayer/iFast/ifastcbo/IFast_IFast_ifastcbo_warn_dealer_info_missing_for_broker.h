...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_dealer_info_missing_for_broker : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_dealer_info_missing_for_broker() { }
		~CIFast_IFast_ifastcbo_warn_dealer_info_missing_for_broker() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_DEALER_INFO_MISSING_FOR_BROKER")); }
