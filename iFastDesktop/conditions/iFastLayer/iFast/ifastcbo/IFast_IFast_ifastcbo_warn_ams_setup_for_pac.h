...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_ams_setup_for_pac : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_ams_setup_for_pac() { }
		~CIFast_IFast_ifastcbo_warn_ams_setup_for_pac() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_AMS_SETUP_FOR_PAC")); }
