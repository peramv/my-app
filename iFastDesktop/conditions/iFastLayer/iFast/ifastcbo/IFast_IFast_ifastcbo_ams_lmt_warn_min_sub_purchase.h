...
namespace CND
{
	class CIFast_IFast_ifastcbo_ams_lmt_warn_min_sub_purchase : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_ams_lmt_warn_min_sub_purchase() { }
		~CIFast_IFast_ifastcbo_ams_lmt_warn_min_sub_purchase() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("AMS_LMT_WARN_MIN_SUB_PURCHASE")); }
