...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_stopdate_not_valid : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_stopdate_not_valid() { }
		~CIFast_IFast_ifastcbo_err_stopdate_not_valid() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_STOPDATE_NOT_VALID")); }
