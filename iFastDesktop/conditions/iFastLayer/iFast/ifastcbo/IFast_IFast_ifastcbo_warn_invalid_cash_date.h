...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_invalid_cash_date : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_invalid_cash_date() { }
		~CIFast_IFast_ifastcbo_warn_invalid_cash_date() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_INVALID_CASH_DATE")); }
