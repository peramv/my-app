...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_warn_spousal_consent_waiver_required : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_warn_spousal_consent_waiver_required() { }
		~CIFast_IFast_ifastcbo_err_warn_spousal_consent_waiver_required() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_WARN_SPOUSAL_CONSENT_WAIVER_REQUIRED")); }
