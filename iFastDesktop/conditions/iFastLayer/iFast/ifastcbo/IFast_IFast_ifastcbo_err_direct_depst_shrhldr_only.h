...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_direct_depst_shrhldr_only : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_direct_depst_shrhldr_only() { }
		~CIFast_IFast_ifastcbo_err_direct_depst_shrhldr_only() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_DIRECT_DEPST_SHRHLDR_ONLY")); }
