...
namespace CND
{
	class CIFast_IFast_ifastcbo_info_shareholder_has_multiple_addresses : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_info_shareholder_has_multiple_addresses() { }
		~CIFast_IFast_ifastcbo_info_shareholder_has_multiple_addresses() { }
