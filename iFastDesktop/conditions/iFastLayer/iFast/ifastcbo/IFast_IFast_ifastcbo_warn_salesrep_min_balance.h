...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_salesrep_min_balance : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_salesrep_min_balance() { }
		~CIFast_IFast_ifastcbo_warn_salesrep_min_balance() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_SALESREP_MIN_BALANCE")); }
