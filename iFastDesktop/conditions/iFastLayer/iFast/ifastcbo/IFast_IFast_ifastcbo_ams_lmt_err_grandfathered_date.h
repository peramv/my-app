...
namespace CND
{
	class CIFast_IFast_ifastcbo_ams_lmt_err_grandfathered_date : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_ams_lmt_err_grandfathered_date() { }
		~CIFast_IFast_ifastcbo_ams_lmt_err_grandfathered_date() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("AMS_LMT_ERR_GRANDFATHERED_DATE")); }
