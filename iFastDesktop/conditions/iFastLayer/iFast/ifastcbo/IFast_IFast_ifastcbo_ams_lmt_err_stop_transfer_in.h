...
namespace CND
{
	class CIFast_IFast_ifastcbo_ams_lmt_err_stop_transfer_in : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_ams_lmt_err_stop_transfer_in() { }
		~CIFast_IFast_ifastcbo_ams_lmt_err_stop_transfer_in() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("AMS_LMT_ERR_STOP_TRANSFER_IN")); }
