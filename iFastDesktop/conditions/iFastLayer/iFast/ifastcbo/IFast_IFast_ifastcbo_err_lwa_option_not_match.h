...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_lwa_option_not_match : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_lwa_option_not_match() { }
		~CIFast_IFast_ifastcbo_err_lwa_option_not_match() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_LWA_OPTION_NOT_MATCH")); }
