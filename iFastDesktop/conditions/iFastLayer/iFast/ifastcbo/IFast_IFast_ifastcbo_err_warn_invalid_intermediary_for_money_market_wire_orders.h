...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_warn_invalid_intermediary_for_money_market_wire_orders : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_warn_invalid_intermediary_for_money_market_wire_orders() { }
		~CIFast_IFast_ifastcbo_err_warn_invalid_intermediary_for_money_market_wire_orders() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_WARN_INVALID_INTERMEDIARY_FOR_MONEY_MARKET_WIRE_ORDERS")); }
