...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_annuitant_date_of_birth_is_changing : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_annuitant_date_of_birth_is_changing() { }
		~CIFast_IFast_ifastcbo_warn_annuitant_date_of_birth_is_changing() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_ANNUITANT_DOFBIRTH_IS_CHANGING")); }
