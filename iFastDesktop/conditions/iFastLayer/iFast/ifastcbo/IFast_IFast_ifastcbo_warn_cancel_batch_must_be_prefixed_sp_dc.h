...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_cancel_batch_must_be_prefixed_sp_dc : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_cancel_batch_must_be_prefixed_sp_dc() { }
		~CIFast_IFast_ifastcbo_warn_cancel_batch_must_be_prefixed_sp_dc() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_CANCEL_BATCH_MUST_BE_PREFIXED_SP_DC")); }
