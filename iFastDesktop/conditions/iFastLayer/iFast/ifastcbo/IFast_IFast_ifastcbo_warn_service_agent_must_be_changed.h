...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_service_agent_must_be_changed : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_service_agent_must_be_changed() { }
		~CIFast_IFast_ifastcbo_warn_service_agent_must_be_changed() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_SERVICE_AGENT_MUST_BE_CHANGED")); }
