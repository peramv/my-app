...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_scheduled_payment_not_available : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_scheduled_payment_not_available() { }
		~CIFast_IFast_ifastcbo_err_scheduled_payment_not_available() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_SCHEDULED_PAYMENT_NOT_AVAILABLE")); }
