...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_broker_min_balance : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_broker_min_balance() { }
		~CIFast_IFast_ifastcbo_err_broker_min_balance() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_BROKER_MIN_BALANCE")); }
