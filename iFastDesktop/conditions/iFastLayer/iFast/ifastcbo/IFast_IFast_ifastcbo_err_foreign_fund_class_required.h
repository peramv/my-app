...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_foreign_fund_class_required : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_foreign_fund_class_required() { }
		~CIFast_IFast_ifastcbo_err_foreign_fund_class_required() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_FOREIGN_FUND_CLASS_REQUIRED")); }
