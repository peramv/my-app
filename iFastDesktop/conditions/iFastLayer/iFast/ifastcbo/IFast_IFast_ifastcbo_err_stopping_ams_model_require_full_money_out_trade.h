...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_stopping_ams_model_require_full_money_out_trade : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_stopping_ams_model_require_full_money_out_trade() { }
		~CIFast_IFast_ifastcbo_err_stopping_ams_model_require_full_money_out_trade() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_STOPPING_AMS_MODEL_REQUIRE_FULL_MONEY_OUT_TRADE")); }
