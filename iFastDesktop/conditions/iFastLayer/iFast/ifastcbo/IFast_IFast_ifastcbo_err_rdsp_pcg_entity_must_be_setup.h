...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_rdsp_pcg_entity_must_be_setup : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_rdsp_pcg_entity_must_be_setup() { }
		~CIFast_IFast_ifastcbo_err_rdsp_pcg_entity_must_be_setup() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_RDSP_PCG_ENTITY_MUST_BE_SETUP")); }
