...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_Settledate_less_than_fund_level_Settledate : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_Settledate_less_than_fund_level_Settledate() { }
		~CIFast_IFast_ifastcbo_warn_Settledate_less_than_fund_level_Settledate() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_SETTLEDATE_LESS_THAN_FUND_LEVEL_SETTLEDATE")); }
