...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_payment_status_is_outstanding : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_payment_status_is_outstanding() { }
		~CIFast_IFast_ifastcbo_warn_payment_status_is_outstanding() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_PAYMENT_STATUS_IS_OUTSTANDING")); }
