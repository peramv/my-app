...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_stop_flag_set_for_fund : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_stop_flag_set_for_fund() { }
		~CIFast_IFast_ifastcbo_err_stop_flag_set_for_fund() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_STOP_FLAG_SET_FOR_FUND")); }
