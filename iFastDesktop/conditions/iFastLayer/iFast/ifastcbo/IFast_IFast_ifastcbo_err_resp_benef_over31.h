...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_resp_benef_over31 : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_resp_benef_over31() { }
		~CIFast_IFast_ifastcbo_err_resp_benef_over31() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_RESP_BENEF_OVER31")); }
