...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_acct_locked_no_redemption_available : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_acct_locked_no_redemption_available() { }
		~CIFast_IFast_ifastcbo_err_acct_locked_no_redemption_available() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_ACCT_LOCKED_NO_REDEMPTION_AVAILABLE")); }
