...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_fund_class_sysgentrfout_stop_flag_on : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_fund_class_sysgentrfout_stop_flag_on() { }
		~CIFast_IFast_ifastcbo_err_fund_class_sysgentrfout_stop_flag_on() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_FUND_CLASS_SYSGENTRFOUT_STOP_FLAG_ON")); }
