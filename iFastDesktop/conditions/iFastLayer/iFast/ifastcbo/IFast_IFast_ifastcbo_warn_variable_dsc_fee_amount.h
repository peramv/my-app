...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_variable_dsc_fee_amount : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_variable_dsc_fee_amount() { }
		~CIFast_IFast_ifastcbo_warn_variable_dsc_fee_amount() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_VARIABLE_DSC_FEE_AMOUNT")); }
