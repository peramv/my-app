...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_invalid_age : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_invalid_age() { }
		~CIFast_IFast_ifastcbo_err_invalid_age() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_INVALID_AGE")); }
