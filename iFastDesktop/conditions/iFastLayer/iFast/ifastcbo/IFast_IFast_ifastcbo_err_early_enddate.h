...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_early_enddate : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_early_enddate() { }
		~CIFast_IFast_ifastcbo_err_early_enddate() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_EARLY_ENDDATE")); }
