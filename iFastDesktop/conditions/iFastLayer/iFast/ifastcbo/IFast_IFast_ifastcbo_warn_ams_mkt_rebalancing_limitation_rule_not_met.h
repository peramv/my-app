...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_ams_mkt_rebalancing_limitation_rule_not_met : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_ams_mkt_rebalancing_limitation_rule_not_met() { }
		~CIFast_IFast_ifastcbo_warn_ams_mkt_rebalancing_limitation_rule_not_met() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_AMS_MKT_REBALANCING_LIMITATION_RULE_NOT_MET")); }
