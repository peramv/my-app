...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_notional_amounts_must_be_negative : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_notional_amounts_must_be_negative() { }
		~CIFast_IFast_ifastcbo_err_notional_amounts_must_be_negative() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_NOTIONAL_AMOUNTS_MUST_BE_NEGATIVE")); }
