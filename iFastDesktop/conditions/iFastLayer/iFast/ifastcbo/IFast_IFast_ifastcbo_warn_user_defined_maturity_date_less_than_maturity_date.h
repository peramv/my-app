...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_user_defined_maturity_date_less_than_maturity_date : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_user_defined_maturity_date_less_than_maturity_date() { }
		~CIFast_IFast_ifastcbo_warn_user_defined_maturity_date_less_than_maturity_date() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_USER_DEFINED_MATURITY_DATE_LESS_THAN_MATURITY_DATE")); }
