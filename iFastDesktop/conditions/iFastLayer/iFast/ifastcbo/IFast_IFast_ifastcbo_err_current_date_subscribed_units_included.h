...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_current_date_subscribed_units_included : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_current_date_subscribed_units_included() { }
		~CIFast_IFast_ifastcbo_err_current_date_subscribed_units_included() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_CURRENT_DATE_SUBSCRIBED_UNITS_INCLUDED")); }
