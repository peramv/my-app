...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_contract_acct_status_inactive : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_contract_acct_status_inactive() { }
		~CIFast_IFast_ifastcbo_err_contract_acct_status_inactive() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_CONTRACT_ACCT_STATUS_INACTIVE")); }
