...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_fund_capped_at_fnd_cls : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_fund_capped_at_fnd_cls() { }
		~CIFast_IFast_ifastcbo_warn_fund_capped_at_fnd_cls() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_FUND_CAPPED_AT_FND_CLS")); }
