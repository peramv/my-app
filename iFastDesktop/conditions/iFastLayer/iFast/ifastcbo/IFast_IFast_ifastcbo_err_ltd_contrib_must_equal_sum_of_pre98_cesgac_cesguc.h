...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_ltd_contrib_must_equal_sum_of_pre98_cesgac_cesguc: public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_ltd_contrib_must_equal_sum_of_pre98_cesgac_cesguc() { }
		~CIFast_IFast_ifastcbo_err_ltd_contrib_must_equal_sum_of_pre98_cesgac_cesguc() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_LTD_CONTRIB_MUST_EQUAL_SUM_OF_PRE98_CESGAC_CESGUC")); }
