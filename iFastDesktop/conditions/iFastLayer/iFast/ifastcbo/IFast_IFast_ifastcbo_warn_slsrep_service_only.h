...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_slsrep_service_only : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_slsrep_service_only() { }
		~CIFast_IFast_ifastcbo_warn_slsrep_service_only() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_SERVICE_ONLY_SALES_REP")); }
