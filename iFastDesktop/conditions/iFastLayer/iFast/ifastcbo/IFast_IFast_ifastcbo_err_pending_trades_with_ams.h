...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_pending_trades_with_ams : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_pending_trades_with_ams() { }
		~CIFast_IFast_ifastcbo_err_pending_trades_with_ams() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_PENDING_TRADES_WITH_AMS")); }
