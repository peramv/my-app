...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_parent_fund_class_diff_from_ams_model : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_parent_fund_class_diff_from_ams_model() { }
		~CIFast_IFast_ifastcbo_warn_parent_fund_class_diff_from_ams_model() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_PARENT_FUND_CLASS_DIFF_FROM_AMS_MODEL")); }
