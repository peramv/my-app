...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_service_agent_changed_by_compensation_agent : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_service_agent_changed_by_compensation_agent() { }
		~CIFast_IFast_ifastcbo_warn_service_agent_changed_by_compensation_agent() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_SERVICE_AGENT_CHANGED_BY_COMPENSATION_AGENT")); }
