...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_invalid_year_resp_oc_withdrawal : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_invalid_year_resp_oc_withdrawal() { }
		~CIFast_IFast_ifastcbo_warn_invalid_year_resp_oc_withdrawal() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_INVALID_YEAR_RESP_OC_WITHDRAWAL")); }
