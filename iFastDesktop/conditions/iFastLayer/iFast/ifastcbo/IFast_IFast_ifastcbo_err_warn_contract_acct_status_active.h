...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_warn_contract_acct_status_active : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_warn_contract_acct_status_active() { }
		~CIFast_IFast_ifastcbo_err_warn_contract_acct_status_active() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_WARN_CONTRACT_ACCT_STATUS_ACTIVE")); }
