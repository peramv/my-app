...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_ams_setup_for_swp : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_ams_setup_for_swp() { }
		~CIFast_IFast_ifastcbo_err_ams_setup_for_swp() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_AMS_SETUP_FOR_SWP")); }
