...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_active_swp_conttype_exists : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_active_swp_conttype_exists() { }
		~CIFast_IFast_ifastcbo_warn_active_swp_conttype_exists() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_ACTIVE_SWP_CONTTYPE_EXISTS")); }
