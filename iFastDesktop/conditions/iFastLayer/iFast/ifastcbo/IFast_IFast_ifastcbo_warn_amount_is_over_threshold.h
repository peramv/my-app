...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_amount_is_over_threshold : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_amount_is_over_threshold() { }
		~CIFast_IFast_ifastcbo_warn_amount_is_over_threshold() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_AMOUNT_IS_OVER_THRESHOLD")); }
