...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_slsrep_min_allowable_purchase : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_slsrep_min_allowable_purchase() { }
		~CIFast_IFast_ifastcbo_warn_slsrep_min_allowable_purchase() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_SLSREP_MIN_ALLOWABLE_PURCHASE")); }
