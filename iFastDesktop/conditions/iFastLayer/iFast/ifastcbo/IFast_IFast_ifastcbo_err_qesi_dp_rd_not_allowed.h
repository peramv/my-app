...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_qesi_dp_rd_not_allowed : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_qesi_dp_rd_not_allowed() { }
		~CIFast_IFast_ifastcbo_err_qesi_dp_rd_not_allowed() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_QESI_DP_RD_NOT_ALLOWED")); }
