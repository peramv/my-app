...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_duplicate_loan_num : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_duplicate_loan_num() { }
		~CIFast_IFast_ifastcbo_warn_duplicate_loan_num() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_DUPLICATE_LOAN_NUM")); }
