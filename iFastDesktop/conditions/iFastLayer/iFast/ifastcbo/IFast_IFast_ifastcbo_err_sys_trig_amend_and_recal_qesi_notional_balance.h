...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_sys_trig_amend_and_recal_qesi_notional_balance : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_sys_trig_amend_and_recal_qesi_notional_balance() { }
		~CIFast_IFast_ifastcbo_err_sys_trig_amend_and_recal_qesi_notional_balance() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_SYS_TRIG_AMEND_AND_RECAL_QESI_NOTIONAL_BALANCE")); }
