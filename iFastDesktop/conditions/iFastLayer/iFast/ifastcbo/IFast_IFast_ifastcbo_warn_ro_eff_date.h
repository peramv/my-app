...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_ro_eff_date : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_ro_eff_date() { }
		~CIFast_IFast_ifastcbo_warn_ro_eff_date() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_RO_EFF_DATE")); }
