...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_warn_assignment_redeem_not_allow : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_warn_assignment_redeem_not_allow() { }
		~CIFast_IFast_ifastcbo_err_warn_assignment_redeem_not_allow() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_WARN_ASSIGNMENT_REDEEM_NOT_ALLOW")); }
