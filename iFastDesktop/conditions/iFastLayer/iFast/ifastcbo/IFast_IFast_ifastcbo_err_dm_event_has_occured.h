...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_dm_event_has_occured : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_dm_event_has_occured() { }
		~CIFast_IFast_ifastcbo_err_dm_event_has_occured() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_DM_EVENT_HAS_OCCURED")); }
