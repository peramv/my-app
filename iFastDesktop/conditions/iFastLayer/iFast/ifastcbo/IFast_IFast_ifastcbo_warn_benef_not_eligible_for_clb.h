...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_benef_not_eligible_for_clb : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_benef_not_eligible_for_clb() { }
		~CIFast_IFast_ifastcbo_warn_benef_not_eligible_for_clb() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_BENEF_NOT_ELIGIBLE_FOR_CLB")); }
