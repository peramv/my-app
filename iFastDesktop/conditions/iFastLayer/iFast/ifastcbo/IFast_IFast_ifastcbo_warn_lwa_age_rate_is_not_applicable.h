...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_lwa_age_rate_is_not_applicable : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_lwa_age_rate_is_not_applicable() { }
		~CIFast_IFast_ifastcbo_warn_lwa_age_rate_is_not_applicable() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_LWA_AGE_RATE_IS_NOT_APPLICABLE")); }
