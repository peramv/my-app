...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_lsif_redemption_not_enough_units_available : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_lsif_redemption_not_enough_units_available() { }
		~CIFast_IFast_ifastcbo_err_lsif_redemption_not_enough_units_available() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_LSIF_REDEMPTION_NOT_ENOUGH_UNITS_AVAILABLE")); }
