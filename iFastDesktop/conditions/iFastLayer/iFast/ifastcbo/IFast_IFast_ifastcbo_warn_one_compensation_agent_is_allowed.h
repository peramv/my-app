...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_one_compensation_agent_is_allowed : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_one_compensation_agent_is_allowed() { }
		~CIFast_IFast_ifastcbo_warn_one_compensation_agent_is_allowed() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_ONE_COMPENSATION_AGENT_IS_ALLOWED")); }
