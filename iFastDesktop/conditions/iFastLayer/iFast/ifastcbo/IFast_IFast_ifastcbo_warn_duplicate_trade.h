...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_duplicate_trade : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_duplicate_trade() { }
		~CIFast_IFast_ifastcbo_warn_duplicate_trade() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_DUPLICATE_TRADE")); }
