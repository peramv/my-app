...
namespace CND
{
	class CIFast_IFast_ifastcbo_ams_lmt_err_stop_redemption : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_ams_lmt_err_stop_redemption() { }
		~CIFast_IFast_ifastcbo_ams_lmt_err_stop_redemption() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("AMS_LMT_ERR_STOP_REDEMPTION")); }
