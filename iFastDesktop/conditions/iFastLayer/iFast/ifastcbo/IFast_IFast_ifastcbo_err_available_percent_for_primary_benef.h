...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_available_percent_for_primary_benef : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_available_percent_for_primary_benef() { }
		~CIFast_IFast_ifastcbo_err_available_percent_for_primary_benef() { }
