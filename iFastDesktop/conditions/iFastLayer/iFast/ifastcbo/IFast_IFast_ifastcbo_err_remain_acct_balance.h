...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_remain_acct_balance : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_remain_acct_balance() { }
		~CIFast_IFast_ifastcbo_err_remain_acct_balance() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_REMAIN_ACCT_BALANCE")); }
