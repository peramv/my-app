...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_subsequent_events_taken_place_at_backdating : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_subsequent_events_taken_place_at_backdating() { }
		~CIFast_IFast_ifastcbo_err_subsequent_events_taken_place_at_backdating() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_SUBSEQUENT_EVENTS_TAKEN_PLACE_AT_BACKDATING")); }
