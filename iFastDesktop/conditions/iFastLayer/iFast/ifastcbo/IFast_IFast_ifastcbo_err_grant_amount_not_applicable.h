...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_grant_amount_not_applicable : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_grant_amount_not_applicable() { }
		~CIFast_IFast_ifastcbo_err_grant_amount_not_applicable() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_GRANT_AMOUNT_NOT_APPLICABLE")); }
