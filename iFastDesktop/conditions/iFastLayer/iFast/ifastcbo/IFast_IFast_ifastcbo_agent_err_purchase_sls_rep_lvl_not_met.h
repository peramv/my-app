...
namespace CND
{
	class CIFast_IFast_ifastcbo_agent_err_purchase_sls_rep_lvl_not_met : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_agent_err_purchase_sls_rep_lvl_not_met() { }
		~CIFast_IFast_ifastcbo_agent_err_purchase_sls_rep_lvl_not_met() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("AGENT_ERR_PURCHASE_SLS_REP_LVL_NOT_MET")); }
