...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_gmwb_payoption : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_gmwb_payoption() { }
		~CIFast_IFast_ifastcbo_warn_gmwb_payoption() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_GMWB_PAYOPTION")); }
