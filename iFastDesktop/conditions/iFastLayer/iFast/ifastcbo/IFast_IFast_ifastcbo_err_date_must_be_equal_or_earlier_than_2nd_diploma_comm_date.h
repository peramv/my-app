...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_date_must_be_equal_or_earlier_than_2nd_diploma_comm_date : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_date_must_be_equal_or_earlier_than_2nd_diploma_comm_date() { }
		~CIFast_IFast_ifastcbo_err_date_must_be_equal_or_earlier_than_2nd_diploma_comm_date() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_DATE_MUST_BE_EQUAL_OR_EARLIER_THAN_2ND_DIPLOMA_COMM_DATE")); }
