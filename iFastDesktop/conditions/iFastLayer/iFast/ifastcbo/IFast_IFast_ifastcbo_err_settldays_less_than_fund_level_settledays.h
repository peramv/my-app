...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_Settledays_less_than_fund_level_Settledays : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_Settledays_less_than_fund_level_Settledays() { }
		~CIFast_IFast_ifastcbo_err_Settledays_less_than_fund_level_Settledays() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_SETTLEDAYS_LESS_THAN_FUND_LEVEL_SETTLEDAYS")); }
