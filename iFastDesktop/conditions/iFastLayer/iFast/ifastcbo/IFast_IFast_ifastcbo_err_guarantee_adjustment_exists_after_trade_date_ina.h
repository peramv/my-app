...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_guarantee_adjustment_exists_after_trade_date_ina : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_guarantee_adjustment_exists_after_trade_date_ina() { }
		~CIFast_IFast_ifastcbo_err_guarantee_adjustment_exists_after_trade_date_ina() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_GUARANTEE_ADJUSTMENT_EXISTS_AFTER_TRADE_DATE_INA")); }
