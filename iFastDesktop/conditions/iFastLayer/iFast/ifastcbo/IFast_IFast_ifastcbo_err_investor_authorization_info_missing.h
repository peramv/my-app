...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_investor_authorization_info_missing : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_investor_authorization_info_missing() { }
		~CIFast_IFast_ifastcbo_err_investor_authorization_info_missing() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_INVESTOR_AUTHORIZATION_INFO_MISSING")); }
