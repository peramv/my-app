...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_trade_is_part_of_dm_event : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_trade_is_part_of_dm_event() { }
		~CIFast_IFast_ifastcbo_warn_trade_is_part_of_dm_event() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_TRADE_IS_PART_OF_DM_EVENT")); }
