...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_assisted_contribution_amount_more_than_available_assisted_amount : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_assisted_contribution_amount_more_than_available_assisted_amount() { }
		~CIFast_IFast_ifastcbo_warn_assisted_contribution_amount_more_than_available_assisted_amount() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_ASSISTED_CONTRIBUTION_AMOUNT_MORE_THAN_AVAILABLE_ASSISTED_AMOUNT")); }
