...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_value_between_two_reocrds : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_value_between_two_reocrds() { }
		~CIFast_IFast_ifastcbo_err_value_between_two_reocrds() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_VALUE_BETWEEN_TWO_REOCRDS")); }
