...
namespace CND
{
  class CIFast_IFast_ifastcbo_warn_only_one_rec_with_100_percent_allowed : public CConditionObject
  {
    public:
      CIFast_IFast_ifastcbo_warn_only_one_rec_with_100_percent_allowed() { }
      ~CIFast_IFast_ifastcbo_warn_only_one_rec_with_100_percent_allowed() { }
  
    public:
      // General
      virtual DString GetConditionName() const { return DString(I_("WARN_ONLY_ONE_REC_WITH_100_PERCENT_ALLOWED")); }
