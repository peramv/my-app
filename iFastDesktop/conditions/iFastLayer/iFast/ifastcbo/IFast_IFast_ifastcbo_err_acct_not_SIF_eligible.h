...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_acct_not_SIF : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_acct_not_SIF() { }
		~CIFast_IFast_ifastcbo_err_acct_not_SIF() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_ACCOUNT_NOT_SIF_ELIGABLE")); }
