...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_gross_redemption_minimum_applies : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_gross_redemption_minimum_applies() { }
		~CIFast_IFast_ifastcbo_err_gross_redemption_minimum_applies() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_GROSS_REDEMPTION_MINIMUM_APPLIES")); }
