...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_flatpercent_must_be_yes : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_flatpercent_must_be_yes() { }
		~CIFast_IFast_ifastcbo_err_flatpercent_must_be_yes() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_FLATPERCENT_MUST_BE_YES")); }
