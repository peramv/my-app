...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_aip_to_nonresident_not_allowed : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_aip_to_nonresident_not_allowed() { }
		~CIFast_IFast_ifastcbo_warn_aip_to_nonresident_not_allowed() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_AIP_TO_NONRESIDENT_NOT_ALLOWED")); }
