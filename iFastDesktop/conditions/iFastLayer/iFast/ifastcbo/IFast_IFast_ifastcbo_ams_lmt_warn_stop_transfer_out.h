...
namespace CND
{
	class CIFast_IFast_ifastcbo_ams_lmt_warn_stop_transfer_out : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_ams_lmt_warn_stop_transfer_out() { }
		~CIFast_IFast_ifastcbo_ams_lmt_warn_stop_transfer_out() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("AMS_LMT_WARN_STOP_TRANSFER_OUT")); }
