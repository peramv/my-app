...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_reset_has_occured : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_reset_has_occured() { }
		~CIFast_IFast_ifastcbo_err_reset_has_occured() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_RESET_HAS_OCCURED")); }
