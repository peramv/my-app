...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_loan_type_for_escrow : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_loan_type_for_escrow() { }
		~CIFast_IFast_ifastcbo_err_loan_type_for_escrow() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_LOAN_TYPE_FOR_ESCROW")); }
