...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_swp_payoption : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_swp_payoption() { }
		~CIFast_IFast_ifastcbo_err_swp_payoption() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_SWP_PAYOPTION")); }
