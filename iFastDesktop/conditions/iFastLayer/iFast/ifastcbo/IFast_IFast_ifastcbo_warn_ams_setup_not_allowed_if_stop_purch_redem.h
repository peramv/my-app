...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_ams_setup_not_allowed_if_stop_purch_redem : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_ams_setup_not_allowed_if_stop_purch_redem() { }
		~CIFast_IFast_ifastcbo_warn_ams_setup_not_allowed_if_stop_purch_redem() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_AMS_SETUP_NOT_ALLOWED_IF_STOP_PURCH_REDEM")); }
