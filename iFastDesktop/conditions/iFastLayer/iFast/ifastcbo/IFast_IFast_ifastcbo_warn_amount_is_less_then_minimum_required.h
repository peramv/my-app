...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_amount_is_less_then_minimum_required : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_amount_is_less_then_minimum_required() { }
		~CIFast_IFast_ifastcbo_warn_amount_is_less_then_minimum_required() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_AMOUNT_IS_LESS_THEN_MINIMUM_REQUIRED")); }
