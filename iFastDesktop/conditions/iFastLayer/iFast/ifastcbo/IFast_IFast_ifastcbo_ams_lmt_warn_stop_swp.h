...
namespace CND
{
	class CIFast_IFast_ifastcbo_ams_lmt_warn_stop_swp : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_ams_lmt_warn_stop_swp() { }
		~CIFast_IFast_ifastcbo_ams_lmt_warn_stop_swp() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("AMS_LMT_WARN_STOP_SWP")); }
