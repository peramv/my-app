...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_fund_class_not_applicable : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_fund_class_not_applicable() { }
		~CIFast_IFast_ifastcbo_warn_fund_class_not_applicable() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_FUND_CLASS_NOT_APPLICABLE")); }
