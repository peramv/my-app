...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_assisted_contribution_amount_more_than_unassisted_amount : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_assisted_contribution_amount_more_than_unassisted_amount() { }
		~CIFast_IFast_ifastcbo_err_assisted_contribution_amount_more_than_unassisted_amount() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_ASSISTED_CONTRIBUTION_AMOUNT_MORE_THAN_UNASSISTED_AMOUNT")); }
