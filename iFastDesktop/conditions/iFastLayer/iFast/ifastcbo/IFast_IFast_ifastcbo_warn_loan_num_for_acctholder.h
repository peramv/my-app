...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_loan_num_for_acctholder : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_loan_num_for_acctholder() { }
		~CIFast_IFast_ifastcbo_warn_loan_num_for_acctholder() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_LOAN_NUM_FOR_ACCTHOLDER")); }
