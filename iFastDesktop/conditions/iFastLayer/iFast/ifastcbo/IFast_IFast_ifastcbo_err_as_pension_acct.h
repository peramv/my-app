...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_as_pension_acct : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_as_pension_acct() { }
		~CIFast_IFast_ifastcbo_err_as_pension_acct() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_AS_PENSION_ACCT")); }
