...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_ns_duplicate_biccode : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_ns_duplicate_biccode() { }
		~CIFast_IFast_ifastcbo_err_ns_duplicate_biccode() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_NS_DUPLICATE_BICCODE")); }
