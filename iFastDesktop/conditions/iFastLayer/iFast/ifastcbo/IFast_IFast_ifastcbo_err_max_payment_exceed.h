...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_max_payment_exceed : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_max_payment_exceed() { }
		~CIFast_IFast_ifastcbo_err_max_payment_exceed() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_MAX_PAYMENT_EXCEED")); }
