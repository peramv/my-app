...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_country_of_exposure_is_required : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_country_of_exposure_is_required() { }
		~CIFast_IFast_ifastcbo_warn_country_of_exposure_is_required() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_COUNTRY_OF_EXPOSURE_IS_REQUIRED")); }
