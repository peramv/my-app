...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_warn_settlement_source_not_for_acct_designation : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_warn_settlement_source_not_for_acct_designation() { }
		~CIFast_IFast_ifastcbo_err_warn_settlement_source_not_for_acct_designation() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_WARN_SETTLEMENT_SOURCE_NOT_FOR_ACCT_DESIGNATION")); }
