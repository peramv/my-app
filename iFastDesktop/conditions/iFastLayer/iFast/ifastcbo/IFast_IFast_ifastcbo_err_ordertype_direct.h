...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_ordertype_direct : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_ordertype_direct() { }
		~CIFast_IFast_ifastcbo_err_ordertype_direct() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_ORDERTYPE_DIRECT")); }
