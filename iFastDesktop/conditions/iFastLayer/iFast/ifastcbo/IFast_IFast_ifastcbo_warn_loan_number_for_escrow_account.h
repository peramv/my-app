...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_loan_number_for_escrow_account : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_loan_number_for_escrow_account() { }
		~CIFast_IFast_ifastcbo_warn_loan_number_for_escrow_account() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_LOAN_NUMBER_FOR_ESCROW_ACCOUNT")); }
