...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_min_two_funds : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_min_two_funds() { }
		~CIFast_IFast_ifastcbo_err_min_two_funds() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_MIN_TWO_FUNDS")); }
