...
namespace CND
{
	class CIFast_IFast_ifastcbo_warn_invalid_broker_for_money_market_wire_orders : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_warn_invalid_broker_for_money_market_wire_orders() { }
		~CIFast_IFast_ifastcbo_warn_invalid_broker_for_money_market_wire_orders() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("WARN_INVALID_BROKER_FOR_MONEY_MARKET_WIRE_ORDERS")); }
