...
namespace CND
{
	class CIFast_IFast_ifastcbo_err_broker_is_not_eligible_for_fund_class : public CConditionObject
	{
	public:
		CIFast_IFast_ifastcbo_err_broker_is_not_eligible_for_fund_class() { }
		~CIFast_IFast_ifastcbo_err_broker_is_not_eligible_for_fund_class() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_BROKER_IS_NOT_ELIGIBLE_FOR_FUND_CLASS")); }
