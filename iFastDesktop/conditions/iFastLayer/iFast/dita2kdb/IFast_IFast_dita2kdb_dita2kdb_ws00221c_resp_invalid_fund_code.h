...
namespace CND
{
	class CIFast_IFast_dita2kdb_dita2kdb_ws00221c_resp_invalid_fund_code : public CConditionObject
	{
	public:
		CIFast_IFast_dita2kdb_dita2kdb_ws00221c_resp_invalid_fund_code() { }
		~CIFast_IFast_dita2kdb_dita2kdb_ws00221c_resp_invalid_fund_code() { }
