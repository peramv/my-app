...
namespace CND
{
	class CIFast_IFast_dita2kdb_dita2kdb_ws00221c_resp_acct_marked_stop_transfer : public CConditionObject
	{
	public:
		CIFast_IFast_dita2kdb_dita2kdb_ws00221c_resp_acct_marked_stop_transfer() { }
		~CIFast_IFast_dita2kdb_dita2kdb_ws00221c_resp_acct_marked_stop_transfer() { }
