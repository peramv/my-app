...
namespace CND
{
	class CIFast_IFast_dita2kdb_dita2kdb_ws00221c_resp_invalid_batch_num : public CConditionObject
	{
	public:
		CIFast_IFast_dita2kdb_dita2kdb_ws00221c_resp_invalid_batch_num() { }
		~CIFast_IFast_dita2kdb_dita2kdb_ws00221c_resp_invalid_batch_num() { }
