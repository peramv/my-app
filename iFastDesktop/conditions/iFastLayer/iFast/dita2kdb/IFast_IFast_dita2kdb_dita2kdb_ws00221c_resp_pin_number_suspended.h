...
namespace CND
{
	class CIFast_IFast_dita2kdb_dita2kdb_ws00221c_resp_pin_number_suspended : public CConditionObject
	{
	public:
		CIFast_IFast_dita2kdb_dita2kdb_ws00221c_resp_pin_number_suspended() { }
		~CIFast_IFast_dita2kdb_dita2kdb_ws00221c_resp_pin_number_suspended() { }
