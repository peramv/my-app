...
namespace CND
{
	class CIFast_IFast_dita2kdb_dita2kdb_ws00221c_resp_invalid_dlr_number : public CConditionObject
	{
	public:
		CIFast_IFast_dita2kdb_dita2kdb_ws00221c_resp_invalid_dlr_number() { }
		~CIFast_IFast_dita2kdb_dita2kdb_ws00221c_resp_invalid_dlr_number() { }
