...
namespace CND
{
	class CIFast_IFast_dita2kdb_dita2kdb_ws00221c_resp_exch_bank_only_from_side : public CConditionObject
	{
	public:
		CIFast_IFast_dita2kdb_dita2kdb_ws00221c_resp_exch_bank_only_from_side() { }
		~CIFast_IFast_dita2kdb_dita2kdb_ws00221c_resp_exch_bank_only_from_side() { }
