...
namespace CND
{
	class CIFast_IFast_dita2kdb_dita2kdb_ws00221c_resp_invalid_min_amt : public CConditionObject
	{
	public:
		CIFast_IFast_dita2kdb_dita2kdb_ws00221c_resp_invalid_min_amt() { }
		~CIFast_IFast_dita2kdb_dita2kdb_ws00221c_resp_invalid_min_amt() { }
