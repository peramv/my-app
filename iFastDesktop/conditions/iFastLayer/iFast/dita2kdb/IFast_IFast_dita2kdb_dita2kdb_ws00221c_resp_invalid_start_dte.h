...
namespace CND
{
	class CIFast_IFast_dita2kdb_dita2kdb_ws00221c_resp_invalid_start_dte : public CConditionObject
	{
	public:
		CIFast_IFast_dita2kdb_dita2kdb_ws00221c_resp_invalid_start_dte() { }
		~CIFast_IFast_dita2kdb_dita2kdb_ws00221c_resp_invalid_start_dte() { }
