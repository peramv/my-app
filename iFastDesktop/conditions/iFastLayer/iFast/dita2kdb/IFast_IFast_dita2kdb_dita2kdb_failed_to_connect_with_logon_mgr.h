...
namespace CND
{
	class CIFast_IFast_dita2kdb_dita2kdb_failed_to_connect_with_logon_mgr : public CConditionObject
	{
	public:
		CIFast_IFast_dita2kdb_dita2kdb_failed_to_connect_with_logon_mgr() { }
		~CIFast_IFast_dita2kdb_dita2kdb_failed_to_connect_with_logon_mgr() { }
