...
namespace CND
{
	class CIFast_IFast_dita2kdb_dita2kdb_ws00221c_resp_copy_purch_atempt_invalid : public CConditionObject
	{
	public:
		CIFast_IFast_dita2kdb_dita2kdb_ws00221c_resp_copy_purch_atempt_invalid() { }
		~CIFast_IFast_dita2kdb_dita2kdb_ws00221c_resp_copy_purch_atempt_invalid() { }
