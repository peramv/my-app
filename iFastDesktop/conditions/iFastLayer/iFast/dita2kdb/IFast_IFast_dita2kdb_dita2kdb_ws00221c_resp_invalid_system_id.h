...
namespace CND
{
	class CIFast_IFast_dita2kdb_dita2kdb_ws00221c_resp_invalid_system_id : public CConditionObject
	{
	public:
		CIFast_IFast_dita2kdb_dita2kdb_ws00221c_resp_invalid_system_id() { }
		~CIFast_IFast_dita2kdb_dita2kdb_ws00221c_resp_invalid_system_id() { }
