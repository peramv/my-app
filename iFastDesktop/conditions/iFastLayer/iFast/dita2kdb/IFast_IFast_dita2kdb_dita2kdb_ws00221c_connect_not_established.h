...
namespace CND
{
	class CIFast_IFast_dita2kdb_dita2kdb_ws00221c_connect_not_established : public CConditionObject
	{
	public:
		CIFast_IFast_dita2kdb_dita2kdb_ws00221c_connect_not_established() { }
		~CIFast_IFast_dita2kdb_dita2kdb_ws00221c_connect_not_established() { }
