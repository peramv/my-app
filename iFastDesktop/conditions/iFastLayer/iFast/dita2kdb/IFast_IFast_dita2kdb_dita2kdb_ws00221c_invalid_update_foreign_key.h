...
namespace CND
{
	class CIFast_IFast_dita2kdb_dita2kdb_ws00221c_invalid_update_foreign_key : public CConditionObject
	{
	public:
		CIFast_IFast_dita2kdb_dita2kdb_ws00221c_invalid_update_foreign_key() { }
		~CIFast_IFast_dita2kdb_dita2kdb_ws00221c_invalid_update_foreign_key() { }
