...
namespace CND
{
	class CIFast_IFast_dita2kdb_dita2kdb_ws00221c_connect_auth_failure : public CConditionObject
	{
	public:
		CIFast_IFast_dita2kdb_dita2kdb_ws00221c_connect_auth_failure() { }
		~CIFast_IFast_dita2kdb_dita2kdb_ws00221c_connect_auth_failure() { }
