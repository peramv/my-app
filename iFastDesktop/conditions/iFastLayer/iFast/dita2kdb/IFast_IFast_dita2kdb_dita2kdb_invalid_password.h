...
namespace CND
{
	class CIFast_IFast_dita2kdb_dita2kdb_invalid_password : public CConditionObject
	{
	public:
		CIFast_IFast_dita2kdb_dita2kdb_invalid_password() { }
		~CIFast_IFast_dita2kdb_dita2kdb_invalid_password() { }
	...
	public:
		...
		virtual DString GetMessage_DE_DE() const { return DString(I_("Es gibt ein internes Problem. Eine unbekannte Ausnahme ist aufgetreten.")); }
