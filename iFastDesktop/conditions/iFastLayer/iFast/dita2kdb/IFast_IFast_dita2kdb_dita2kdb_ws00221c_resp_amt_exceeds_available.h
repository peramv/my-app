...
namespace CND
{
	class CIFast_IFast_dita2kdb_dita2kdb_ws00221c_resp_amt_exceeds_available : public CConditionObject
	{
	public:
		CIFast_IFast_dita2kdb_dita2kdb_ws00221c_resp_amt_exceeds_available() { }
		~CIFast_IFast_dita2kdb_dita2kdb_ws00221c_resp_amt_exceeds_available() { }
