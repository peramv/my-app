...
namespace CND
{
	class CIFast_IFast_dita2kdb_dita2kdb_ws00221c_resp_return_info_unavail : public CConditionObject
	{
	public:
		CIFast_IFast_dita2kdb_dita2kdb_ws00221c_resp_return_info_unavail() { }
		~CIFast_IFast_dita2kdb_dita2kdb_ws00221c_resp_return_info_unavail() { }
