...
namespace CND
{
	class CIFast_IFast_dita2kdb_dita2kdb_ws00221c_resp_invalid_num_abbrev_st : public CConditionObject
	{
	public:
		CIFast_IFast_dita2kdb_dita2kdb_ws00221c_resp_invalid_num_abbrev_st() { }
		~CIFast_IFast_dita2kdb_dita2kdb_ws00221c_resp_invalid_num_abbrev_st() { }
