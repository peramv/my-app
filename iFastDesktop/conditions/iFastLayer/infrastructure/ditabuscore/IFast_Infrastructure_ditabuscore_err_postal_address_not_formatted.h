...
namespace CND
{
	class CIFast_Infrastructure_ditabuscore_err_postal_address_not_formatted : public CConditionObject
	{
	public:
		CIFast_Infrastructure_ditabuscore_err_postal_address_not_formatted() { }
		~CIFast_Infrastructure_ditabuscore_err_postal_address_not_formatted() { }
