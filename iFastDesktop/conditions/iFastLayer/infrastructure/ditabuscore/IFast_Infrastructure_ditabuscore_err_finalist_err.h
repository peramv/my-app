...
namespace CND
{
	class CIFast_Infrastructure_ditabuscore_err_finalist_err : public CConditionObject
	{
	public:
		CIFast_Infrastructure_ditabuscore_err_finalist_err() { }
		~CIFast_Infrastructure_ditabuscore_err_finalist_err() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_FINALIST_ERR")); }
