...
namespace CND
{
	class CIFast_Infrastructure_dita2kdb_dita2kdb_ws00221c_resp_error_in_binary_search : public CConditionObject
	{
	public:
		CIFast_Infrastructure_dita2kdb_dita2kdb_ws00221c_resp_error_in_binary_search() { }
		~CIFast_Infrastructure_dita2kdb_dita2kdb_ws00221c_resp_error_in_binary_search() { }
