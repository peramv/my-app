...
namespace CND
{
	class CIFast_Infrastructure_dita2kdb_dita2kdb_ws00221c_rewrite_without_open_for_io : public CConditionObject
	{
	public:
		CIFast_Infrastructure_dita2kdb_dita2kdb_ws00221c_rewrite_without_open_for_io() { }
		~CIFast_Infrastructure_dita2kdb_dita2kdb_ws00221c_rewrite_without_open_for_io() { }
