...
namespace CND
{
	class CIFast_Infrastructure_dita2kdb_dita2kdb_invalid_exch_pur_canc : public CConditionObject
	{
	public:
		CIFast_Infrastructure_dita2kdb_dita2kdb_invalid_exch_pur_canc() { }
		~CIFast_Infrastructure_dita2kdb_dita2kdb_invalid_exch_pur_canc() { }
