...
namespace CND
{
	class CIFast_Infrastructure_dita2kdb_dita2kdb_invalid_res_state_code : public CConditionObject
	{
	public:
		CIFast_Infrastructure_dita2kdb_dita2kdb_invalid_res_state_code() { }
		~CIFast_Infrastructure_dita2kdb_dita2kdb_invalid_res_state_code() { }
