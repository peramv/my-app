...
namespace CND
{
	class CIFast_Infrastructure_dita2kdb_dita2kdb_ws00221c_deadlock_rolled_bck : public CConditionObject
	{
	public:
		CIFast_Infrastructure_dita2kdb_dita2kdb_ws00221c_deadlock_rolled_bck() { }
		~CIFast_Infrastructure_dita2kdb_dita2kdb_ws00221c_deadlock_rolled_bck() { }
