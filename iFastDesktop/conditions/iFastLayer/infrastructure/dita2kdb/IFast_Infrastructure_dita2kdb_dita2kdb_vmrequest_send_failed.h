...
namespace CND
{
	class CIFast_Infrastructure_dita2kdb_dita2kdb_vmrequest_send_failed : public CConditionObject
	{
	public:
		CIFast_Infrastructure_dita2kdb_dita2kdb_vmrequest_send_failed() { }
		~CIFast_Infrastructure_dita2kdb_dita2kdb_vmrequest_send_failed() { }
