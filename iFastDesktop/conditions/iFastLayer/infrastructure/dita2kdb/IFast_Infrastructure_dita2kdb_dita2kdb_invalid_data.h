...
namespace CND
{
	class CIFast_Infrastructure_dita2kdb_dita2kdb_invalid_data : public CConditionObject
	{
	public:
		CIFast_Infrastructure_dita2kdb_dita2kdb_invalid_data() { }
		~CIFast_Infrastructure_dita2kdb_dita2kdb_invalid_data() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("DITA2KDB_INVALID_DATA")); }
