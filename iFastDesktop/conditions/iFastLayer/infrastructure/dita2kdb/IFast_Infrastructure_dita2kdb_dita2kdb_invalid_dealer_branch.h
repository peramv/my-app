...
namespace CND
{
	class CIFast_Infrastructure_dita2kdb_dita2kdb_invalid_dealer_branch : public CConditionObject
	{
	public:
		CIFast_Infrastructure_dita2kdb_dita2kdb_invalid_dealer_branch() { }
		~CIFast_Infrastructure_dita2kdb_dita2kdb_invalid_dealer_branch() { }
