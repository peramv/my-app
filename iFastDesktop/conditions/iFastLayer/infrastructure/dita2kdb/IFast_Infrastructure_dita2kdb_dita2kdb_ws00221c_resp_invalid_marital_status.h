...
namespace CND
{
	class CIFast_Infrastructure_dita2kdb_dita2kdb_ws00221c_resp_invalid_marital_status : public CConditionObject
	{
	public:
		CIFast_Infrastructure_dita2kdb_dita2kdb_ws00221c_resp_invalid_marital_status() { }
		~CIFast_Infrastructure_dita2kdb_dita2kdb_ws00221c_resp_invalid_marital_status() { }
