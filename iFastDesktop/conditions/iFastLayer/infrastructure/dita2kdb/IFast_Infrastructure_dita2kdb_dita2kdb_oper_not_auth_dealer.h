...
namespace CND
{
	class CIFast_Infrastructure_dita2kdb_dita2kdb_oper_not_auth_dealer : public CConditionObject
	{
	public:
		CIFast_Infrastructure_dita2kdb_dita2kdb_oper_not_auth_dealer() { }
		~CIFast_Infrastructure_dita2kdb_dita2kdb_oper_not_auth_dealer() { }
