...
namespace CND
{
	class CIFast_Infrastructure_dita2kdb_dita2kdb_invalid_purch_cancel : public CConditionObject
	{
	public:
		CIFast_Infrastructure_dita2kdb_dita2kdb_invalid_purch_cancel() { }
		~CIFast_Infrastructure_dita2kdb_dita2kdb_invalid_purch_cancel() { }
