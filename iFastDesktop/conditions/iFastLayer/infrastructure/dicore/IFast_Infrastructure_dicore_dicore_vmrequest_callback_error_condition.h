...
namespace CND
{
	class CIFast_Infrastructure_dicore_dicore_vmrequest_callback_error_condition : public CConditionObject
	{
	public:
		CIFast_Infrastructure_dicore_dicore_vmrequest_callback_error_condition() { }
		~CIFast_Infrastructure_dicore_dicore_vmrequest_callback_error_condition() { }
