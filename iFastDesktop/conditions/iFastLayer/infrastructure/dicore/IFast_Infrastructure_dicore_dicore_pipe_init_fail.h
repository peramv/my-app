...
namespace CND
{
	class CIFast_Infrastructure_dicore_dicore_pipe_init_fail : public CConditionObject
	{
	public:
		CIFast_Infrastructure_dicore_dicore_pipe_init_fail() { }
		~CIFast_Infrastructure_dicore_dicore_pipe_init_fail() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("DICORE_PIPE_INIT_FAIL")); }
