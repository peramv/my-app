...
namespace CND
{
	class CIFast_Infrastructure_dicore_dicore_mutexsem_open_fail : public CConditionObject
	{
	public:
		CIFast_Infrastructure_dicore_dicore_mutexsem_open_fail() { }
		~CIFast_Infrastructure_dicore_dicore_mutexsem_open_fail() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("DICORE_MUTEXSEM_OPEN_FAIL")); }
