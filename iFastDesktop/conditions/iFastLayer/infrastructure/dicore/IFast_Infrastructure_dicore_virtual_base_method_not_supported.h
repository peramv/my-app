...
namespace CND
{
	class CIFast_Infrastructure_dicore_virtual_base_method_not_supported : public CConditionObject
	{
	public:
		CIFast_Infrastructure_dicore_virtual_base_method_not_supported() { }
		~CIFast_Infrastructure_dicore_virtual_base_method_not_supported() { }
