...
namespace CND
{
	class CIFast_Infrastructure_ifastdbrkr_err_pd_cannot_change_passord_for : public CConditionObject
	{
	public:
		CIFast_Infrastructure_ifastdbrkr_err_pd_cannot_change_passord_for() { }
		~CIFast_Infrastructure_ifastdbrkr_err_pd_cannot_change_passord_for() { }
