...
namespace CND
{
	class CIFast_Infrastructure_ifastdbrkr_err_ad_maximum_sessions_already_running : public CConditionObject
	{
	public:
		CIFast_Infrastructure_ifastdbrkr_err_ad_maximum_sessions_already_running() { }
		~CIFast_Infrastructure_ifastdbrkr_err_ad_maximum_sessions_already_running() { }
