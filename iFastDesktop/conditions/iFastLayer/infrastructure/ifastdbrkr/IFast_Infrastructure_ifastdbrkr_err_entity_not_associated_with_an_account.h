...
namespace CND
{
	class CIFast_Infrastructure_ifastdbrkr_err_entity_not_associated_with_an_account : public CConditionObject
	{
	public:
		CIFast_Infrastructure_ifastdbrkr_err_entity_not_associated_with_an_account() { }
		~CIFast_Infrastructure_ifastdbrkr_err_entity_not_associated_with_an_account() { }
