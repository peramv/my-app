...
namespace CND
{
	class CIFast_Infrastructure_ifastdbrkr_err_unknown_account : public CConditionObject
	{
	public:
		CIFast_Infrastructure_ifastdbrkr_err_unknown_account() { }
		~CIFast_Infrastructure_ifastdbrkr_err_unknown_account() { }
	...
	public:
		...
		virtual DString GetAction_ES_ES() const { return DString(I_("Verify data entered.")); }
