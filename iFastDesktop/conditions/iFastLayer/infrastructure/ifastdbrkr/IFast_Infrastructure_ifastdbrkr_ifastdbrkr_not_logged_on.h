...
namespace CND
{
	class CIFast_Infrastructure_ifastdbrkr_ifastdbrkr_not_logged_on : public CConditionObject
	{
	public:
		CIFast_Infrastructure_ifastdbrkr_ifastdbrkr_not_logged_on() { }
		~CIFast_Infrastructure_ifastdbrkr_ifastdbrkr_not_logged_on() { }
	...
	public:
		...
		virtual DString GetAction_ES_ES() const { return DString(I_("Verify certificate number and re-enter.")); }
