...
namespace CND
{
	class CIFast_Infrastructure_ifastdbrkr_err_pd_password_must_be_at_least : public CConditionObject
	{
	public:
		CIFast_Infrastructure_ifastdbrkr_err_pd_password_must_be_at_least() { }
		~CIFast_Infrastructure_ifastdbrkr_err_pd_password_must_be_at_least() { }
