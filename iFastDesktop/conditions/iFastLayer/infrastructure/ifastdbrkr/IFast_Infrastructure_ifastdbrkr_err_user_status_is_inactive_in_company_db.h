...
namespace CND
{
	class CIFast_Infrastructure_ifastdbrkr_err_user_status_is_inactive_in_company_db : public CConditionObject
	{
	public:
		CIFast_Infrastructure_ifastdbrkr_err_user_status_is_inactive_in_company_db() { }
		~CIFast_Infrastructure_ifastdbrkr_err_user_status_is_inactive_in_company_db() { }
