...
namespace CND
{
	class CIFast_Infrastructure_ifastdbrkr_err_ad_user_has_no_company_access : public CConditionObject
	{
	public:
		CIFast_Infrastructure_ifastdbrkr_err_ad_user_has_no_company_access() { }
		~CIFast_Infrastructure_ifastdbrkr_err_ad_user_has_no_company_access() { }
