...
namespace CND
{
	class CIFast_Infrastructure_ifastdbrkr_err_account_entity_not_found : public CConditionObject
	{
	public:
		CIFast_Infrastructure_ifastdbrkr_err_account_entity_not_found() { }
		~CIFast_Infrastructure_ifastdbrkr_err_account_entity_not_found() { }
