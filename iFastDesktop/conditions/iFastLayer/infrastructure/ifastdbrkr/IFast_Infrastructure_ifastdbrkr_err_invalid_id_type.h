...
namespace CND
{
	class CIFast_Infrastructure_ifastdbrkr_err_invalid_id_type : public CConditionObject
	{
	public:
		CIFast_Infrastructure_ifastdbrkr_err_invalid_id_type() { }
		~CIFast_Infrastructure_ifastdbrkr_err_invalid_id_type() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_INVALID_ID_TYPE")); }
