...
namespace CND
{
	class CIFast_Infrastructure_ifastdbrkr_err_registered_address_default_not_found : public CConditionObject
	{
	public:
		CIFast_Infrastructure_ifastdbrkr_err_registered_address_default_not_found() { }
		~CIFast_Infrastructure_ifastdbrkr_err_registered_address_default_not_found() { }
