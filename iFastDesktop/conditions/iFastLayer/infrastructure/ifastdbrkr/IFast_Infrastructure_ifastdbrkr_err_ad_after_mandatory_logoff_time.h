...
namespace CND
{
	class CIFast_Infrastructure_ifastdbrkr_err_ad_after_mandatory_logoff_time : public CConditionObject
	{
	public:
		CIFast_Infrastructure_ifastdbrkr_err_ad_after_mandatory_logoff_time() { }
		~CIFast_Infrastructure_ifastdbrkr_err_ad_after_mandatory_logoff_time() { }
