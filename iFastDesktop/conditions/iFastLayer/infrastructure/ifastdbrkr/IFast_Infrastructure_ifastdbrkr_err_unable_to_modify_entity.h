...
namespace CND
{
	class CIFast_Infrastructure_ifastdbrkr_err_unable_to_modify_entity : public CConditionObject
	{
	public:
		CIFast_Infrastructure_ifastdbrkr_err_unable_to_modify_entity() { }
		~CIFast_Infrastructure_ifastdbrkr_err_unable_to_modify_entity() { }
