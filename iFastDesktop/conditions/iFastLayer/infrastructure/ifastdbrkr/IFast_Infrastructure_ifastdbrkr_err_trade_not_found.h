...
namespace CND
{
	class CIFast_Infrastructure_ifastdbrkr_err_trade_not_found : public CConditionObject
	{
	public:
		CIFast_Infrastructure_ifastdbrkr_err_trade_not_found() { }
		~CIFast_Infrastructure_ifastdbrkr_err_trade_not_found() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_TRADE_NOT_FOUND")); }
