...
namespace CND
{
	class CIFast_Infrastructure_ifastcbo_err_order_src_invalid_for_wire_order : public CConditionObject
	{
	public:
		CIFast_Infrastructure_ifastcbo_err_order_src_invalid_for_wire_order() { }
		~CIFast_Infrastructure_ifastcbo_err_order_src_invalid_for_wire_order() { }
