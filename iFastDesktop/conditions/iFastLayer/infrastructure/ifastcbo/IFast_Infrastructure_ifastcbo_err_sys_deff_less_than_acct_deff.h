...
namespace CND
{
	class CIFast_Infrastructure_ifastcbo_err_sys_deff_less_than_acct_deff : public CConditionObject
	{
	public:
		CIFast_Infrastructure_ifastcbo_err_sys_deff_less_than_acct_deff() { }
		~CIFast_Infrastructure_ifastcbo_err_sys_deff_less_than_acct_deff() { }
