...
namespace CND
{
	class CIFast_Infrastructure_ifastcbo_err_invalid_negative_amount : public CConditionObject
	{
	public:
		CIFast_Infrastructure_ifastcbo_err_invalid_negative_amount() { }
		~CIFast_Infrastructure_ifastcbo_err_invalid_negative_amount() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_INVALID_NEGATIVE_AMOUNT")); }
