...
namespace CND
{
	class CIFast_Infrastructure_ifastcbo_err_invalid_amttype_for_purchase : public CConditionObject
	{
	public:
		CIFast_Infrastructure_ifastcbo_err_invalid_amttype_for_purchase() { }
		~CIFast_Infrastructure_ifastcbo_err_invalid_amttype_for_purchase() { }
