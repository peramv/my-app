...
namespace CND
{
	class CIFast_Infrastructure_ifastcbo_err_at_has_stopped_transfer_or_exch : public CConditionObject
	{
	public:
		CIFast_Infrastructure_ifastcbo_err_at_has_stopped_transfer_or_exch() { }
		~CIFast_Infrastructure_ifastcbo_err_at_has_stopped_transfer_or_exch() { }
