...
namespace CND
{
	class CIFast_Infrastructure_ifastcbo_err_at_has_stopped_transfer_in : public CConditionObject
	{
	public:
		CIFast_Infrastructure_ifastcbo_err_at_has_stopped_transfer_in() { }
		~CIFast_Infrastructure_ifastcbo_err_at_has_stopped_transfer_in() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_AT_HAS_STOPPED_TRANSFER_IN")); }
