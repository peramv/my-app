...
namespace CND
{
	class CIFast_Infrastructure_ifastcbo_err_order_src_must_be_i_for_intermediary : public CConditionObject
	{
	public:
		CIFast_Infrastructure_ifastcbo_err_order_src_must_be_i_for_intermediary() { }
		~CIFast_Infrastructure_ifastcbo_err_order_src_must_be_i_for_intermediary() { }
