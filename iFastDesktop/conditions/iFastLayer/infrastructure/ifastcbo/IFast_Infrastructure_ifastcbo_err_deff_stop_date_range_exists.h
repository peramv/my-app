...
namespace CND
{
	class CIFast_Infrastructure_ifastcbo_err_deff_stop_date_range_exists : public CConditionObject
	{
	public:
		CIFast_Infrastructure_ifastcbo_err_deff_stop_date_range_exists() { }
		~CIFast_Infrastructure_ifastcbo_err_deff_stop_date_range_exists() { }
