...
namespace CND
{
	class CIFast_Infrastructure_ifastcbo_err_no_value_for_id : public CConditionObject
	{
	public:
		CIFast_Infrastructure_ifastcbo_err_no_value_for_id() { }
		~CIFast_Infrastructure_ifastcbo_err_no_value_for_id() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_NO_VALUE_FOR_ID")); }
