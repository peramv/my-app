...
namespace CND
{
	class CIFast_Infrastructure_ifastcbo_err_instcode_not_exist : public CConditionObject
	{
	public:
		CIFast_Infrastructure_ifastcbo_err_instcode_not_exist() { }
		~CIFast_Infrastructure_ifastcbo_err_instcode_not_exist() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_INSTCODE_NOT_EXIST")); }
