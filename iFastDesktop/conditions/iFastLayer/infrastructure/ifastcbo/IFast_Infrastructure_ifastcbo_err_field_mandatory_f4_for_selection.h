...
namespace CND
{
	class CIFast_Infrastructure_ifastcbo_err_field_mandatory_f4_for_selection : public CConditionObject
	{
	public:
		CIFast_Infrastructure_ifastcbo_err_field_mandatory_f4_for_selection() { }
		~CIFast_Infrastructure_ifastcbo_err_field_mandatory_f4_for_selection() { }
