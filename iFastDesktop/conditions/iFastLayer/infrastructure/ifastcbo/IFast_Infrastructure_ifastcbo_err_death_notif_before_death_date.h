...
namespace CND
{
	class CIFast_Infrastructure_ifastcbo_err_death_notif_before_death_date : public CConditionObject
	{
	public:
		CIFast_Infrastructure_ifastcbo_err_death_notif_before_death_date() { }
		~CIFast_Infrastructure_ifastcbo_err_death_notif_before_death_date() { }
