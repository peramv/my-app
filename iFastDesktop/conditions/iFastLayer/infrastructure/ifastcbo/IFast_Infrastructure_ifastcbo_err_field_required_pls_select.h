...
namespace CND
{
	class CIFast_Infrastructure_ifastcbo_err_field_required_pls_select : public CConditionObject
	{
	public:
		CIFast_Infrastructure_ifastcbo_err_field_required_pls_select() { }
		~CIFast_Infrastructure_ifastcbo_err_field_required_pls_select() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_FIELD_REQUIRED_PLS_SELECT")); }
