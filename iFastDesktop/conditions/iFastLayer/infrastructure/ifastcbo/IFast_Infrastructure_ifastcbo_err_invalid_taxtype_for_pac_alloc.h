...
namespace CND
{
	class CIFast_Infrastructure_ifastcbo_err_invalid_taxtype_for_pac_alloc : public CConditionObject
	{
	public:
		CIFast_Infrastructure_ifastcbo_err_invalid_taxtype_for_pac_alloc() { }
		~CIFast_Infrastructure_ifastcbo_err_invalid_taxtype_for_pac_alloc() { }
