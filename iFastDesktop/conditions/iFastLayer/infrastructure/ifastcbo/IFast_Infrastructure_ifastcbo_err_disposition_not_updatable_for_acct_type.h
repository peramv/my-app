...
namespace CND
{
	class CIFast_Infrastructure_ifastcbo_err_disposition_not_updatable_for_acct_type : public CConditionObject
	{
	public:
		CIFast_Infrastructure_ifastcbo_err_disposition_not_updatable_for_acct_type() { }
		~CIFast_Infrastructure_ifastcbo_err_disposition_not_updatable_for_acct_type() { }
