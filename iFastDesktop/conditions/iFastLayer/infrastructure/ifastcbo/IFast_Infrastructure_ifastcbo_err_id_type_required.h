...
namespace CND
{
	class CIFast_Infrastructure_ifastcbo_err_id_type_required : public CConditionObject
	{
	public:
		CIFast_Infrastructure_ifastcbo_err_id_type_required() { }
		~CIFast_Infrastructure_ifastcbo_err_id_type_required() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_ID_TYPE_REQUIRED")); }
