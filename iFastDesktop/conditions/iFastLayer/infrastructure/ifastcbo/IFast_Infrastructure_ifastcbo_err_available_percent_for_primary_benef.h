...
namespace CND
{
	class CIFast_Infrastructure_ifastcbo_err_available_percent_for_primary_benef : public CConditionObject
	{
	public:
		CIFast_Infrastructure_ifastcbo_err_available_percent_for_primary_benef() { }
		~CIFast_Infrastructure_ifastcbo_err_available_percent_for_primary_benef() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_AVAILABLE_PERCENT_FOR_PRIMARY_BENEF")); }
