...
namespace CND
{
	class CIFast_Infrastructure_ifastcbo_err_secondary_benef_percent_should_add_up_to_100 : public CConditionObject
	{
	public:
		CIFast_Infrastructure_ifastcbo_err_secondary_benef_percent_should_add_up_to_100() { }
		~CIFast_Infrastructure_ifastcbo_err_secondary_benef_percent_should_add_up_to_100() { }
