...
namespace CND
{
	class CIFast_Infrastructure_ifastcbo_err_bankinfo_required : public CConditionObject
	{
	public:
		CIFast_Infrastructure_ifastcbo_err_bankinfo_required() { }
		~CIFast_Infrastructure_ifastcbo_err_bankinfo_required() { }
	...
	public:
		...
		virtual DString GetAction_ES_ES() const { return DString(I_("check the date string format and make sure that HostMasks is defined in the registry under DICORE")); }
