...
namespace CND
{
	class CIFast_Infrastructure_ifastcbo_err_duplicate_address_code : public CConditionObject
	{
	public:
		CIFast_Infrastructure_ifastcbo_err_duplicate_address_code() { }
		~CIFast_Infrastructure_ifastcbo_err_duplicate_address_code() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_DUPLICATE_ADDRESS_CODE")); }
