...
namespace CND
{
	class CIFast_Infrastructure_didbrkr_didbrkr_redefine_length_mismatch : public CConditionObject
	{
	public:
		CIFast_Infrastructure_didbrkr_didbrkr_redefine_length_mismatch() { }
		~CIFast_Infrastructure_didbrkr_didbrkr_redefine_length_mismatch() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("DIDBRKR_REDEFINE_LENGTH_MISMATCH")); }
