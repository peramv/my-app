...
namespace CND
{
	class CIFast_Infrastructure_dicbocore_err_no_additional_repeat_records : public CConditionObject
	{
	public:
		CIFast_Infrastructure_dicbocore_err_no_additional_repeat_records() { }
		~CIFast_Infrastructure_dicbocore_err_no_additional_repeat_records() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_NO_ADDITIONAL_REPEAT_RECORDS")); }
