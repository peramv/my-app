...
namespace CND
{
	class CIFast_Infrastructure_dicbocore_err_field_group_not_found : public CConditionObject
	{
	public:
		CIFast_Infrastructure_dicbocore_err_field_group_not_found() { }
		~CIFast_Infrastructure_dicbocore_err_field_group_not_found() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_FIELD_GROUP_NOT_FOUND")); }
