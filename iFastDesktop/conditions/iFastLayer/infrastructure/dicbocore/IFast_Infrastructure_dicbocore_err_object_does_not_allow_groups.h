...
namespace CND
{
	class CIFast_Infrastructure_dicbocore_err_object_does_not_allow_groups : public CConditionObject
	{
	public:
		CIFast_Infrastructure_dicbocore_err_object_does_not_allow_groups() { }
		~CIFast_Infrastructure_dicbocore_err_object_does_not_allow_groups() { }
