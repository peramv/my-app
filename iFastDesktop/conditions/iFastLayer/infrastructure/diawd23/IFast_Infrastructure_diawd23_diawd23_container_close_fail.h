...
namespace CND
{
	class CIFast_Infrastructure_diawd23_diawd23_container_close_fail : public CConditionObject
	{
	public:
		CIFast_Infrastructure_diawd23_diawd23_container_close_fail() { }
		~CIFast_Infrastructure_diawd23_diawd23_container_close_fail() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("DIAWD23_CONTAINER_CLOSE_FAIL")); }
