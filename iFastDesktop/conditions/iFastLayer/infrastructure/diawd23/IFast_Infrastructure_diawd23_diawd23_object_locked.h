...
namespace CND
{
	class CIFast_Infrastructure_diawd23_diawd23_object_locked : public CConditionObject
	{
	public:
		CIFast_Infrastructure_diawd23_diawd23_object_locked() { }
		~CIFast_Infrastructure_diawd23_diawd23_object_locked() { }
	...
	public:
		...
		virtual DString GetAction_ES_ES() const { return DString(I_("Intente acceder a esta tarea más tarde.")); }
