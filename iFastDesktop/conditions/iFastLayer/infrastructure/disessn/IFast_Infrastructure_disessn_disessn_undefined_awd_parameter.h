...
namespace CND
{
	class CIFast_Infrastructure_disessn_disessn_undefined_awd_parameter : public CConditionObject
	{
	public:
		CIFast_Infrastructure_disessn_disessn_undefined_awd_parameter() { }
		~CIFast_Infrastructure_disessn_disessn_undefined_awd_parameter() { }
