...
namespace CND
{
	class CBase_Ifds_dita2kdb_dita2kdb_invalid_trans_num : public CConditionObject
	{
	public:
		CBase_Ifds_dita2kdb_dita2kdb_invalid_trans_num() { }
		~CBase_Ifds_dita2kdb_dita2kdb_invalid_trans_num() { }
	...
	public:
		...
		virtual DString GetMessage_FR_FR() const { return DString(I_("There is an internal problem.  An unknown exception was caught.")); }
