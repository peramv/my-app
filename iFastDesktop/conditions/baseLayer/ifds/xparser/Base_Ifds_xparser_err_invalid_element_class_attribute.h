...
namespace CND
{
	class CBase_Ifds_xparser_err_invalid_element_class_attribute : public CConditionObject
	{
	public:
		CBase_Ifds_xparser_err_invalid_element_class_attribute() { }
		~CBase_Ifds_xparser_err_invalid_element_class_attribute() { }
	...
	public:
		...
		// Messages
		virtual DString GetMessage_EN_US() const { return DString(I_("Invalid Request: Class Attribute may not have a value of %VALUE%.")); }
		...
		virtual DString GetMessage_ES_ES() const { return DString(I_("Invalid Request: Class Attribute may not have a value of %VALUE%.")); }
		virtual DString GetMessage_FR_CA() const { return DString(I_("Requête invalide : l'attribut de classe pourrait n'avoir aucune valeur de %VALUE%.")); }
		virtual DString GetMessage_NL_NL() const { return DString(I_("Invalid Request: Class Attribute may not have a value of %VALUE%.")); }
