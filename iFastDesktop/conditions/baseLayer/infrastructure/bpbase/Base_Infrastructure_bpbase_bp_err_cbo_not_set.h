...
namespace CND
{
	class CBase_Infrastructure_bpbase_bp_err_cbo_not_set : public CConditionObject
	{
	public:
		CBase_Infrastructure_bpbase_bp_err_cbo_not_set() { }
		~CBase_Infrastructure_bpbase_bp_err_cbo_not_set() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("BP_ERR_CBO_NOT_SET")); }
		...
		virtual DString GetMessage_DE_DE() const { return DString(I_("Es gibt ein internes Problem. Diese Ansicht ist ungültig.")); }
		...
		virtual DString GetMessage_NL_NL() const { return DString(I_("Er is een intern probleem. Deze view is ongeldig")); }
