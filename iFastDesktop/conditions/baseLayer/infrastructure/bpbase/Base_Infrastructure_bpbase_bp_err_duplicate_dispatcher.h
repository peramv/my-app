...
namespace CND
{
	class CBase_Infrastructure_bpbase_bp_err_duplicate_dispatcher : public CConditionObject
	{
	public:
		CBase_Infrastructure_bpbase_bp_err_duplicate_dispatcher() { }
		~CBase_Infrastructure_bpbase_bp_err_duplicate_dispatcher() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("BP_ERR_DUPLICATE_DISPATCHER")); }
