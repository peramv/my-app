...
namespace CND
{
	class CBase_Infrastructure_diawd23_diawd23_container_open_fail : public CConditionObject
	{
	public:
		CBase_Infrastructure_diawd23_diawd23_container_open_fail() { }
		~CBase_Infrastructure_diawd23_diawd23_container_open_fail() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("DIAWD23_CONTAINER_OPEN_FAIL")); }
		virtual DString GetGroupName() const { return DString(I_("Infrastructure")); }
		virtual DString GetModuleName() const { return DString(I_("diawd23")); }
		virtual int GetSeverity() const { return 7; }

		// Messages
		virtual DString GetMessage_EN_US() const { return DString(I_("There is an internal problem.\n\nAWD container failed to open.")); }
