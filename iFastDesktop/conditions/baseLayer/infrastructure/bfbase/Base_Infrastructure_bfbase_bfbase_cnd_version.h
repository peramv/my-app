...
namespace CND
{
	class CBase_Infrastructure_bfbase_bfbase_cnd_version : public CConditionObject
	{
	public:
		CBase_Infrastructure_bfbase_bfbase_cnd_version() { }
		~CBase_Infrastructure_bfbase_bfbase_cnd_version() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("BFBASE_CND_VERSION")); }
		...
		virtual DString GetAction_ES_ES() const { return DString(I_("Notifique lo siguiente a un representante de soporte técnico: verifique el archivo iwsholid.dat del sistema.")); }
