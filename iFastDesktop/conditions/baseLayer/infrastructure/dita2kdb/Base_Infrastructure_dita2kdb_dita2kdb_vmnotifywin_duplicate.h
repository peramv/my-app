...
namespace CND
{
	class CBase_Infrastructure_dita2kdb_dita2kdb_vmnotifywin_duplicate : public CConditionObject
	{
	public:
		CBase_Infrastructure_dita2kdb_dita2kdb_vmnotifywin_duplicate() { }
		~CBase_Infrastructure_dita2kdb_dita2kdb_vmnotifywin_duplicate() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("DITA2KDB_VMNOTIFYWIN_DUPLICATE")); }
