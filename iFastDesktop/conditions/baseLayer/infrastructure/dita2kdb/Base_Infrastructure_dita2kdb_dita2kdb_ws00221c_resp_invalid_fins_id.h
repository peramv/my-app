...
namespace CND
{
	class CBase_Infrastructure_dita2kdb_dita2kdb_ws00221c_resp_invalid_fins_id : public CConditionObject
	{
	public:
		CBase_Infrastructure_dita2kdb_dita2kdb_ws00221c_resp_invalid_fins_id() { }
		~CBase_Infrastructure_dita2kdb_dita2kdb_ws00221c_resp_invalid_fins_id() { }
