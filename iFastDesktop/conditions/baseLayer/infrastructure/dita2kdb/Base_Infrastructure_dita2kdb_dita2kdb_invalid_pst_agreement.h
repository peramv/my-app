...
namespace CND
{
	class CBase_Infrastructure_dita2kdb_dita2kdb_invalid_pst_agreement : public CConditionObject
	{
	public:
		CBase_Infrastructure_dita2kdb_dita2kdb_invalid_pst_agreement() { }
		~CBase_Infrastructure_dita2kdb_dita2kdb_invalid_pst_agreement() { }
