...
namespace CND
{
	class CBase_Infrastructure_dita2kdb_dita2kdb_invalid_monthly_accum : public CConditionObject
	{
	public:
		CBase_Infrastructure_dita2kdb_dita2kdb_invalid_monthly_accum() { }
		~CBase_Infrastructure_dita2kdb_dita2kdb_invalid_monthly_accum() { }
