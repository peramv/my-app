...
namespace CND
{
	class CBase_Infrastructure_dicbocore_err_key_not_found : public CConditionObject
	{
	public:
		CBase_Infrastructure_dicbocore_err_key_not_found() { }
		~CBase_Infrastructure_dicbocore_err_key_not_found() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_KEY_NOT_FOUND")); }
