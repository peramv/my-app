...
namespace CND
{
	class CBase_Infrastructure_dicbocore_err_field_checkpoint_not_available : public CConditionObject
	{
	public:
		CBase_Infrastructure_dicbocore_err_field_checkpoint_not_available() { }
		~CBase_Infrastructure_dicbocore_err_field_checkpoint_not_available() { }
