...
namespace CND
{
	class CBase_Infrastructure_dicore_dicore_mutexsem_release_fail : public CConditionObject
	{
	public:
		CBase_Infrastructure_dicore_dicore_mutexsem_release_fail() { }
		~CBase_Infrastructure_dicore_dicore_mutexsem_release_fail() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("DICORE_MUTEXSEM_RELEASE_FAIL")); }
