...
namespace CND
{
	class CBase_Infrastructure_dicore_dicore_mutexsem_create_fail : public CConditionObject
	{
	public:
		CBase_Infrastructure_dicore_dicore_mutexsem_create_fail() { }
		~CBase_Infrastructure_dicore_dicore_mutexsem_create_fail() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("DICORE_MUTEXSEM_CREATE_FAIL")); }
