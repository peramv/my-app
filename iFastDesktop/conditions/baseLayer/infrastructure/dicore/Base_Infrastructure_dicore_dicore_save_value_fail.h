...
namespace CND
{
	class CBase_Infrastructure_dicore_dicore_save_value_fail : public CConditionObject
	{
	public:
		CBase_Infrastructure_dicore_dicore_save_value_fail() { }
		~CBase_Infrastructure_dicore_dicore_save_value_fail() { }
	...
	public:
		...
		virtual DString GetAction_ES_ES() const { return DString(I_("Póngase en contacto con un representante de soporte técnico.")); }
