...
namespace CND
{
	class CBase_Infrastructure_dicore_dicore_eventsem_wait_fail : public CConditionObject
	{
	public:
		CBase_Infrastructure_dicore_dicore_eventsem_wait_fail() { }
		~CBase_Infrastructure_dicore_dicore_eventsem_wait_fail() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("DICORE_EVENTSEM_WAIT_FAIL")); }
