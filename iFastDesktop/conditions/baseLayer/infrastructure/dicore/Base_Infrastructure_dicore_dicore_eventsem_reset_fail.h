...
namespace CND
{
	class CBase_Infrastructure_dicore_dicore_eventsem_reset_fail : public CConditionObject
	{
	public:
		CBase_Infrastructure_dicore_dicore_eventsem_reset_fail() { }
		~CBase_Infrastructure_dicore_dicore_eventsem_reset_fail() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("DICORE_EVENTSEM_RESET_FAIL")); }
