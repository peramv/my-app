...
namespace CND
{
	class CBase_Infrastructure_dicore_dicore_bad_packet : public CConditionObject
	{
	public:
		CBase_Infrastructure_dicore_dicore_bad_packet() { }
		~CBase_Infrastructure_dicore_dicore_bad_packet() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("DICORE_BAD_PACKET")); }
