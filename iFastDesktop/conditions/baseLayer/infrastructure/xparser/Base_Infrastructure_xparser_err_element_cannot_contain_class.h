...
namespace CND
{
	class CBase_Infrastructure_xparser_err_element_cannot_contain_class : public CConditionObject
	{
	public:
		CBase_Infrastructure_xparser_err_element_cannot_contain_class() { }
		~CBase_Infrastructure_xparser_err_element_cannot_contain_class() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_ELEMENT_CANNOT_CONTAIN_CLASS")); }
