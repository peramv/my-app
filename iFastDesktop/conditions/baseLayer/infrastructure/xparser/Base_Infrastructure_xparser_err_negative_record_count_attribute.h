...
namespace CND
{
	class CBase_Infrastructure_xparser_err_negative_record_count_attribute : public CConditionObject
	{
	public:
		CBase_Infrastructure_xparser_err_negative_record_count_attribute() { }
		~CBase_Infrastructure_xparser_err_negative_record_count_attribute() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_NEGATIVE_RECORD_COUNT_ATTRIBUTE")); }
