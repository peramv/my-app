...
namespace CND
{
	class CBase_Infrastructure_bfdata_cnd_bfdatanotimplementedexception : public CConditionObject
	{
	public:
		CBase_Infrastructure_bfdata_cnd_bfdatanotimplementedexception() { }
		~CBase_Infrastructure_bfdata_cnd_bfdatanotimplementedexception() { }
