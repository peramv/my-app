...
namespace CND
{
	class CBase_Infrastructure_bfdata_bfdata_cnd_version : public CConditionObject
	{
	public:
		CBase_Infrastructure_bfdata_bfdata_cnd_version() { }
		~CBase_Infrastructure_bfdata_bfdata_cnd_version() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("BFDATA_CND_VERSION")); }
