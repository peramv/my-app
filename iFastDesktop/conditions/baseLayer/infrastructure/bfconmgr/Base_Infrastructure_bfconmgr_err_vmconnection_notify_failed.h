...
namespace CND
{
	class CBase_Infrastructure_bfconmgr_err_vmconnection_notify_failed : public CConditionObject
	{
	public:
		CBase_Infrastructure_bfconmgr_err_vmconnection_notify_failed() { }
		~CBase_Infrastructure_bfconmgr_err_vmconnection_notify_failed() { }
