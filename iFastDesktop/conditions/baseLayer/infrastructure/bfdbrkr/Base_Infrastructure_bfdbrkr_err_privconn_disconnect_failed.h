...
namespace CND
{
	class CBase_Infrastructure_bfdbrkr_err_privconn_disconnect_failed : public CConditionObject
	{
	public:
		CBase_Infrastructure_bfdbrkr_err_privconn_disconnect_failed() { }
		~CBase_Infrastructure_bfdbrkr_err_privconn_disconnect_failed() { }

	public:
		// General
		virtual DString GetConditionName() const { return DString(I_("ERR_PRIVCONN_DISCONNECT_FAILED")); }
