...
void AboutPropRegistryPage::generateReport( std::wstringstream& ss )
{
   ...
   addReportItem( ss, I_("MFDSTC"), I_("RTSHost"), I_("SMQAWDQueue") );
   ...
   addReportItem( ss, I_("MFDSTC"), I_("RTSHost"), I_("SMQMaxConnections") );

   addReportItem( ss, I_("MFDSTC"), I_("RTSHost"), I_("UseActiveMQ") );
   addReportItem( ss, I_("MFDSTC"), I_("RTSHost"), I_("AMQBrokerURLs") );
   addReportItem( ss, I_("MFDSTC"), I_("RTSHost"), I_("AMQSingleQueue") );
   addReportItem( ss, I_("MFDSTC"), I_("RTSHost"), I_("AMQMultiQueue") );
   addReportItem( ss, I_("MFDSTC"), I_("RTSHost"), I_("AMQLDAPQueue") );
   addReportItem( ss, I_("MFDSTC"), I_("RTSHost"), I_("AMQAWDQueue") );
   addReportItem( ss, I_("MFDSTC"), I_("RTSHost"), I_("AMQUser") );
   addReportItem( ss, I_("MFDSTC"), I_("RTSHost"), I_("AMQPassword") );
   addReportItem( ss, I_("MFDSTC"), I_("RTSHost"), I_("AMQWaitTimeout") );
   addReportItem( ss, I_("MFDSTC"), I_("RTSHost"), I_("AMQTimeToLive") );
   addReportItem( ss, I_("MFDSTC"), I_("RTSHost"), I_("AMQMaxConnections") );
   ...
   addReportItem( ss, I_("MFDSTC"), I_("Support"), I_("ControlTextRewriter_Path") );
   addReportItem( ss, I_("MFDSTC"), I_("Support"), I_("KeyPeek_Path") );
   ss << std::endl;
}
...
BOOL AboutPropRegistryPage::OnInitDialog()
{
   ...
   addConfigEntry( I_("MFDSTC"), I_("RTSHost"), I_("SMQAWDQueue") );
   ...
   addConfigEntry( I_("MFDSTC"), I_("RTSHost"), I_("SMQMaxConnections") );

   addConfigEntry( I_("MFDSTC"), I_("RTSHost"), I_("UseActiveMQ") );
   addConfigEntry( I_("MFDSTC"), I_("RTSHost"), I_("AMQBrokerURLs") );
   addConfigEntry( I_("MFDSTC"), I_("RTSHost"), I_("AMQSingleQueue") );
   addConfigEntry( I_("MFDSTC"), I_("RTSHost"), I_("AMQMultiQueue") );
   addConfigEntry( I_("MFDSTC"), I_("RTSHost"), I_("AMQLDAPQueue") );
   addConfigEntry( I_("MFDSTC"), I_("RTSHost"), I_("AMQAWDQueue") );
   addConfigEntry( I_("MFDSTC"), I_("RTSHost"), I_("AMQUser") );
   addConfigEntry( I_("MFDSTC"), I_("RTSHost"), I_("AMQPassword") );
   addConfigEntry( I_("MFDSTC"), I_("RTSHost"), I_("AMQWaitTimeout") );
   addConfigEntry( I_("MFDSTC"), I_("RTSHost"), I_("AMQTimeToLive") );
   addConfigEntry( I_("MFDSTC"), I_("RTSHost"), I_("AMQMaxConnections") );
   ...
   addConfigEntry( I_("MFDSTC"), I_("Support"), I_("ControlTextRewriter_Path") );
...
//******************************************************************************
//
// $Log:   Y:/VCS/BF iFAST/ifsupp/AboutPropRegistryPage.cpp-arc  $
// 
//    Rev 1.0   Dec 05 2011 09:04:10   purdyech
// Initial revision.
// 
