...
public class Transfers {
	...
	public String toString() {
		return "Transfers [accountNumber=" + accountNumber + ", transactionId=" + transactionId + ", extRDSPContNum="
				+ extRDSPContNum + ", extSpecimenPlanNum=" + extSpecimenPlanNum + ", internalRDSPContNum="
				+ internalRDSPContNum + ", internalSpecimenPlanNum=" + internalSpecimenPlanNum
				+ ", nonTaxablePrivateCntbns=" + nonTaxablePrivateCntbns + ", canadaDisabilitySavingsGrant="
				+ canadaDisabilitySavingsGrant + ", taxableReportsRollovers=" + taxableReportsRollovers
				+ ", canadaDisabilitySavingsBond=" + canadaDisabilitySavingsBond + ", fairMarketValue="
				+ fairMarketValue + ", grantBondsPaid=" + grantBondsPaid + ", contributions=" + contributions
				+ ", nonTaxablePriorDapLdap=" + nonTaxablePriorDapLdap + ", nonTaxablePresentDapLdap="
