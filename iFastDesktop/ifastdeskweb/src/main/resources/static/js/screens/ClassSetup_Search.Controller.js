...
DesktopWeb.ScreenController = function(){	
   ...
   function updateInitData(responseXML,callbackfn)
	...
	return {
		...
		{
			DesktopWeb.Ajax.deleteCacheRequest(['UpdatedClassData','ScreenDefList'], deleteCacheHandler);
		...
		,addClass: function()
		{   
			DesktopWeb.Ajax.deleteCacheRequest(['ExistingClassData', 'UpdatedClassData','ScreenDefList'], deleteCacheHandler);
