...
DesktopWeb.ScreenTranslation = {
	'enUS': {
		...
		ContractInformationPassesTransactionValidation:"Contract information passes transaction validation",
		ContractInformationPasses60DayRule:"Contract information passes 60 day rule",
		ContractInformationContainsMinimumInformationRequirements:"Contract information contains Minimum Information Requirements",
		BeneficiarySinPassesIdentityValidationAtSir:"Beneficiary SIN passes Identity Validation at SIR ",
		HoldersSinPassesIdentityValidationAtSir:"Holder(s) SIN passes Identity Validation at SIR ",
		CurrentContractIsWaitingForATransferToOccur:"Current contract is waiting for a Transfer to occur",
		BeneficiaryPassesResidencyValidationAtContractSignatureDate:"Beneficiary Passes Residency validation at Contract Signature Date",
		BeneficiaryPassesDtcEligibilityValidationAtContractSignatureDate:"Beneficiary Passes DTC eligibility validation at Contract Signature Date",
		BeneficiarySinIsUsableAtContractSignatureDate:"Beneficiary SIN is usable at Contract Signature Date",
		HoldersSinIsUsableAtContractSignatureDate:"Holder(s) SIN is usable at Contract Signature Date",
		RemainingBalanceOnContract:"Remaining Balance on Contract ",
		CurrentReasonForChangeOfContractStatus:"Current Reason for change of Contract Status",
