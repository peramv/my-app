  ...
  <fo:root>
    <fo:layout-master-set>
      <fo:simple-page-master master-name="page">
        <fo:region-body margin=".25in .25in .25in .25in"/>
        <fo:region-before extent=".15in"/>
...
<xsl:template match="xhtml:table">
  ...
  <fo:table width="100%"  table-layout="fixed"  text-align="center"><xsl:call-template name="common-atts"/>
...
<xsl:template match="xhtml:th|th">
  <fo:table-cell  font-weight="bold" padding=".2em" keep-together="always" hyphenate="true" wrap-option="wrap"><xsl:call-template name="common-atts"/>
    <xsl:if test="../../@border &gt; 0">
		<xsl:attribute name="border"><xsl:value-of select="'1 groove gray'"/></xsl:attribute>
	</xsl:if>
    <xsl:if test="../@bgcolor">
...
<xsl:template  match="xhtml:td|td">
  <fo:table-cell keep-together="always"  hyphenate="true" padding=".2em"><xsl:call-template name="common-atts"/>
    <xsl:if test="../../@border &gt; 0">
		<xsl:attribute name="border"><xsl:value-of select="'1 groove gray'"/></xsl:attribute>
	</xsl:if>
    <xsl:if test="@colspan">
...
<xsl:template match="xhtml:sup|sup">
  <fo:inline vertical-align="super" font-size="6pt"><xsl:call-template name="common-atts"/>    
    <xsl:value-of select="."/>
  </fo:inline>
</xsl:template>
