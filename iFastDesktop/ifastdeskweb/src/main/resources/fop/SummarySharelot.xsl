...
xhtml 
	...
	<xsl:template name="tmpSummarySharelot">
		...
		<table width="100%" word-wrap="break-word" table-layout="fixed" cellspacing="0" celpadding="0" border="1">
			...
			<thead border="1">
				<tr>
					...
					<th >Unit Balance</th>
					<th >Value Balance</th>
					<th >Equilisation <br/> Potential Value</th>
					<th >
						Equilisation <br/> Market Value	
					</th>
					<!-- 
					<td>Eq 1</td>
					<td>Eq 2</td>
