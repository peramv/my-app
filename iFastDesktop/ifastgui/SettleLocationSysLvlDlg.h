...
//******************************************************************************
//
// ^FILE   : SettleLocationSysLvlDlg.h
// ^AUTHOR : 
// ^DATE   : 
//
...
#endif
class SettleLocationSysLvlDlg : public BaseMainDlg
{
public:
   /**
    * Standard dialog constructor for DSTC
    */
   SettleLocationSysLvlDlg( CWnd* pParent, GenericInterfaceContainer* pGIC, GenericInterface* pGIParent, const Command& rCommand);

   //{{AFX_DATA(SettleLocationSysLvlDlg)
   enum
   {
      IDD = IDD_SETTLEMENT_LOCATION_SYSLVL
   };
   //}}AFX_DATA

   // ClassWizard generated virtual function overrides
   //{{AFX_VIRTUAL(SettleLocationSysLvlDlg)
   protected:
...
protected:
   ...
   //{{AFX_MSG(SettleLocationSysLvlDlg)
...
//***********************************************
//
// $Log:   Y:/VCS/BF iFAST/ifastgui/SettleLocationSysLvlDlg.h-arc  $
//
