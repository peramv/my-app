...
//******************************************************************************
//
// ^FILE   : RESPBeneficiaryAllocationDlg.h
// ^AUTHOR :
// ^DATE   : 
//
...
#endif
class RESPBeneficiaryAllocationDlg : public BaseMainDlg
{
public:
   /**
    * Standard dialog constructor for DSTC
    */
   RESPBeneficiaryAllocationDlg(CWnd* pParent, GenericInterfaceContainer* pGIC, GenericInterface* pGIParent, const Command& rCommand);
// Dialog Data
   //{{AFX_DATA(SettlementDlg)
   enum
   {
      IDD = IDD_RESP_BENEFICIARY_ALLOCATION
   };
   //}}AFX_DATA
...
protected:
   ...
   afx_msg void OnBtnAllocHistory ();
   //}}AFX_MSG
