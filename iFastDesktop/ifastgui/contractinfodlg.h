#ifndef CONTRACTINFODLG_H
#define CONTRACTINFODLG_H
//*****************************************************************************
//
// COPYRIGHT:
//
...
class ContractInfoDlg : public BaseMainDlg
{
// Construction
public:
   ContractInfoDlg(CWnd* pParent, GenericInterfaceContainer* pGIC, GenericInterface* pGIParent, const Command& rCommand );

// Dialog Data
   //{{AFX_DATA(ContractInfoDlg)
   enum
   {
      IDD = IDD_CONTRACT_INFO
   };
   //}}AFX_DATA
...
protected:
   ...
   afx_msg void OnBtnFeatureOpt();
   afx_msg void OnBtnContractMaturityInstr();
   afx_msg void OnBtnSEGProcessing();
   afx_msg void OnBtnGuaranteeFee();
   afx_msg void OnBtnSEGDates();
...
private:
   ...
   void SetContrMatrInstrBtnState();
 ...
 ******************************************************************************
 *
 * $Log:   Y:/VCS/BF iFAST/ifastgui/contractinfodlg.h-arc  $
 * 
 *    Rev 1.24   Mar 22 2012 18:36:48   wp040100
 * P0186484 FN05 - Contract Maturity Instruction Changes
 * 
 *    Rev 1.23   Feb 03 2012 19:14:04   dchatcha
 * Synch up: IN# 2799812 - Contract Screen Issues.
 * 
 *    Rev 1.22   Dec 27 2011 01:06:54   dchatcha
 * P0186484 - FN 05 - work on Contract Information Screen
 * 
 *    Rev 1.21   Jun 06 2006 17:25:56   porteanm
 * PET 2102 FN01 - Flex support.
 * 
 *    Rev 1.20   Aug 17 2005 16:46:48   porteanm
