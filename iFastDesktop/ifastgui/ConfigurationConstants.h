...
namespace CONFIGURATION_CONSTANTS
{
   ...
   CONFIGURATION_CONSTANTS_EXTERN( SMQMaxConnections );

   CONFIGURATION_CONSTANTS_EXTERN( AMQBrokerURLs );
   CONFIGURATION_CONSTANTS_EXTERN( AMQSingleQueue );
   CONFIGURATION_CONSTANTS_EXTERN( AMQMultiQueue );
   CONFIGURATION_CONSTANTS_EXTERN( AMQWorkEventTopicPrefix );
   CONFIGURATION_CONSTANTS_EXTERN( AMQWorkEventReplyTopic );
   CONFIGURATION_CONSTANTS_EXTERN( AMQWorkAgentKeepAliveTopic );
   CONFIGURATION_CONSTANTS_EXTERN( AMQUser );
   CONFIGURATION_CONSTANTS_EXTERN( AMQPassword );
   CONFIGURATION_CONSTANTS_EXTERN( AMQWaitTimeout );
   CONFIGURATION_CONSTANTS_EXTERN( AMQTimeToLive );
   CONFIGURATION_CONSTANTS_EXTERN( AMQMaxConnections );
}
