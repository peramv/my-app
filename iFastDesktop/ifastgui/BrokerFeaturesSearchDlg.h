...
//******************************************************************************
//
// ^FILE   : BrokerFeaturesSearchDlg.hpp
// ^AUTHOR : Serban Popescu
// ^DATE   : 01/08/03
//
// ^CLASS    : BrokerFeaturesSearchDlg
...
class BrokerFeaturesSearchDlg : public BaseMainDlg
{
public:
   // standard constructor
   BrokerFeaturesSearchDlg(CWnd* pParent, GenericInterfaceContainer* pGIC, 
      GenericInterface* pGIParent, const Command& rCommand);
// Dialog Data
   //{{AFX_DATA(BrokerFeaturesSearchDlg)
   enum
   {
      IDD = IDD_BROKER_FEATURES_SEARCH
   };
   //}}AFX_DATA

// Overrides
   // ClassWizard generated virtual function overrides
   //{{AFX_VIRTUAL(BrokerFeaturesSearchDlg)
public:
...
protected:
   ...
   //{{AFX_MSG(BrokerFeaturesSearchDlg)
...
//*****************************************************************************
//
/* $Log:   Y:/VCS/BF iFAST/ifastgui/BrokerFeaturesSearchDlg.h-arc  $
//
