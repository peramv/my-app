...
*/
   ...
   POSITION posDocTemplate = ((MFDSTCApp*)AfxGetApp())->GetFirstDocTemplatePosition();
   CDocTemplate* pDocTemplate = ((MFDSTCApp*)AfxGetApp())->GetNextDocTemplate(posDocTemplate);
   POSITION posDoc = pDocTemplate->GetFirstDocPosition();
   CDocument* pDoc = pDocTemplate->GetNextDoc(posDoc);
   POSITION posView = pDoc->GetFirstViewPosition();
   CDSTCView* pView = (CDSTCView*)pDoc->GetNextView(posView);
...
//******************************************************************************
//
/* $Log:   Y:/VCS/BF iFAST/ifastgui/AboutPropLogPage.cpp-arc  $
// 
