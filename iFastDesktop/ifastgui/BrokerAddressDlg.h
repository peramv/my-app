...
class BrokerAddressDlg : public BaseMainDlg
{
// Construction
public:
   BrokerAddressDlg( CWnd *pParent, GenericInterfaceContainer* pGIC, GenericInterface* pGIParent, const Command& rCommand );
...
//******************************************************************************
//
/* $Log:   Y:/VCS/BF iFAST/ifastgui/BrokerAddressDlg.h-arc  $
//
//   Rev 1.0   Apr 03 2003 09:39:18   YINGBAOL
//Initial revision.
