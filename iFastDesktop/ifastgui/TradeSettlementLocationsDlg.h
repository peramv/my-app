...
//******************************************************************************
//
// ^FILE   : TradeSettlementLocationsDlg.h
// ^AUTHOR :
// ^DATE   : July, 2009
//
...
#endif
class TradeSettlementLocationsDlg : public BaseMainDlg
{
public:
   /**
    * Standard dialog constructor for DSTC
    */
   TradeSettlementLocationsDlg(CWnd* pParent, GenericInterfaceContainer* pGIC, GenericInterface* pGIParent, const Command& rCommand);
// Dialog Data
   //{{AFX_DATA(SettlementDlg)
   enum
   {
      IDD = IDD_TRADE_SETTLEMENT_LOCATIONS
   };
   //}}AFX_DATA
