...
class InterestSegmentDlg : public BaseMainDlg
{
public:
   /**
    * Standard dialog constructor for DSTC
    */
   InterestSegmentDlg(CWnd* pParent, GenericInterfaceContainer* pGIC, GenericInterface* pGIParent, const Command& rCommand);
// Dialog Data
   //{{AFX_DATA(InterestSegmentDlg)
   enum
   {
      IDD = IDD_INTEREST_SEGMENTS
   };
   //}}AFX_DATA
...
// Overrides
   ...
   //{{AFX_VIRTUAL(InterestSegmentDlg)
protected:
...
//******************************************************************************
//
/* $Log:   Y:/VCS/BF iFAST/ifastgui/InterestSegmentDlg.h-arc  $
//
//   Rev 1.0   Dec 09 2011 19:50:24   wp040100
//Initial revision.
//
