...
#endif
class TradeAuthorizationDlg : public BaseMainDlg
{
public:
   /**
    * Standard dialog constructor for DSTC
    */
   TradeAuthorizationDlg(CWnd* pParent, GenericInterfaceContainer* pGIC, GenericInterface* pGIParent, const Command& rCommand);
// Dialog Data
   //{{AFX_DATA(SettlementDlg)
   enum
   {
      IDD = IDD_TRADE_AUTHORIZATION
   };
   //}}AFX_DATA
