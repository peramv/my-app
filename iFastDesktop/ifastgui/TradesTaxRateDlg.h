#ifndef TradesTaxRateDlg_H
#define TradesTaxRateDlg_H
//******************************************************************************
//
// COPYRIGHT:
//
...
class TradesTaxRateDlg : public BaseMainDlg
{
public:
   /**
    * Constructor
    */
   TradesTaxRateDlg(CWnd* pParent, GenericInterfaceContainer* pGIC, GenericInterface* pGIParent, const Command& rCommand);
...
//******************************************************************************
//
/* $Log:   Y:/VCS/BF iFAST/ifastgui/TradesTaxRateDlg.h-arc  $
//
//   Rev 1.2   Sep 20 2003 10:34:30   VADEANUM
//PTS 10021736 - Withholding Tax Default Rates.
//
//   Rev 1.1   Aug 15 2003 17:38:06   FENGYONG
//Add check box Override
//
//   Rev 1.0   Aug 15 2003 10:28:04   FENGYONG
//Initial Revision
//
