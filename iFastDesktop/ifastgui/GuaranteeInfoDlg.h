#ifndef GUARANTEEINFODLG_H
#define GUARANTEEINFODLG_H
//*****************************************************************************
//
// COPYRIGHT:
//
...
class GuaranteeInfoDlg : public BaseMainDlg
{
// Construction
public:
   GuaranteeInfoDlg(CWnd* pParent, GenericInterfaceContainer* pGIC, GenericInterface* pGIParent, const Command& rCommand);
// Dialog Data
   //{{AFX_DATA(GuaranteeInfoDlg)
   enum
   {
      IDD = IDD_GUARANTEE_INFO
   };
   //}}AFX_DATA
...
protected:
   ...
   virtual bool doRefresh( GenericInterface *, 
                           const I_CHAR * );
 ...
 ******************************************************************************
 *
 * $Log:   Y:/VCS/BF iFAST/ifastgui/GuaranteeInfoDlg.h-arc  $
 * 
 *    Rev 1.14   Jul 24 2009 01:41:04   dchatcha
 * PET 157825 - FN 13 - Dilution Allocation Enhancements, Sorting combo in grid.
 * 
 *    Rev 1.13   Aug 17 2005 16:44:24   porteanm
