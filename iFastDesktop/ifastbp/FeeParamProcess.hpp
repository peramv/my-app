...
class IFASTBP_LINKAGE FeeParamProcess : public AbstractProcess, public IFastHistoricalParameters
{
// Construction
public:
   /**
    * Default constructor
    */
//CP20030319   FeeParamProcess();
   FeeParamProcess( GenericInterfaceContainer* pGIC, GenericInterface* pGIParent, const Command& rCommand );
   virtual ~FeeParamProcess();
...
protected:
   ...
   virtual SEVERITY FeeParamProcess::performSearch( GenericInterface *rpGI, const BFContainerId& idSearch, 
...
//******************************************************************************
//
/* $Log:   Y:/VCS/BF iFAST/ifastbp/FeeParamProcess.hpp-arc  $
//
