...
class IFASTBP_LINKAGE BrokerFeaturesSearchProcess : public AbstractProcess
{
// Construction
public:
   BrokerFeaturesSearchProcess(GenericInterfaceContainer* pGIC, 
      GenericInterface* pGIParent, const Command& rCommand);
   virtual ~BrokerFeaturesSearchProcess();
...
//******************************************************************************
//
/* $Log:   Y:/VCS/BF iFAST/ifastbp/BrokerFeaturesSearchProcess.hpp-arc  $
//
