...
class IFASTBP_LINKAGE MatSweepInstrProcess : public AbstractProcess
{
public:
   MatSweepInstrProcess( GenericInterfaceContainer* pGIC, GenericInterface* pGIParent, const Command& rCommand );
   virtual ~MatSweepInstrProcess();
protected:
