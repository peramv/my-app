...
class IFASTBP_LINKAGE ShrSummProcess : public AbstractProcess
{
// Construction
public:
   /**
    * Default constructor
    */
//CP20030319   ShrSummProcess();
   ShrSummProcess( GenericInterfaceContainer* pGIC, GenericInterface* pGIParent, const Command& rCommand );
   virtual ~ShrSummProcess();
...
//******************************************************************************
//
/* $Log:   Y:/VCS/BF iFAST/ifastbp/JShrSummProcess.hpp-arc  $
 * 
 *    Rev 1.7   Mar 21 2003 17:44:22   PURDYECH
...
// 
//    Rev 1.0   Feb 25 2000 16:19:56   FENGYONG
// Initial revision.
// 
// Initial revision.
 * 
