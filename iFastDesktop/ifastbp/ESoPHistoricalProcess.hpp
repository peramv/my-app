...
class IFASTBP_LINKAGE ESoPHistoricalProcess : public AbstractProcess
{
// Construction
public:
   /**
    * Default constructor
    */
//CP20030319   ESoPHistoricalProcess();
   ESoPHistoricalProcess( GenericInterfaceContainer* pGIC, GenericInterface* pGIParent, const Command& rCommand );
   virtual ~ESoPHistoricalProcess();
...
///#endif // ESoPHistoricalProcess.hpp
