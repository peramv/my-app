 ...
 * ViewsGenerator: Generated on : Wednesday, October 21, 2015 10:30:04
 */
public class AccountEntityView extends IFastView implements Serializable
{
   ...
   /**
    * RelationshipCode member array.
    */
   private String[] _RelationshipCode = null;
   ...
   /**
    * Gets the RelationshipCode field for the response and the 
    * given index. If the field has no value, null is returned. 
    * 
    * @param index  Zero based index of the repeat for which the value will be retrieved.
    * @return The value of the RelationshipCode or null.
    */
   public final String getRelationshipCode( int index )
   {
      return _RelationshipCode[index];
   }
    ...
    * @param index         Zero based index of the repeat for which the value will be retrieved.
    * @param defaultValue  The value to return if the field has no value.
    * @return The value of the RelationshipCode or the specified default value.
    */
   public final String getRelationshipCode( int index, String defaultValue )
   {
      return _RelationshipCode[index] == null ? defaultValue : _RelationshipCode[index];
   }
    
   /**
    * Gets the array of RelationshipCode fields for the response that
    * have been retrieved so far. Fields from records that have not yet been received,
    * will not present.
    * 
    * @return The array of RelationshipCode values.
    */
   public final String[] getRelationshipCodeArray()
   {
   ...
   protected void decodeFields( RTSResponseDecodeBuffer responseBuffer ) throws ParseException, UnsupportedEncodingException
   {
      ...
      _RelationshipCode = resizeArray( _RelationshipCode, _RepeatCount );
      ...
      for (int x = oldRepeatCount ; x < _RepeatCount; x++)
      {
         ...
         _RelationshipCode[x] = responseBuffer.decodeString(responseBuffer.getNextField());
      }
