...
/**
 * Account Default Allocation request.
 * For additional view information see <A HREF="../../../../viewspecs/AccountDefaultAllocations.doc">AccountDefaultAllocations.doc</A>.
 * 
 * @author RTS Generated
 */
public class AccountDefaultAllocationsRequest extends IFastRequest implements Serializable
{
   ...
   /**
    * Constructs the AccountDefaultAllocationsRequest object.
    * 
    */
   AccountDefaultAllocationsRequest()
   {
      super ( 58 );
   }

   /**
    * Constructs the AccountDefaultAllocationsRequest object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   AccountDefaultAllocationsRequest( String hostEncoding )
   {
      super ( 58, hostEncoding );
   }
