...
//         _receivedFirst = true;
   ...
   private boolean rawReceive(int overrideRepeats, String routingInstruction) throws ParseException,
         IOException, IFastSystemResponseException, ProducerException,
         ProducerClosedException, SonicConfigException {
      if (_receivedFirst && !_moreAvailable)
         throw new IllegalStateException(
               "Unable to receive view - no records available.");

      _request.setOverrideRepeats(overrideRepeats);

      return processResponse(_request.send(routingInstruction));
   }

   /**
    * This method is called to retrieved data from the host for attached
    * request. This method will return true if data was recieved, otherwise
    * false is returned and the host error response can be retrieved using the
    * getErrorResponse() method.<br>
    * <br>
    * 
    * This method allows the caller to override the number of records in the
    * repeating section to be returned. This override is ignored if it exceeds
    * the host defined maximum.<br>
    * <br>
    * 
    * If more records are available on the host than are returned, the
    * isMoreAvailable() method will return true and subsequent receive() calls
    * may be made.<br>
    * <br>
    * 
    * @param overrideRepeats
    *            Number of records to return.
    * @return false if an error response was received, otherwise true
    * @throws SonicConfigException
    * @throws ProducerClosedException
    * @throws ProducerException
    * @throws IFastSystemResponseException
    * @throws IOException
    * @throws ParseException
    */
   public final boolean receive(int overrideRepeats, String routingInstruction) throws ParseException,
         IOException, IFastSystemResponseException, ProducerException,
         ProducerClosedException, SonicConfigException {
      return rawReceive(overrideRepeats, routingInstruction);
   }

   /**
    * This method is called to retrieve all data from the host for attached
    * request. This method will return true if all data was recieved, without
    * an error, otherwise false is returned and the host error response can be
    * retrieved using the getErrorResponse() method.<br>
    * <br>
    * 
    * If the number of records avaiable on the host exceeds the host defined
    * maximum, this method will cause multiple host transactions to occur, each
    * returning the host defined maximum, until all records are retrieved.<br>
    * <br>
    * 
    * After this method is called the isMoreAvailable() method will always
    * return false.<br>
    * <br>
    * 
    * @return false if an error response was received, otherwise true
    ...
    * @throws ParseException
    */
   public final boolean receiveAll(String routingInstruction) throws ParseException, IOException,
         IFastSystemResponseException, ProducerException,
         ProducerClosedException, SonicConfigException {
      while (!_receivedFirst || _moreAvailable) {
         if (!rawReceive(0, routingInstruction))
            return false;
      }
   ...
   /**
    * This method is called to retrieve the specified number of records from
    * the host for attached request. This method will return true if all data
    * was recieved, without an error, otherwise false is returned and the host
    * error response can be retrieved using the getErrorResponse() method.<br>
    * <br>
    * 
    * If the number of records avaiable on the host exceeds the host defined
    * maximum, this method will cause multiple host transactions to occur, each
    * returning the host defined maximum, until the required number of records
    * are retrieved. If fewer records are available that the specified number,
    * all records are returned<br>
    * <br>
    * 
    * If more records are available on the host than are returned, the
    * isMoreAvailable() method will return true and subsequent receive() calls
    ...
    * @throws ParseException
    */
   public final boolean receiveSpecific(int repeats, String routingInstruction) throws ParseException,
         IOException, IFastSystemResponseException, ProducerException,
         ProducerClosedException, SonicConfigException {
      while (!_receivedFirst || _moreAvailable) {
         ...
         if (!rawReceive(repeatsRemaining, routingInstruction))
            return false;
      }
