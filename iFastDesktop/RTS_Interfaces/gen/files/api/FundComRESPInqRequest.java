...
/**
 * FUNDCom RESP Information Inquiry request.
 * For additional view information see <A HREF="../../../../viewspecs/FundComRESPInq.doc">FundComRESPInq.doc</A>.
 * 
 * @author RTS Generated
 */
public class FundComRESPInqRequest extends IFastRequest implements Serializable
{
   ...
   /**
    * Constructs the FundComRESPInqRequest object.
    * 
    */
   FundComRESPInqRequest()
   {
      super ( 372 );
   }

   /**
    * Constructs the FundComRESPInqRequest object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   FundComRESPInqRequest( String hostEncoding )
   {
      super ( 372, hostEncoding );
   }
