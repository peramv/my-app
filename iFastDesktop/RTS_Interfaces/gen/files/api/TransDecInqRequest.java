...
/**
 * TransDec Inquiry request.
 * For additional view information see <A HREF="../../../../viewspecs/TransDecInq.doc">TransDecInq.doc</A>.
 * 
 * @author RTS Generated
 */
public class TransDecInqRequest extends IFastRequest implements Serializable
{
   ...
   /**
    * Constructs the TransDecInqRequest object.
    * 
    */
   TransDecInqRequest()
   {
   ...
   /**
    * Constructs the TransDecInqRequest object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   TransDecInqRequest( String hostEncoding )
   {
      super ( 330, hostEncoding );
   }
