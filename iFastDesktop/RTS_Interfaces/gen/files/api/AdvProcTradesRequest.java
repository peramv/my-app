...
/**
 * Advisor Processed Trades Listing request.
 * For additional view information see <A HREF="../../../../viewspecs/AdvProcTrades.doc">AdvProcTrades.doc</A>.
 * 
 * @author RTS Generated
 */
public class AdvProcTradesRequest extends IFastRequest implements Serializable
{
   ...
   /**
    * Constructs the AdvProcTradesRequest object.
    * 
    */
   AdvProcTradesRequest()
   {
      super ( 343 );
   }

   /**
    * Constructs the AdvProcTradesRequest object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   AdvProcTradesRequest( String hostEncoding )
   {
      super ( 343, hostEncoding );
   }
