...
/**
 * Message Body Inquiry request.
 * For additional view information see <A HREF="../../../../viewspecs/MesgBodyInq.doc">MesgBodyInq.doc</A>.
 * 
 * @author RTS Generated
 */
public class MesgBodyInqRequest extends IFastRequest implements Serializable
{
   ...
   /**
    * Constructs the MesgBodyInqRequest object.
    * 
    */
   MesgBodyInqRequest()
   {
   ...
   /**
    * Constructs the MesgBodyInqRequest object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   MesgBodyInqRequest( String hostEncoding )
   {
      super ( 334, hostEncoding );
   }
