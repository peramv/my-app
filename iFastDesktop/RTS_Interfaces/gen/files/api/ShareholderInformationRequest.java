...
/**
 * Shareholder Information Inquiry request.
 * For additional view information see <A HREF="../../../../viewspecs/ShareholderInformation.doc">ShareholderInformation.doc</A>.
 * 
 * @author RTS Generated
 */
public class ShareholderInformationRequest extends IFastRequest implements Serializable
{
   ...
   /**
    * Constructs the ShareholderInformationRequest object.
    * 
    */
   ...
   /**
    * Constructs the ShareholderInformationRequest object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   ShareholderInformationRequest( String hostEncoding )
   {
      super ( 69, hostEncoding );
   }
