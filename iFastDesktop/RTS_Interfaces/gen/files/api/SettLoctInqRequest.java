...
/**
 * Settlement Locations Inquiry request.
 * For additional view information see <A HREF="../../../../viewspecs/SettLoctInq.doc">SettLoctInq.doc</A>.
 * 
 * @author RTS Generated
 */
public class SettLoctInqRequest extends IFastRequest implements Serializable
{
   ...
   /**
    * Constructs the SettLoctInqRequest object.
    * 
    */
   SettLoctInqRequest()
   {
   ...
   /**
    * Constructs the SettLoctInqRequest object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   SettLoctInqRequest( String hostEncoding )
   {
      super ( 397, hostEncoding );
   }
