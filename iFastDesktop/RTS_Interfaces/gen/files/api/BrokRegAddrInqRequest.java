...
/**
 * Broker/Interm Registered Addresses Inquiry request.
 * For additional view information see <A HREF="../../../../viewspecs/BrokRegAddrInq.doc">BrokRegAddrInq.doc</A>.
 * 
 * @author RTS Generated
 */
public class BrokRegAddrInqRequest extends IFastRequest implements Serializable
{
   ...
   /**
    * Constructs the BrokRegAddrInqRequest object.
    * 
    */
   BrokRegAddrInqRequest()
   {
      super ( 116 );
   }

   /**
    * Constructs the BrokRegAddrInqRequest object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   BrokRegAddrInqRequest( String hostEncoding )
   {
      super ( 116, hostEncoding );
   }
