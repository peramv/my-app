...
/**
 * ESoP Plan Inquiry request.
 * For additional view information see <A HREF="../../../../viewspecs/ESoPInq.doc">ESoPInq.doc</A>.
 * 
 * @author RTS Generated
 */
public class ESoPInqRequest extends IFastRequest implements Serializable
{
   ...
   /**
    * Constructs the ESoPInqRequest object.
    * 
    */
   ESoPInqRequest()
   {
   ...
   /**
    * Constructs the ESoPInqRequest object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   ESoPInqRequest( String hostEncoding )
   {
      super ( 169, hostEncoding );
   }
