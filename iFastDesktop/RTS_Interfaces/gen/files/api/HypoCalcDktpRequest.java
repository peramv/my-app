...
/**
 * Hypothetical Redemption Summary request.
 * For additional view information see <A HREF="../../../../viewspecs/HypoCalcDktp.doc">HypoCalcDktp.doc</A>.
 * 
 * @author RTS Generated
 */
public class HypoCalcDktpRequest extends IFastRequest implements Serializable
{
   ...
   /**
    * Constructs the HypoCalcDktpRequest object.
    * 
    */
   HypoCalcDktpRequest()
   {
   ...
   /**
    * Constructs the HypoCalcDktpRequest object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   HypoCalcDktpRequest( String hostEncoding )
   {
      super ( 217, hostEncoding );
   }
