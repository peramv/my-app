...
/**
 * Account KYC Historical Inquiry view.
 * For additional view information see <A HREF="../../../../viewspecs/AcctKYCHistInq.doc">AcctKYCHistInq.doc</A>.
 * 
 * @author RTS Generated
 */
public class AcctKYCHistInqView extends IFastView implements Serializable
{
    ...
    */
   private String[] _PreviousDisplay = null;
   
   /**
    * New Display member array.
    */
   private Boolean[] _NewDisplay = null;
   ...
   /**
    * Constructs the AcctKYCHistInqView object.
    * 
    */
   public AcctKYCHistInqView()
   {
      super ( new AcctKYCHistInqRequest() );
   }

   /**
    * Constructs the AcctKYCHistInqView object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   public AcctKYCHistInqView( String hostEncoding )
   {
      super ( new AcctKYCHistInqRequest( hostEncoding ) );
   }

   /**
    * Gets the AcctKYCHistInqRequest object associated with this view. Data is set
    * into this object before calling any of this view's recieve
    * methods. An attempt to set request fields after the first receive will
    * result in a runtime exception.
    * 
    * @return The AcctKYCHistInqRequest object.
    */
   public final AcctKYCHistInqRequest getRequest()
   {
      return (AcctKYCHistInqRequest)getIFastRequest();
   }
    ...
    */
   public final String getPreviousDisplay( int index )
   {
      return _PreviousDisplay[index];
   }
    ...
    */
   public final String getPreviousDisplay( int index, String defaultValue )
   {
      return _PreviousDisplay[index] == null ? defaultValue : _PreviousDisplay[index];
   }
    ...
    */
   public final String[] getPreviousDisplayArray()
   {
    ...
    */
   public final Boolean getNewDisplay( int index )
   {
      return _NewDisplay[index];
   }
    ...
    */
   public final boolean getNewDisplay( int index, boolean defaultValue )
   {
      return _NewDisplay[index] == null ? defaultValue : _NewDisplay[index].booleanValue();
   }
    ...
    */
   public final Boolean[] getNewDisplayArray()
   {
      return _NewDisplay;
   }
   ...
   protected void decodeFields( RTSResponseDecodeBuffer responseBuffer ) throws ParseException, UnsupportedEncodingException
   {
      ...
      _PreviousDisplay = resizeArray( _PreviousDisplay, _RepeatCount );
      _NewDisplay = resizeArray( _NewDisplay, _RepeatCount );
      ...
      for (int x = oldRepeatCount ; x < _RepeatCount; x++)
      {
         ...
         _PreviousDisplay[x] = responseBuffer.decodeString(responseBuffer.getNextField());
         _NewDisplay[x] = responseBuffer.decodeBoolean(responseBuffer.getNextField());
