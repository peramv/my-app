 ...
 */
public class DTAMaintView extends IFastView implements Serializable
{
   ...
   /**
    * Constructs the DTAMaintView object.
    * 
    */
   public DTAMaintView()
   {
      super ( new DTAMaintRequest() );
   }

   /**
    * Constructs the DTAMaintView object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   public DTAMaintView( String hostEncoding )
   {
      super ( new DTAMaintRequest( hostEncoding ) );
   }

   /**
    * Gets the DTAMaintRequest object associated with this view. Data is set
    * into this object before calling any of this view's recieve
    * methods. An attempt to set request fields after the first receive will
    * result in a runtime exception.
    * 
    * @return The DTAMaintRequest object.
    */
   public final DTAMaintRequest getRequest()
   {
      return (DTAMaintRequest)getIFastRequest();
   }
