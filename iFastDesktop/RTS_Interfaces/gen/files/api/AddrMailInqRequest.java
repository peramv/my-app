...
/**
 * Address Mailing by Document Type request.
 * For additional view information see <A HREF="../../../../viewspecs/AddrMailInq.doc">AddrMailInq.doc</A>.
 * 
 * @author RTS Generated
 */
public class AddrMailInqRequest extends IFastRequest implements Serializable
{
   ...
   /**
    * Constructs the AddrMailInqRequest object.
    * 
    */
   AddrMailInqRequest()
   {
   ...
   /**
    * Constructs the AddrMailInqRequest object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   AddrMailInqRequest( String hostEncoding )
   {
      super ( 363, hostEncoding );
   }
