...
/**
 * Transaction Fees Inquiry request.
 * For additional view information see <A HREF="../../../../viewspecs/.doc">.doc</A>.
 * 
 * @author RTS Generated
 */
public class Request extends IFastRequest implements Serializable
{
   ...
   /**
    * Constructs the Request object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   Request( String hostEncoding )
   {
      super ( 298, hostEncoding );
   }
