...
/**
 * System Availability for Handler 7 view.
 * For additional view information see <A HREF="../../../../viewspecs/SysAvailability7.doc">SysAvailability7.doc</A>.
 * 
 * @author RTS Generated
 */
public class SysAvailability7View extends IFastView implements Serializable
{
   ...
   /**
    * Constructs the SysAvailability7View object.
    * 
    */
   public SysAvailability7View()
   {
      super ( new SysAvailability7Request() );
   }

   /**
    * Constructs the SysAvailability7View object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   public SysAvailability7View( String hostEncoding )
   {
      super ( new SysAvailability7Request( hostEncoding ) );
   }

   /**
    * Gets the SysAvailability7Request object associated with this view. Data is set
    * into this object before calling any of this view's recieve
    * methods. An attempt to set request fields after the first receive will
    * result in a runtime exception.
    * 
    * @return The SysAvailability7Request object.
    */
   public final SysAvailability7Request getRequest()
   {
      return (SysAvailability7Request)getIFastRequest();
   }
