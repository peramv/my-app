...
/**
 * Acount AMS Maintenance view.
 * For additional view information see <A HREF="../../../../viewspecs/AcctAmsUpd.doc">AcctAmsUpd.doc</A>.
 * 
 * @author RTS Generated
 */
public class AcctAmsUpdView extends IFastView implements Serializable
{
   ...
   /**
    * Constructs the AcctAmsUpdView object.
    * 
    */
   public AcctAmsUpdView()
   {
      super ( new AcctAmsUpdRequest() );
   }

   /**
    * Constructs the AcctAmsUpdView object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   public AcctAmsUpdView( String hostEncoding )
   {
      super ( new AcctAmsUpdRequest( hostEncoding ) );
   }

   /**
    * Gets the AcctAmsUpdRequest object associated with this view. Data is set
    * into this object before calling any of this view's recieve
    * methods. An attempt to set request fields after the first receive will
    * result in a runtime exception.
    * 
    * @return The AcctAmsUpdRequest object.
    */
   public final AcctAmsUpdRequest getRequest()
   {
      return (AcctAmsUpdRequest)getIFastRequest();
   }
