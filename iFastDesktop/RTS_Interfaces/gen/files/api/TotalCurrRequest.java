...
/**
 * Settlement Totals by Currency request.
 * For additional view information see <A HREF="../../../../viewspecs/TotalCurr.doc">TotalCurr.doc</A>.
 * 
 * @author RTS Generated
 */
public class TotalCurrRequest extends IFastRequest implements Serializable
{
   ...
   /**
    * Vol Settle Type member variable.
    */
   ...
   /**
    * Constructs the TotalCurrRequest object.
    * 
    */
   TotalCurrRequest()
   {
   ...
   /**
    * Constructs the TotalCurrRequest object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   TotalCurrRequest( String hostEncoding )
   {
      super ( 206, hostEncoding );
   }
   ...
   /**
    * Sets the Vol Settle Type field for the request.
    * 
    * @param value  Value that the Vol Settle Type will be set to.
    */
