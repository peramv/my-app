 ...
 */
public class AcctUpdView extends IFastView implements Serializable
{
   ...
   /**
    * Constructs the AcctUpdView object.
    * 
    */
   public AcctUpdView()
   {
      super ( new AcctUpdRequest() );
   }

   /**
    * Constructs the AcctUpdView object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   public AcctUpdView( String hostEncoding )
   {
      super ( new AcctUpdRequest( hostEncoding ) );
   }

   /**
    * Gets the AcctUpdRequest object associated with this view. Data is set
    * into this object before calling any of this view's recieve
    * methods. An attempt to set request fields after the first receive will
    * result in a runtime exception.
    * 
    * @return The AcctUpdRequest object.
    */
   public final AcctUpdRequest getRequest()
   {
      return (AcctUpdRequest)getIFastRequest();
   }
