 ...
 * ViewsGenerator: Generated on : Tuesday, May 03, 2016 16:19:32
 */
public class TransactionDetailsView extends IFastView implements Serializable
{
   ...
   /**
    * returned external institution code member array.
    */
   ...
   /**
    * Gets the returned external institution code field for the response and the 
    * given index. If the field has no value, null is returned. 
    * 
    * @param index  Zero based index of the repeat for which the value will be retrieved.
    * @return The value of the returned external institution code or null.
    */
   public final String getExtInstCode( int index )
   {
      return _ExtInstCode[index];
   }
    ...
    */
   public final String getExtInstCode( int index, String defaultValue )
   {
      return _ExtInstCode[index] == null ? defaultValue : _ExtInstCode[index];
   }
    
   /**
    * Gets the array of returned external institution code fields for the response that
    * have been retrieved so far. Fields from records that have not yet been received,
    * will not present.
    * 
    * @return The array of returned external institution code values.
    */
   public final String[] getExtInstCodeArray()
   {
      return _ExtInstCode;
   }
   ...
   protected void decodeFields( RTSResponseDecodeBuffer responseBuffer ) throws ParseException, UnsupportedEncodingException
   {
      ...
      _ExtInstCode = resizeArray( _ExtInstCode, _RepeatCount );
      ...
      for (int x = oldRepeatCount ; x < _RepeatCount; x++)
      {
         ...
         _ExtInstCode[x] = responseBuffer.decodeString(responseBuffer.getNextField());
      }
