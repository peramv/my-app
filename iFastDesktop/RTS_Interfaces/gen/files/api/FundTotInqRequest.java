 ...
 */
public class FundTotInqRequest extends IFastRequest implements Serializable
{
   ...
   /**
    * Constructs the FundTotInqRequest object.
    * 
    */
   FundTotInqRequest()
   {
   ...
   /**
    * Constructs the FundTotInqRequest object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   FundTotInqRequest( String hostEncoding )
   {
      super ( 364, hostEncoding );
   }
