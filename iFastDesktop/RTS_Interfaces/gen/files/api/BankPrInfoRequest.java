...
/**
 * BankFile Processor Information request.
 * For additional view information see <A HREF="../../../../viewspecs/BankPrInfo.doc">BankPrInfo.doc</A>.
 * 
 * @author RTS Generated
 */
public class BankPrInfoRequest extends IFastRequest implements Serializable
{
   ...
   /**
    * Constructs the BankPrInfoRequest object.
    * 
    */
   BankPrInfoRequest()
   {
   ...
   /**
    * Constructs the BankPrInfoRequest object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   BankPrInfoRequest( String hostEncoding )
   {
      super ( 207, hostEncoding );
   }
