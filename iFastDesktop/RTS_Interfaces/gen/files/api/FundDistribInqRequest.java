...
/**
 * Fund Distribution Inquiry request.
 * For additional view information see <A HREF="../../../../viewspecs/FundDistribInq.doc">FundDistribInq.doc</A>.
 * 
 * @author RTS Generated
 */
public class FundDistribInqRequest extends IFastRequest implements Serializable
{
   ...
   /**
    * Constructs the FundDistribInqRequest object.
    * 
    */
   FundDistribInqRequest()
   {
      super ( 379 );
   }

   /**
    * Constructs the FundDistribInqRequest object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   FundDistribInqRequest( String hostEncoding )
   {
      super ( 379, hostEncoding );
   }
