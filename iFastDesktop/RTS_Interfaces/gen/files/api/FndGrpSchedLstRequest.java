...
/**
 * Fund Group Schedule Inquiry request.
 * For additional view information see <A HREF="../../../../viewspecs/FndGrpSchedLst.doc">FndGrpSchedLst.doc</A>.
 * 
 * @author RTS Generated
 */
public class FndGrpSchedLstRequest extends IFastRequest implements Serializable
{
   ...
   /**
    * Constructs the FndGrpSchedLstRequest object.
    * 
    */
   FndGrpSchedLstRequest()
   {
      super ( 128 );
   }

   /**
    * Constructs the FndGrpSchedLstRequest object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   FndGrpSchedLstRequest( String hostEncoding )
   {
      super ( 128, hostEncoding );
   }
