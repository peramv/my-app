...
public class SegFundValidationsView extends IFastView implements Serializable
{
   ...
   /**
    * Constructs the SegFundValidationsView object.
    * 
    */
   public SegFundValidationsView()
   {
      super ( new SegFundValidationsRequest() );
   }

   /**
    * Constructs the SegFundValidationsView object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   public SegFundValidationsView( String hostEncoding )
   {
      super ( new SegFundValidationsRequest( hostEncoding ) );
   }

   /**
    * Gets the SegFundValidationsRequest object associated with this view. Data is set
    * into this object before calling any of this view's recieve
    * methods. An attempt to set request fields after the first receive will
    * result in a runtime exception.
    * 
    * @return The SegFundValidationsRequest object.
    */
   public final SegFundValidationsRequest getRequest()
   {
      return (SegFundValidationsRequest)getIFastRequest();
   }
