...
/**
 * Seg Fund Multiple Contract Maintenance view.
 * For additional view information see <A HREF="../../../../viewspecs/SegFndMContUpd.doc">SegFndMContUpd.doc</A>.
 * 
 * @author RTS Generated
 */
public class SegFndMContUpdView extends IFastView implements Serializable
{
   ...
   /**
    * Warning Parameter member variable.
    */
   ...
   /**
    * Constructs the SegFndMContUpdView object.
    * 
    */
   public SegFndMContUpdView()
   {
      super ( new SegFndMContUpdRequest() );
   }

   /**
    * Constructs the SegFndMContUpdView object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   public SegFndMContUpdView( String hostEncoding )
   {
      super ( new SegFndMContUpdRequest( hostEncoding ) );
   }

   /**
    * Gets the SegFndMContUpdRequest object associated with this view. Data is set
    * into this object before calling any of this view's recieve
    * methods. An attempt to set request fields after the first receive will
    * result in a runtime exception.
    * 
    * @return The SegFndMContUpdRequest object.
    */
   public final SegFndMContUpdRequest getRequest()
   {
      return (SegFndMContUpdRequest)getIFastRequest();
   }
   ...
   /**
    * Gets the Warning Parameter field for the response. If the field has
    * no value, null is returned. 
    * 
    * @return The value of the Warning Parameter or null.
    */
    ...
    * 
    * @param defaultValue  The value to return if the field has no value.
    * @return The value of the Warning Parameter or the specified default value.
    */
