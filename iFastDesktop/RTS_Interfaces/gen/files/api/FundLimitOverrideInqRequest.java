...
/**
 * Fund Limitation Override Inquiry request.
 * For additional view information see <A HREF="../../../../viewspecs/FundLimitOverrideInq.doc">FundLimitOverrideInq.doc</A>.
 * 
 * @author RTS Generated
 */
public class FundLimitOverrideInqRequest extends IFastRequest implements Serializable
{
   ...
   /**
    * Constructs the FundLimitOverrideInqRequest object.
    * 
    */
   FundLimitOverrideInqRequest()
   {
      super ( 236 );
   }

   /**
    * Constructs the FundLimitOverrideInqRequest object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   FundLimitOverrideInqRequest( String hostEncoding )
   {
      super ( 236, hostEncoding );
   }
