...
/**
 * System Availability for Handler 5 view.
 * For additional view information see <A HREF="../../../../viewspecs/SysAvailability5.doc">SysAvailability5.doc</A>.
 * 
 * @author RTS Generated
 */
public class SysAvailability5View extends IFastView implements Serializable
{
   ...
   /**
    * Constructs the SysAvailability5View object.
    * 
    */
   public SysAvailability5View()
   {
      super ( new SysAvailability5Request() );
   }

   /**
    * Constructs the SysAvailability5View object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   public SysAvailability5View( String hostEncoding )
   {
      super ( new SysAvailability5Request( hostEncoding ) );
   }

   /**
    * Gets the SysAvailability5Request object associated with this view. Data is set
    * into this object before calling any of this view's recieve
    * methods. An attempt to set request fields after the first receive will
    * result in a runtime exception.
    * 
    * @return The SysAvailability5Request object.
    */
   public final SysAvailability5Request getRequest()
   {
      return (SysAvailability5Request)getIFastRequest();
   }
