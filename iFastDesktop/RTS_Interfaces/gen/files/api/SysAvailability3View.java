...
/**
 * System Availability for Handler 3 view.
 * For additional view information see <A HREF="../../../../viewspecs/SysAvailability3.doc">SysAvailability3.doc</A>.
 * 
 * @author RTS Generated
 */
public class SysAvailability3View extends IFastView implements Serializable
{
   ...
   /**
    * Constructs the SysAvailability3View object.
    * 
    */
   public SysAvailability3View()
   {
      super ( new SysAvailability3Request() );
   }

   /**
    * Constructs the SysAvailability3View object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   public SysAvailability3View( String hostEncoding )
   {
      super ( new SysAvailability3Request( hostEncoding ) );
   }

   /**
    * Gets the SysAvailability3Request object associated with this view. Data is set
    * into this object before calling any of this view's recieve
    * methods. An attempt to set request fields after the first receive will
    * result in a runtime exception.
    * 
    * @return The SysAvailability3Request object.
    */
   public final SysAvailability3Request getRequest()
   {
      return (SysAvailability3Request)getIFastRequest();
   }
