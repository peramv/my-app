...
/**
 * Broker Who-To-Pay Inquiry request.
 * For additional view information see <A HREF="../../../../viewspecs/WhoToPayInq.doc">WhoToPayInq.doc</A>.
 * 
 * @author RTS Generated
 */
public class WhoToPayInqRequest extends IFastRequest implements Serializable
{
   ...
   /**
    * Constructs the WhoToPayInqRequest object.
    * 
    */
   WhoToPayInqRequest()
   {
   ...
   /**
    * Constructs the WhoToPayInqRequest object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   WhoToPayInqRequest( String hostEncoding )
   {
      super ( 258, hostEncoding );
   }
