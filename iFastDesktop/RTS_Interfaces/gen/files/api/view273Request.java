 ...
 */
public class view273Request extends IFastRequest implements Serializable
{
   ...
   /**
    * Constructs the view273Request object.
    * 
    */
   view273Request()
   {
   ...
   /**
    * Constructs the view273Request object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   view273Request( String hostEncoding )
   {
      super ( 273, hostEncoding );
   }
