...
/**
 * eInvestor UserId Setup view.
 * For additional view information see <A HREF="../../../../viewspecs/InvIDSetup.doc">InvIDSetup.doc</A>.
 * 
 * @author RTS Generated
 */
public class InvIDSetupView extends IFastView implements Serializable
{
    ...
    */
   private String _RxCurrency = null;
   

   /**
    * Constructs the InvIDSetupView object.
    * 
    */
   public InvIDSetupView()
   {
      super ( new InvIDSetupRequest() );
   }

   /**
    * Constructs the InvIDSetupView object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   public InvIDSetupView( String hostEncoding )
   {
      super ( new InvIDSetupRequest( hostEncoding ) );
   }

   /**
    * Gets the InvIDSetupRequest object associated with this view. Data is set
    * into this object before calling any of this view's recieve
    * methods. An attempt to set request fields after the first receive will
    * result in a runtime exception.
    * 
    * @return The InvIDSetupRequest object.
    */
   public final InvIDSetupRequest getRequest()
   {
      return (InvIDSetupRequest)getIFastRequest();
   }
    ...
    */
   public final String getRxCurrency()
   {
      return _RxCurrency;
   }
    ...
    */
   public final String getRxCurrency( String defaultValue )
   {
      return _RxCurrency == null ? defaultValue : _RxCurrency;
   }
   ...
   protected void decodeFields( RTSResponseDecodeBuffer responseBuffer ) throws ParseException, UnsupportedEncodingException
   {
      ...
      _RxCurrency = responseBuffer.decodeString(responseBuffer.getNextField());
