...
/**
 * Scheduled Job Master request.
 * For additional view information see <A HREF="../../../../viewspecs/SchedJobMstr.doc">SchedJobMstr.doc</A>.
 * 
 * @author RTS Generated
 */
public class SchedJobMstrRequest extends IFastRequest implements Serializable
{
   ...
   /**
    * Constructs the SchedJobMstrRequest object.
    * 
    */
   SchedJobMstrRequest()
   {
   ...
   /**
    * Constructs the SchedJobMstrRequest object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   SchedJobMstrRequest( String hostEncoding )
   {
      super ( 226, hostEncoding );
   }
