...
/**
 * Entity History Inquriy request.
 * For additional view information see <A HREF="../../../../viewspecs/EntHist.doc">EntHist.doc</A>.
 * 
 * @author RTS Generated
 */
public class EntHistRequest extends IFastRequest implements Serializable
{
   ...
   /**
    * Constructs the EntHistRequest object.
    * 
    */
   EntHistRequest()
   {
   ...
   /**
    * Constructs the EntHistRequest object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   EntHistRequest( String hostEncoding )
   {
      super ( 122, hostEncoding );
   }
