...
/**
 * Shareholder History Inquriy view.
 * For additional view information see <A HREF="../../../../viewspecs/PrimHist.doc">PrimHist.doc</A>.
 * 
 * @author RTS Generated
 */
public class PrimHistView extends IFastView implements Serializable
{
    ...
    */
   private String[] _NewDisplay = null;
   ...
   /**
    * Constructs the PrimHistView object.
    * 
    */
   public PrimHistView()
   {
      super ( new PrimHistRequest() );
   }

   /**
    * Constructs the PrimHistView object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   public PrimHistView( String hostEncoding )
   {
      super ( new PrimHistRequest( hostEncoding ) );
   }

   /**
    * Gets the PrimHistRequest object associated with this view. Data is set
    * into this object before calling any of this view's recieve
    * methods. An attempt to set request fields after the first receive will
    * result in a runtime exception.
    * 
    * @return The PrimHistRequest object.
    */
   public final PrimHistRequest getRequest()
   {
      return (PrimHistRequest)getIFastRequest();
   }
    ...
    */
   public final String getNewDisplay( int index )
   {
    ...
    */
   public final String getNewDisplay( int index, String defaultValue )
   {
      return _NewDisplay[index] == null ? defaultValue : _NewDisplay[index];
   }
    ...
    */
   public final String[] getNewDisplayArray()
   {
      return _NewDisplay;
   }
   ...
   protected void decodeFields( RTSResponseDecodeBuffer responseBuffer ) throws ParseException, UnsupportedEncodingException
   {
      ...
      for (int x = oldRepeatCount ; x < _RepeatCount; x++)
      {
         ...
         _NewDisplay[x] = responseBuffer.decodeString(responseBuffer.getNextField());
