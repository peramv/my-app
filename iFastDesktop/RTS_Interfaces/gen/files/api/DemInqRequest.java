...
/**
 * FundCom Demographics Inquiry request.
 * For additional view information see <A HREF="../../../../viewspecs/DemInq.doc">DemInq.doc</A>.
 * 
 * @author RTS Generated
 */
public class DemInqRequest extends IFastRequest implements Serializable
{
   ...
   /**
    * Constructs the DemInqRequest object.
    * 
    */
   DemInqRequest()
   {
   ...
   /**
    * Constructs the DemInqRequest object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   DemInqRequest( String hostEncoding )
   {
      super ( 182, hostEncoding );
   }
