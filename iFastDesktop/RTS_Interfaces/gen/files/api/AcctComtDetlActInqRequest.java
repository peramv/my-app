...
/**
 * Account Commitment Details&Activity Inquiry request.
 * For additional view information see <A HREF="../../../../viewspecs/AcctComtDetlActInq.doc">AcctComtDetlActInq.doc</A>.
 * 
 * @author RTS Generated
 */
public class AcctComtDetlActInqRequest extends IFastRequest implements Serializable
{
   ...
   /**
    * Constructs the AcctComtDetlActInqRequest object.
    * 
    */
   AcctComtDetlActInqRequest()
   {
      super ( 433 );
   }

   /**
    * Constructs the AcctComtDetlActInqRequest object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   AcctComtDetlActInqRequest( String hostEncoding )
   {
      super ( 433, hostEncoding );
   }
