...
/**
 * RESP Beneficiary Allocation Inquiry request.
 * For additional view information see <A HREF="../../../../viewspecs/RESPBenfAllocInq.doc">RESPBenfAllocInq.doc</A>.
 * 
 * @author RTS Generated
 */
public class RESPBenfAllocInqRequest extends IFastRequest implements Serializable
{
   ...
   /**
    * Constructs the RESPBenfAllocInqRequest object.
    * 
    */
   RESPBenfAllocInqRequest()
   {
      super ( 402 );
   }

   /**
    * Constructs the RESPBenfAllocInqRequest object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   RESPBenfAllocInqRequest( String hostEncoding )
   {
      super ( 402, hostEncoding );
   }
