...
/**
 * Entity Regulatory Detail Inquiry request.
 * For additional view information see <A HREF="../../../../viewspecs/EntRegInq.doc">EntRegInq.doc</A>.
 * 
 * @author RTS Generated
 */
public class EntRegInqRequest extends IFastRequest implements Serializable
{
   ...
   /**
    * Constructs the EntRegInqRequest object.
    * 
    */
   EntRegInqRequest()
   {
   ...
   /**
    * Constructs the EntRegInqRequest object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   EntRegInqRequest( String hostEncoding )
   {
      super ( 456, hostEncoding );
   }
