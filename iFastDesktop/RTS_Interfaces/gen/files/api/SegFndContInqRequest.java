...
/**
 * Seg Fund Contract Inquiry request.
 * For additional view information see <A HREF="../../../../viewspecs/SegFndContInq.doc">SegFndContInq.doc</A>.
 * 
 * @author RTS Generated
 */
public class SegFndContInqRequest extends IFastRequest implements Serializable
{
   ...
   /**
    * Constructs the SegFndContInqRequest object.
    * 
    */
   SegFndContInqRequest()
   {
      super ( 105 );
   }

   /**
    * Constructs the SegFndContInqRequest object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   SegFndContInqRequest( String hostEncoding )
   {
      super ( 105, hostEncoding );
   }
