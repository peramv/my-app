...
/**
 * Account History Inquriy view.
 * For additional view information see <A HREF="../../../../viewspecs/AcctHist.doc">AcctHist.doc</A>.
 * 
 * @author RTS Generated
 */
public class AcctHistView extends IFastView implements Serializable
{
   ...
   /**
    * Constructs the AcctHistView object.
    * 
    */
   public AcctHistView()
   {
      super ( new AcctHistRequest() );
   }

   /**
    * Constructs the AcctHistView object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   public AcctHistView( String hostEncoding )
   {
      super ( new AcctHistRequest( hostEncoding ) );
   }

   /**
    * Gets the AcctHistRequest object associated with this view. Data is set
    * into this object before calling any of this view's recieve
    * methods. An attempt to set request fields after the first receive will
    * result in a runtime exception.
    * 
    * @return The AcctHistRequest object.
    */
   public final AcctHistRequest getRequest()
   {
      return (AcctHistRequest)getIFastRequest();
   }
