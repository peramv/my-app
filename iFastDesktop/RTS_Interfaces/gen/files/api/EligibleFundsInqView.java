...
/**
 * Eligible Funds Inquiry view.
 * For additional view information see <A HREF="../../../../viewspecs/EligibleFundsInq.doc">EligibleFundsInq.doc</A>.
 * 
 * @author RTS Generated
 */
public class EligibleFundsInqView extends IFastView implements Serializable
{
   ...
   /**
    * Constructs the EligibleFundsInqView object.
    * 
    */
   public EligibleFundsInqView()
   {
      super ( new EligibleFundsInqRequest() );
   }

   /**
    * Constructs the EligibleFundsInqView object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   public EligibleFundsInqView( String hostEncoding )
   {
      super ( new EligibleFundsInqRequest( hostEncoding ) );
   }

   /**
    * Gets the EligibleFundsInqRequest object associated with this view. Data is set
    * into this object before calling any of this view's recieve
    * methods. An attempt to set request fields after the first receive will
    * result in a runtime exception.
    * 
    * @return The EligibleFundsInqRequest object.
    */
   public final EligibleFundsInqRequest getRequest()
   {
      return (EligibleFundsInqRequest)getIFastRequest();
   }
