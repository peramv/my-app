...
/**
 * FUNDCom REG Plan Contrib Inquiry request.
 * For additional view information see <A HREF="../../../../viewspecs/FundComRegPlanInq.doc">FundComRegPlanInq.doc</A>.
 * 
 * @author RTS Generated
 */
public class FundComRegPlanInqRequest extends IFastRequest implements Serializable
{
   ...
   /**
    * Constructs the FundComRegPlanInqRequest object.
    * 
    */
   FundComRegPlanInqRequest()
   {
      super ( 373 );
   }

   /**
    * Constructs the FundComRegPlanInqRequest object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   FundComRegPlanInqRequest( String hostEncoding )
   {
      super ( 373, hostEncoding );
   }
