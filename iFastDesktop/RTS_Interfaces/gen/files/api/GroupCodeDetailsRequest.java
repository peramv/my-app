...
/**
 * Group Code  List request.
 * For additional view information see <A HREF="../../../../viewspecs/GroupCodeDetails.doc">GroupCodeDetails.doc</A>.
 * 
 * @author RTS Generated
 */
public class GroupCodeDetailsRequest extends IFastRequest implements Serializable
{
   ...
   /**
    * Constructs the GroupCodeDetailsRequest object.
    * 
    */
   GroupCodeDetailsRequest()
   {
      super ( 88 );
   }

   /**
    * Constructs the GroupCodeDetailsRequest object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   GroupCodeDetailsRequest( String hostEncoding )
   {
      super ( 88, hostEncoding );
   }
