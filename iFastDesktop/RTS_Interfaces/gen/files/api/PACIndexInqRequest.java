...
/**
 * PAC Indexing Inquiry request.
 * For additional view information see <A HREF="../../../../viewspecs/PACIndexInq.doc">PACIndexInq.doc</A>.
 * 
 * @author RTS Generated
 */
public class PACIndexInqRequest extends IFastRequest implements Serializable
{
   ...
   /**
    * Constructs the PACIndexInqRequest object.
    * 
    */
   PACIndexInqRequest()
   {
   ...
   /**
    * Constructs the PACIndexInqRequest object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   PACIndexInqRequest( String hostEncoding )
   {
      super ( 119, hostEncoding );
   }
