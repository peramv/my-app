...
/**
 * Fund-Class List request.
 * For additional view information see <A HREF="../../../../viewspecs/FundClassList.doc">FundClassList.doc</A>.
 * 
 * @author RTS Generated
 */
public class FundClassListRequest extends IFastRequest implements Serializable
{
   ...
   /**
    * Constructs the FundClassListRequest object.
    * 
    */
   FundClassListRequest()
   {
      super ( 164 );
   }

   /**
    * Constructs the FundClassListRequest object with the given host encoding.
    * 
    * @param hostEncoding
    *               character encoding for sending/receiving host data
    */
   FundClassListRequest( String hostEncoding )
   {
      super ( 164, hostEncoding );
   }
