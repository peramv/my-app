 ...
 * ViewsGenerator: Generated on : Wednesday, October 21, 2015 10:27:21
 */
public class AccountInformationView extends IFastView implements Serializable
{
   ...
   /**
    * MailHouseholdID member array.
    */
   private String[] _MailHouseholdID = null;
   ...
   /**
    * Gets the MailHouseholdID field for the response and the 
    * given index. If the field has no value, null is returned. 
    * 
    * @param index  Zero based index of the repeat for which the value will be retrieved.
    * @return The value of the MailHouseholdID or null.
    */
   public final String getMailHouseholdID( int index )
   {
      return _MailHouseholdID[index];
   }
    ...
    * @param index         Zero based index of the repeat for which the value will be retrieved.
    * @param defaultValue  The value to return if the field has no value.
    * @return The value of the MailHouseholdID or the specified default value.
    */
   public final String getMailHouseholdID( int index, String defaultValue )
   {
      return _MailHouseholdID[index] == null ? defaultValue : _MailHouseholdID[index];
   }
    
   /**
    * Gets the array of MailHouseholdID fields for the response that
    * have been retrieved so far. Fields from records that have not yet been received,
    * will not present.
    * 
    * @return The array of MailHouseholdID values.
    */
   public final String[] getMailHouseholdIDArray()
   {
      return _MailHouseholdID;
   }
   ...
   protected void decodeFields( RTSResponseDecodeBuffer responseBuffer ) throws ParseException, UnsupportedEncodingException
   {
      ...
      _MailHouseholdID = resizeArray( _MailHouseholdID, _RepeatCount );
      ...
      for (int x = oldRepeatCount ; x < _RepeatCount; x++)
      {
         ...
         _MailHouseholdID[x] = responseBuffer.decodeString(responseBuffer.getNextField());
      }
