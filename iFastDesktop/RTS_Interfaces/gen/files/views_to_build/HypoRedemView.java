 ...
 * ViewsGenerator: Generated on : Tuesday, October 18, 2016 23:17:50
 */
public class HypoRedemView extends IFastView implements Serializable
{
    ...
    *  member array.
    */
   private String[] _TenPercentMeth = null;
            
   /**
    *  member array.
    */
   private String[] _TotFeesRed = null;
            
   /**
    *  member array.
    */
   private String[] _TotTaxClawback = null;
    ...
    */
   public final String getTenPercentMeth( int index )
   {
      return _TenPercentMeth[index];
   }
    ...
    */
   public final String getTenPercentMeth( int index, String defaultValue )
   {
      return _TenPercentMeth[index] == null ? defaultValue : _TenPercentMeth[index];
   }
    ...
    */
   public final String[] getTenPercentMethArray()
   {
      return _TenPercentMeth;
   }
    ...
    * @return The value of the  or null.
    */
   public final String getTotFeesRed( int index )
   {
      return _TotFeesRed[index];
   }
    ...
    * @return The value of the  or the specified default value.
    */
   public final String getTotFeesRed( int index, String defaultValue )
   {
      return _TotFeesRed[index] == null ? defaultValue : _TotFeesRed[index];
   }
    ...
    * @return The array of  values.
    */
   public final String[] getTotFeesRedArray()
   {
      return _TotFeesRed;
   }
    ...
    * @return The value of the  or null.
    */
   public final String getTotTaxClawback( int index )
   {
      return _TotTaxClawback[index];
   }
    ...
    * @return The value of the  or the specified default value.
    */
   public final String getTotTaxClawback( int index, String defaultValue )
   {
      return _TotTaxClawback[index] == null ? defaultValue : _TotTaxClawback[index];
   }
    ...
    * @return The array of  values.
    */
   public final String[] getTotTaxClawbackArray()
   {
      return _TotTaxClawback;
   }
   ...
   protected void decodeFields( RTSResponseDecodeBuffer responseBuffer ) throws ParseException, UnsupportedEncodingException
   {
      ...
      _TenPercentMeth = resizeArray( _TenPercentMeth, _RepeatCount );
      _TotFeesRed = resizeArray( _TotFeesRed, _RepeatCount );
      _TotTaxClawback = resizeArray( _TotTaxClawback, _RepeatCount );
      ...
      for (int x = oldRepeatCount ; x < _RepeatCount; x++)
      {
         ...
         _TenPercentMeth[x] = responseBuffer.decodeString(responseBuffer.getNextField());
         _TotFeesRed[x] = responseBuffer.decodeString(responseBuffer.getNextField());
         _TotTaxClawback[x] = responseBuffer.decodeString(responseBuffer.getNextField());
      }
