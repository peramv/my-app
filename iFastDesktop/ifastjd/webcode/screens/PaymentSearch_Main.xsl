<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="vGUICaller"    select="/websrvXML/FormInformation/GUICaller"/>
  ...
  <xsl:template name="form_callback">
    ...
    <xsl:element name="input">
  	<xsl:attribute name="id">dateFormat</xsl:attribute>
  	<xsl:attribute name="type">hidden</xsl:attribute>
  	<xsl:attribute name="value"><xsl:value-of select="$vDateFormat"/></xsl:attribute>
    </xsl:element>

	<xsl:element name="input">
  	<xsl:attribute name="id">GUICaller</xsl:attribute>
  	<xsl:attribute name="type">hidden</xsl:attribute>
  	<xsl:attribute name="value"><xsl:value-of select="$vGUICaller"/></xsl:attribute>
    </xsl:element> 
          ...
          <tr>
            ...
            <td align="left">
                <input type="integer" id="transNumValue" maxlength="11">
                  <xsl:if test="//FormInformation/searchType='TransNumber'">
    ...
    <fieldset id="consolidatedPayments" style="position:relative; width:704px; display:none; z-index:9;">
      ...
      <div align="right" style="position:relative; width:700;">
        ...
        <div align="left" id="submitLoadingDiv" style="position:relative; font-size:140%; display:none; width:140px; height:25; left:-30; top:3; z-index:10;" >
        </div>
        ...
        <!--
          - C++ Code has a hook to catch btnHistorical so it will fire off a new screen
          -->
        <input id="btnHistorical" name="btnHistorical" type="button" value="Historical" style="width:80;" onclick='loadHistoricalScreen()'/>
      </div>
    </fieldset>
