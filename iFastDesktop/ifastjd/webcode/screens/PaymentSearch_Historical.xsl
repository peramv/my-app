    ...
    <div style="position:relative; width:700;">
      ...
      <div style="width:100%; position:relative; left:5;">
        ...
        <div align="right" style="position:relative; left:-5;">
          <input style="width:80px" type="button" id="prevHistoricalButton" value="Previous" disabled="true" onclick="sendHistoricalCall (Number(currentHistoricalStart) - Number(recordsPerPage), recordsPerPage);"/>
          <input style="width:80px" type="button" id="nextHistoricalButton" value="Next" disabled="true" onclick="sendHistoricalCall  (Number(currentHistoricalEnd)+1, recordsPerPage);"/>
