<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="vDateFormat"   select="/websrvXML/FormInformation/dateFormat"/>
    ...
    <Screen>
      ...
      <html>
        <head>
          ...
          <link rel="stylesheet"
            type="text/css"
            href="{$vURL}css/FundLimitations_Grid.css"/>
          ...
          <script src="{$vURL}javascript/General_FieldSuggest.js">
            // comment. pls keep
          </script>
          <script src="{$vURL}javascript/General_SuggestDropdown.js">
            // comment. pls keep
          </script>
          <script src="{$vURL}javascript/FundLimitations_Grid.js">
            // comment. pls keep
          </script>
          <script src="{$vURL}javascript/FundLimitations_AddScreen.js">
            // comment. pls keep
          </script>
          <script src="{$vURL}javascript/General_Loading.js">
            // comment. pls keep
          </script>
          ...
          <script>
            ...
            function loading()
            {
              ...
              setSelectedRuleType( "<xsl:value-of select="//FormInformation/ruleType"/>" );              
            }
          </script>
  ...
  <xsl:template name="tmplForm">
    ...
    <script type="text/javascript">
      ...
      function basedOnShowForm()
      {
        ...
        if (obj2.value =='fundSponsor')
        {
          ...
          showHideDiv('enterFundGroup','hide');
        }
        ...
        else if (obj2.value =='specificFundGroup')
        {
          showHideDiv('enterSponsor','hide');
          showHideDiv('enterFund','hide');
          showHideDiv('enterClass','hide');
          showHideDiv('enterFundGroup','show');
        }
        else
        {
          showHideDiv('enterSponsor', 'hide');
    ...
    <div class="bodytext">
      ...
      <xsl:element name="input">
    	...
    	<xsl:element name="input">
    		<xsl:attribute name="id">fldDateFormat</xsl:attribute>
    		<xsl:attribute name="type">hidden</xsl:attribute>
    		<xsl:attribute name="value"><xsl:value-of select="$vDateFormat"/></xsl:attribute>
    	</xsl:element>
                  ...
                  <xsl:element name="input">
                    ...
                    <xsl:attribute name="defaultValue"><xsl:value-of select=".//DefaultDates/start"/></xsl:attribute>
                  	<xsl:attribute name="dateformat">
                  		<xsl:value-of select="$vDateFormat"/>
                  	</xsl:attribute>
        ...
        <div style="position:relative">
          <div class="contentRow fontTypeSize10" style="margin-top:4px; margin-bottom:8px; position:relative">
            ...
            <span class="fontTypeSize10" style="position:absolute; right:50%">
              <select name="basedOnDropDown" class="fontTypeSize10" id = "basedOnShowFormId" onchange="basedOnShowForm();" style="width:160px">
          ...
          <div id="dynamicallyChangingBox">
            ...
            <div id="enterSponsor" style="display:none">
              ...
              <div id="divFundSponsor_allow" class="contentRow fontTypeSize10" style="display:none; margin-top:2px; margin-bottom:5px; position:relative; height:3ex;">
                <span>
                  Applicable:
                </span>
                <span style="position:absolute; right:50%;">
                  <select id="fundSponsor_allow" name="minimumInitialPurchaseBox" class="fontTypeSize10" style="width:140px">
            ...
            <div id="enterFund" style="display:none">
              ...
              <div id="divFund_allow" class="contentRow fontTypeSize10" style="display:none; margin-top:5px; margin-bottom:5px; position:relative; height:3ex;">
                <span>
                  Applicable:
                </span>
                <span style="position:absolute; right:50%">
                  <select name="fund_allow" id="fund_allow" class="fontTypeSize10" style="width:140px">
                    <option value="yes">yes</option>
                    <option value="no">no</option>
                  </select>
                </span>
            ...
            <div id="enterClass" style="display:none">
              ...
              <div id="divClass_allow" class="contentRow fontTypeSize10" style="display:none; margin-top:5px; margin-bottom:5px; position:relative; height:3ex;">
                <span>
                  Applicable:
                </span>
                <span style="position:absolute; right:50%">
                  <select name="class_allow" id="class_allow" class="fontTypeSize10" style="width:140px">
                    <option value="yes">yes</option>                    
                    <option value="no">no</option>
                  </select>
                </span>
          ...
          <!-- FundGroup ============  -->
          <div id="enterFundGroup" style="display:none">
            <div id="fundSponsor" class="contentRow fontTypeSize10" style="margin-top:5px; margin-bottom:4px; height:3ex; position:relative">
              <span>
                Fund Group:
              </span>
              <span style="position:absolute; right:50%">
                <xsl:element name = "select">
                  <xsl:attribute name = "name">fundGroupDropdown</xsl:attribute>
                  <xsl:attribute name = "id">fundGroup_fundGroupDropdown</xsl:attribute>
                  <xsl:attribute name = "class">fundDropDown fontTypeSize10</xsl:attribute>
                  <!--xsl:attribute name="onchange">populateClassList(this);</xsl:attribute-->
                  
                  <xsl:for-each select="//List[@listName='FundGroupList']/Element">
                    <option>
                      <xsl:attribute name="value"><xsl:value-of select="value"/></xsl:attribute>
                      <xsl:value-of select="value"/>
                    </option>                                               
            ...
            <div id="divFundGroup_amt" class="contentRow fontTypeSize10" style="display:block; margin-top:5px; margin-bottom:5px; position:relative; height:3ex;">
              <span>
                Amount:
              </span>
              <span style="position:absolute; right:50%">
                <input name="fundGroup_amt" id="fundGroup_amt" class="fontTypeSize10" type="text" style="width:140px" value="0.00" defaultValue="0.00" onclick='if(this.value=="0.00") this.select();' onkeydown="return validateNumeric(this)"/>
              </span>
            </div>            
            <div id="divFundGroup_allow" class="contentRow fontTypeSize10" style="display:none; margin-top:5px; margin-bottom:5px; position:relative; height:3ex;">
              <span>
                Applicable:
              </span>
              <span style="position:absolute; right:50%">
                <select name="fundGroup_allow" id="fundGroup_allow" class="fontTypeSize10" style="width:140px">
                  <option value="yes">yes</option>                  
                  <option value="no">no</option>
                </select>
              </span>
            ...
            <div id="onlineEWI" class="contentRow fontTypeSize10" style="display:block; margin-top:6px; margin-bottom:5px; position:relative; height:3ex;">
              ...
              <span style="position:absolute; right:50%">
                <select id="fundGroup_onlineewi" class="fundDropDown fontTypeSize10">
                  <option value="e">Error</option>
                  <option value="w">Warning</option>
                  <option value="i">Ignore</option>
                </select>
            ...
            <div id="cycleEWI" class="contentRow fontTypeSize10" style="display:block; margin-top:5px; margin-bottom:5px; position:relative; height:3ex;">
              ...
              <span style="position:absolute; right:50%">
                <select id="fundGroup_cycleewi" class="fundDropDown fontTypeSize10">
                  <option value="e">Error</option>
                  <option value="w">Warning</option>
                  <option value="i">Ignore</option>
                </select>
            ...
            <div id="esgEWI" class="contentRow fontTypeSize10" style="display:block; margin-top:5px; margin-bottom:5px; position:relative; height:3ex;">
              ...
              <span style="position:absolute; right:50%">
                <select id="fundGroup_esgewi" class="fundDropDown fontTypeSize10">
                  <option value="e">Error</option>
                  <option value="w">Warning</option>
                  <option value="i">Ignore</option>
                </select>
            ...
            <div class="contentRow" style="position:absolute; top:0px; left:350px; width:266px; height:12ex; font-size:16px; text-align:left;">
              ...
              <div class="fontTypeSize10" style="position:relative; height:3ex;">
                <input class="fontTypeSize10" id="fundGroup_exclude" name="fundGroup_ifRuleFound" type="radio" checked="true" value="exclude" />Exclude Fund From Update
              </div>
              <div class="fontTypeSize10" style="position:relative; height:3ex;">
                <input class="fontTypeSize10" id="fundGroup_stop" name="fundGroup_ifRuleFound" type="radio" value="stop" />Stop Existing Rule
              </div>
              
              <div id="addLimitation" class ="contentRow" style="text-align:center;">
                <input id="fundGroup_addLimitationsBtn" class="btnClass buttonFont" style="position:relative; top:20px; width:140px;" name="addLimitationBtn" type="button" value="Add Limitations" onclick="fundGroupLimitationsLookup();" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div  class="contentRow" style="text-align:right;">
          <span>
            <input name="deleteBtn"
                   type="button"
                   class="btnClass buttonFont"
                   id="deleteBtn"
                   value="Delete"
                   disabled="true"
                   style="width:6em; height:29px; margin-right:0px;"
                   onclick="deleteRules();"/>
            </span>
          <span>
            <input name="commitBtn"
                   type="button"
                   class="btnClass buttonFont"
                   id="commitBtn"
                   value="OK"
          ...
          <span>
            <input name="cancelBtn"
                   type="button"
                   class="btnClass buttonFont"
                   id="cancelBtn"
                   value="Cancel"
                   style="width:6em; height:29px;"
                   onclick="cancel();"/>
          </span>


          <input name="btnConfirmDlg"
                   type="button"
                   class="btnClass buttonFont"
                   id="btnConfirmDlg"
                   value="btnConfirmDlg"
                   style="width:0em; height:0px; margin-right:0px;"/>
