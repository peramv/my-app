    ...
    <table style="width:260;">
      ...
      <tr style="height:40;">
        ...
        <td style="width:120px;">
			<!-- hard-coded to dmy because the scheduler requires this format -->
          <input id="dateField" class="dstdatepicker" type="text" disabled="true" style="width:100" dateformat="dmy">
            <xsl:attribute name="value">
      ...
      <tr style="height:40">
        <td colspan="4" align="right">
          <input style="width:80" id="submitOk" type="button" value="OK" onclick="submitSchedule();"/>
