<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="vUpdAllowed"   select="/websrvXML/dtOvrdLimitActInitResponse/UpdFlag/UpdAllowed"/>
    ...
    <Screen>
      ...
      <html>
        <head>
          ...
          <script src="{$vURL}javascript/FundLimitations.js">
            // comment. pls keep
          </script>
          <script src="{$vURL}javascript/FundLimitations_Reload.js">
            // comment. pls keep
          </script>
          ...
          <script>
              ...
              var _updatesAllowed = ( "<xsl:value-of select="$vUpdAllowed"/>".toLowerCase() != "no" ); 
  ...
  <xsl:template name="tmplForm">
    ...
    <div class="bodytext">
      ...
      <div class="mainBorder">
        ...
        <div id="ruleType" class="contentRow fontTypeSize10 rowSpacer1" style="position:relative; height:3ex;">
          ...
          <span class="boxPosition1">
            <xsl:element name = "select">
              ...
              <xsl:attribute name = "onchange">changeHandler_ruleType()</xsl:attribute>
        ...
        <div id="fundSponsor" class="contentRow fontTypeSize10  rowSpacer1" style="position:relative; height:3ex;">
          ...
          <span class="boxPosition1">
            <xsl:element name = "select">
              ...
              <xsl:attribute name = "class">fundDropDown fontTypeSize10 boxBackground</xsl:attribute>
              <xsl:attribute name="onchange">changeHandler_fundSponsor();</xsl:attribute>
        ...
        <div id="fundListBasedOn" class="contentRow fontTypeSize10 rowSpacer1" style="position:relative; height:3ex; z-index:1;">
          ...
          <span id= "mainFund" class="boxPosition1">
            <xsl:element name="input">
              ...
              <xsl:attribute name="onblur">blurHandler_fund() </xsl:attribute>              
            </xsl:element>
          </span>
        ...
        <div id="classListBasedOn" class="contentRow fontTypeSize10 rowSpacer1" style="position:relative; height:3ex; z-index:1;">
          <span style="position:absolute;">
            Class:
          </span>
          <span id= "mainClass" class="boxPosition1">
            <span id="classSpan">
              <xsl:element name = "select">
                ...
                <xsl:attribute name = "class">fundDropDown fontTypeSize10 boxBackground</xsl:attribute>
                <xsl:attribute name = "onchange">changeHandler_class();</xsl:attribute>
        ...
        <div id="fundGroupListBasedOn" class="contentRow fontTypeSize10" style="position:relative; height:3ex; z-index:1;">
          <span style="position:absolute;">
            Fund Group:
          </span>
          <span id= "mainFundGroup" class="boxPosition1">
            <span id="classSpan">
              <xsl:element name = "select">
                <xsl:attribute name = "name">fundGroupBox</xsl:attribute>
                <xsl:attribute name = "id">fundGroupBox</xsl:attribute>
                <xsl:attribute name = "class">fundDropDown fontTypeSize10 boxBackground</xsl:attribute>
                <xsl:attribute name = "onchange">changeHandler_fundGroupBox()</xsl:attribute>
        ...
        <div class="contentRow fontTypeSize10">
          ...
          <div id = "FundRuleTable" class="tableBorder">
            <div id = "accountListDiv"  style="position:absolute; left:0; top:0; height:100%; width:100%; border:1px solid #D3D3D3; overflow:scroll; background-color: #ffffff;">
              <table id="accountList" cellpadding="1" cellspacing="0" style="cursor:default; background-color: #ffffff;" width="1605px">
      ...
      <input name="btnCloseScreen" type="button" id="btnCloseScreen" value="Close" class="btnClass buttonFont" style="position:relative; top:20; width:100;" onclick="clickHandler_btnCloseScreen()"/>
      
      <!-- hidden button - for calling C++ -->      
      <input name="btnConfirmDlg" type="button" id="btnConfirmDlg" value="btnConfirmDlg" class="btnClass buttonFont" style="position:relative; top:20; width:100; display:none"/>
      <input name="btnClose" type="button" id="btnClose" value="btnClose" class="btnClass buttonFont" style="position:relative; top:20; width:100; display:none"/>
    </div>
