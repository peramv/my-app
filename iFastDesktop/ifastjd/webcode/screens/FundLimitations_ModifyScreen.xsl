<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <Screen>
      ...
      <html>
        <head>
          ...
          <script src="{$vURL}javascript/FundLimitations_ModifySubmit.js">
            // comment. pls keep
          </script>
          <script src="{$vURL}javascript/FundLimitations_Grid.js">
            ...
            <script>
              ...
              var _fundgroup     = '<xsl:value-of select="//FormInformation/fundgroup"/>';
  ...
  <xsl:template name="tmplForm">
    ...
    <div class="bodytext">
      <div class="mainTitle">Fund Limitations - Modify </div>
      <div class="mainBorder">
          ...
          <div style="position:relative">
            <div class="contentRow fontTypeSize10" style="margin-top:4px; margin-bottom:8px; position:relative">
              ...
              <span style="position:absolute; left:60%">
                Fund Group: <b><xsl:value-of select="//FormInformation/fundgroup"/></b>
              </span>
            </div>
        ...
        <div  class="contentRow fontTypeSize10" style="text-align:right;height:35;">
          <span>
            <input name="modifyBtn" type="button" id="modifyBtn" value="  OK  " style="position:relative; width:6em; height:4ex; top:5" onclick="SubmitModify();"/>
          </span>
          <span>
  ...
  <xsl:template name="fundLimitation">
    ...
    <span><xsl:value-of select="$ruleTypeName"/></span>
