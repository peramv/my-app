function disableInputFields()
{
    ...
    document.getElementById("fundSponsor_flag").disabled = true;
    ...
    document.getElementById("fund_flag").disabled = true;
    ...
    document.getElementById("class_flag").disabled = true;
...
function enableInputFields()
{
    ...
    document.getElementById("fundSponsor_flag").disabled = false;
    ...
    document.getElementById("fund_flag").disabled = false;
    ...
    document.getElementById("class_flag").disabled = false;
...
function reset()
{
    ...
    document.getElementById("divFundSponsor_flag").style.display = "none";
    ...
    document.getElementById("divFund_flag").style.display = "none";
    ...
    document.getElementById("divClass_flag").style.display = "none";
...
/*function navigateAccountField (fld){
...
{
    if(ruleSelectBox.value == "01" || ruleSelectBox.value == "02" || ruleSelectBox.value == "16")
    {
        document.getElementById("divFundSponsor_amt").style.display = "block";
        document.getElementById("divFundSponsor_flag").style.display = "none"
    ...
    else
    {
        ...
        document.getElementById("divFundSponsor_flag").style.display = "block"
        document.getElementById("fundSponsor_flag").disabled="true";

        document.getElementById("divFund_amt").style.display = "none";
        document.getElementById("divFund_flag").style.display = "block";
        document.getElementById("fund_flag").disabled="true";

        document.getElementById("divClass_amt").style.display = "none";
        document.getElementById("divClass_flag").style.display = "block";
        document.getElementById("class_flag").disabled="true";
    }
}
...
function getMainScreenURL()
{
    return document.getElementById("fldServletPath").value
        ...
        + "&ruserId=" + document.getElementById("fldRUserId").value
        + "&sessionId=" + document.getElementById("fldSessionId").value
        + "&jobname=" + "FundLimitations_MainScreen";
}
...
function fundSponsorLimitationsLookup()
{
    ...
    {
        lookupStr += "&overridelog=" + document.getElementById("fundSponsor_flag").value;
    }
...
function fundLimitationsLookup()
{
    ...
    {
        lookupStr += "&overridelog=" + document.getElementById("fund_flag").value;
    }
...
function classLimitationsLookup()
{
    ...
    {
        lookupStr += "&overridelog=" + document.getElementById("class_flag").value;
    }
...
function submitRules()
{
    ...
    for(var i = 1; i < rulesTableRows.length; i++)
    {
        ...
        ruleXMLStr += XML_Lib.createXMLStr("overridelog", cols[7].innerHTML);
        ruleXMLStr += XML_Lib.createXMLStr("overrideamt", cols[14].innerHTML);
        ...
        ruleXMLStr += XML_Lib.createXMLStr("controlsid", cols[12].innerHTML);
        ruleXMLStr += XML_Lib.createXMLStr("version", cols[13].innerHTML);
...
function addHandleOnKeydown(){
		...
		var scrollTop = document.getElementById("ruleListDiv").scrollTop;
		// Height of the visible div
		var visibleDivHeight = document.getElementById("ruleListDiv").clientHeight; 
        ...
        {	
   			if (rowPosition<scrollTop+38 && rowPosition< scrollTop + 48){
        	   	...
        	   	for (var i = 0; i < 15; i++)
        	   		document.getElementById("ruleListDiv").scrollTop--;
      	    }    
